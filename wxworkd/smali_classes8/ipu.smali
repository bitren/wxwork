...
.method private a(Landroid/content/Context;[Ljava/lang/String;Ljava/lang/String;Lipw;)Lipu$a;
    .locals 16

    move-object/from16 v0, p2

    .line 67
    invoke-direct/range {p0 .. p1}, Lipu;->fn(Landroid/content/Context;)[Ljava/lang/String;
    ...
    invoke-virtual {v4, v15, v10}, Lipw;->log(Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    .line 95
    new-instance v0, Lipu$a;

    invoke-direct {v0, v6, v10}, Lipu$a;-><init>(Ljava/util/zip/ZipFile;Ljava/util/zip/ZipEntry;)V
...
.method private f(Ljava/io/InputStream;Ljava/io/OutputStream;)J
    .locals 5
...
.method private fn(Landroid/content/Context;)[Ljava/lang/String;
    .locals 4
...
# virtual methods
.method public a(Landroid/content/Context;[Ljava/lang/String;Ljava/lang/String;Ljava/io/File;Lipw;)V
    .locals 10
    ...
    .line 125
    :try_start_0
    invoke-direct {p0, p1, p2, p3, p5}, Lipu;->a(Landroid/content/Context;[Ljava/lang/String;Ljava/lang/String;Lipw;)Lipu$a;
    ...
    invoke-virtual {p5, v1, v4}, Lipw;->log(Ljava/lang/String;[Ljava/lang/Object;)V
    :try_end_1
    ...
    :cond_0
    :try_start_3
    iget-object v1, p1, Lipu$a;->orf:Ljava/util/zip/ZipFile;

    iget-object v4, p1, Lipu$a;->org:Ljava/util/zip/ZipEntry;
    ...
    .line 148
    :try_start_5
    invoke-direct {p0, v1, v4}, Lipu;->f(Ljava/io/InputStream;Ljava/io/OutputStream;)J
    ...
    .line 161
    :try_start_6
    invoke-direct {p0, v1}, Lipu;->d(Ljava/io/Closeable;)V

    .line 162
    :goto_1
    invoke-direct {p0, v4}, Lipu;->d(Ljava/io/Closeable;)V
    ...
    .line 175
    :try_start_7
    iget-object p2, p1, Lipu$a;->orf:Ljava/util/zip/ZipFile;

    if-eqz p2, :cond_2

    .line 176
    iget-object p1, p1, Lipu$a;->orf:Ljava/util/zip/ZipFile;
    ...
    .line 162
    invoke-direct {p0, v0}, Lipu;->d(Ljava/io/Closeable;)V
    ...
    .line 172
    invoke-virtual {p5, p2}, Lipw;->log(Ljava/lang/String;)V
    :try_end_8
    ...
    .line 175
    :try_start_b
    iget-object p3, p1, Lipu$a;->orf:Ljava/util/zip/ZipFile;
