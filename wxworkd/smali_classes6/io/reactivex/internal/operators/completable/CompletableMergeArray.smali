...
.method public b(Lhig;)V
    ...
    iget-object v3, p0, Lio/reactivex/internal/operators/completable/CompletableMergeArray;->sources:[Lhii;

    array-length v3, v3

    add-int/lit8 v3, v3, 0x1

    invoke-direct {v2, p1, v1, v0, v3}, Lio/reactivex/internal/operators/completable/CompletableMergeArray$InnerCompletableObserver;-><init>(Lhig;Ljava/util/concurrent/atomic/AtomicBoolean;Lhji;I)V

    .line 35
    invoke-interface {p1, v0}, Lhig;->onSubscribe(Lhjj;)V

    .line 37
    iget-object p1, p0, Lio/reactivex/internal/operators/completable/CompletableMergeArray;->sources:[Lhii;
