...
# instance fields
.field private final sources:[Lhis;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "[",
            "Lhis<",
...
.method public b(Lhiq;)V
    ...
    .line 41
    iget-object v0, p0, Lio/reactivex/internal/operators/maybe/MaybeAmb;->sources:[Lhis;
    ...
    invoke-direct {v2, p1}, Lio/reactivex/internal/operators/maybe/MaybeAmb$AmbMaybeObserver;-><init>(Lhiq;)V

    .line 68
    invoke-interface {p1, v2}, Lhiq;->onSubscribe(Lhjj;)V
    ...
    .line 81
    :cond_5
    invoke-interface {v4, v2}, Lhis;->a(Lhiq;)V
