...
# static fields
.field static final nMQ:[Lio/reactivex/internal/operators/maybe/MaybeCache$CacheDisposable;

.field static final nMR:[Lio/reactivex/internal/operators/maybe/MaybeCache$CacheDisposable;


# instance fields
.field error:Ljava/lang/Throwable;

.field final nMS:Ljava/util/concurrent/atomic/AtomicReference;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.method static constructor <clinit>()V
    ...
    sput-object v1, Lio/reactivex/internal/operators/maybe/MaybeCache;->nMQ:[Lio/reactivex/internal/operators/maybe/MaybeCache$CacheDisposable;

    .line 32
    new-array v0, v0, [Lio/reactivex/internal/operators/maybe/MaybeCache$CacheDisposable;

    sput-object v0, Lio/reactivex/internal/operators/maybe/MaybeCache;->nMR:[Lio/reactivex/internal/operators/maybe/MaybeCache$CacheDisposable;
...
.method a(Lio/reactivex/internal/operators/maybe/MaybeCache$CacheDisposable;)Z
    ...
    .line 121
    sget-object v1, Lio/reactivex/internal/operators/maybe/MaybeCache;->nMR:[Lio/reactivex/internal/operators/maybe/MaybeCache$CacheDisposable;
...
.method public b(Lhiq;)V
    ...
    invoke-direct {v0, p1, p0}, Lio/reactivex/internal/operators/maybe/MaybeCache$CacheDisposable;-><init>(Lhiq;Lio/reactivex/internal/operators/maybe/MaybeCache;)V
    ...
    .line 75
    :cond_0
    iget-object p1, p0, Lio/reactivex/internal/operators/maybe/MaybeCache;->nMS:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    .line 77
    invoke-interface {p1, p0}, Lhis;->a(Lhiq;)V
    ...
    .line 62
    invoke-interface {p1, v0}, Lhiq;->onError(Ljava/lang/Throwable;)V
    ...
    .line 66
    invoke-interface {p1, v0}, Lhiq;->onSuccess(Ljava/lang/Object;)V

    goto :goto_0

    .line 68
    :cond_4
    invoke-interface {p1}, Lhiq;->onComplete()V
...
.method b(Lio/reactivex/internal/operators/maybe/MaybeCache$CacheDisposable;)V
    ...
    .line 160
    sget-object v1, Lio/reactivex/internal/operators/maybe/MaybeCache;->nMQ:[Lio/reactivex/internal/operators/maybe/MaybeCache$CacheDisposable;
...
.method public onComplete()V
    ...
    .line 113
    iget-object v3, v3, Lio/reactivex/internal/operators/maybe/MaybeCache$CacheDisposable;->actual:Lhiq;

    invoke-interface {v3}, Lhiq;->onComplete()V
...
.method public onError(Ljava/lang/Throwable;)V
    ...
    invoke-interface {v3, p1}, Lhiq;->onError(Ljava/lang/Throwable;)V
...
.method public onSuccess(Ljava/lang/Object;)V
    ...
    invoke-interface {v3, p1}, Lhiq;->onSuccess(Ljava/lang/Object;)V
