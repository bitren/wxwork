...
.method constructor <init>(Lhiy;Lhjv;IZ)V
    ...
    .line 90
    iput-object p1, p0, Lio/reactivex/internal/operators/observable/ObservableZip$ZipCoordinator;->actual:Lhiy;

    .line 91
    iput-object p2, p0, Lio/reactivex/internal/operators/observable/ObservableZip$ZipCoordinator;->zipper:Lhjv;
...
.method cancelSources()V
    ...
    .line 137
    invoke-virtual {v3}, Lio/reactivex/internal/operators/observable/ObservableZip$a;->dispose()V
...
.method checkTerminated(ZZLhiy;ZLio/reactivex/internal/operators/observable/ObservableZip$a;)Z
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(ZZ",
    ...
    .line 226
    iget-object p1, p5, Lio/reactivex/internal/operators/observable/ObservableZip$a;->error:Ljava/lang/Throwable;
...
.method clear()V
    ...
    .line 143
    iget-object v3, v3, Lio/reactivex/internal/operators/observable/ObservableZip$a;->queue:Lhkz;
...
.method public drain()V
    ...
    .line 155
    iget-object v8, v7, Lio/reactivex/internal/operators/observable/ObservableZip$ZipCoordinator;->actual:Lhiy;
    ...
    .line 166
    iget-boolean v2, v6, Lio/reactivex/internal/operators/observable/ObservableZip$a;->done:Z

    .line 167
    iget-object v1, v6, Lio/reactivex/internal/operators/observable/ObservableZip$a;->queue:Lhkz;
    ...
    .line 170
    invoke-virtual/range {v1 .. v6}, Lio/reactivex/internal/operators/observable/ObservableZip$ZipCoordinator;->checkTerminated(ZZLhiy;ZLio/reactivex/internal/operators/observable/ObservableZip$a;)Z
    ...
    .line 179
    :cond_5
    iget-boolean v1, v6, Lio/reactivex/internal/operators/observable/ObservableZip$a;->done:Z
    ...
    .line 180
    iget-object v1, v6, Lio/reactivex/internal/operators/observable/ObservableZip$a;->error:Ljava/lang/Throwable;
    ...
    .line 183
    invoke-interface {v8, v1}, Lhiy;->onError(Ljava/lang/Throwable;)V
    ...
    :cond_8
    :try_start_0
    iget-object v1, v7, Lio/reactivex/internal/operators/observable/ObservableZip$ZipCoordinator;->zipper:Lhjv;

    invoke-virtual {v9}, [Ljava/lang/Object;->clone()Ljava/lang/Object;

    move-result-object v2

    invoke-interface {v1, v2}, Lhjv;->apply(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .line 205
    invoke-interface {v8, v1}, Lhiy;->onNext(Ljava/lang/Object;)V
    ...
    .line 201
    invoke-interface {v8, v0}, Lhiy;->onError(Ljava/lang/Throwable;)V
...
.method public subscribe([Lhix;I)V
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "([",
    ...
    .line 105
    iget-object p2, p0, Lio/reactivex/internal/operators/observable/ObservableZip$ZipCoordinator;->actual:Lhiy;

    invoke-interface {p2, p0}, Lhiy;->onSubscribe(Lhjj;)V
    ...
    invoke-interface {p2, v3}, Lhix;->subscribe(Lhiy;)V
