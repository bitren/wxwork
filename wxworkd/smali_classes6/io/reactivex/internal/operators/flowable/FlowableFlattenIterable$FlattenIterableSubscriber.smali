...
# direct methods
.method constructor <init>(Linu;Lhjv;I)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 119
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableFlattenIterable$FlattenIterableSubscriber;->actual:Linu;

    .line 120
    iput-object p2, p0, Lio/reactivex/internal/operators/flowable/FlowableFlattenIterable$FlattenIterableSubscriber;->mapper:Lhjv;
...
.method public cancel()V
    ...
    .line 210
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableFlattenIterable$FlattenIterableSubscriber;->s:Linv;
    ...
    .line 213
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableFlattenIterable$FlattenIterableSubscriber;->queue:Lhkh;
...
.method checkTerminated(ZZLinu;Lhkh;)Z
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(ZZ",
    ...
    .line 385
    invoke-interface {p4}, Lhkh;->clear()V
...
.method drain()V
    ...
    .line 223
    :cond_0
    iget-object v2, v1, Lio/reactivex/internal/operators/flowable/FlowableFlattenIterable$FlattenIterableSubscriber;->actual:Linu;

    .line 224
    iget-object v3, v1, Lio/reactivex/internal/operators/flowable/FlowableFlattenIterable$FlattenIterableSubscriber;->queue:Lhkh;
    ...
    .line 240
    :try_start_0
    invoke-interface {v3}, Lhkh;->poll()Ljava/lang/Object;
    ...
    .line 256
    :goto_2
    invoke-virtual {v1, v9, v11, v2, v3}, Lio/reactivex/internal/operators/flowable/FlowableFlattenIterable$FlattenIterableSubscriber;->checkTerminated(ZZLinu;Lhkh;)Z
    ...
    .line 266
    :try_start_1
    iget-object v6, v1, Lio/reactivex/internal/operators/flowable/FlowableFlattenIterable$FlattenIterableSubscriber;->mapper:Lhjv;

    invoke-interface {v6, v10}, Lhjv;->apply(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .line 273
    iget-object v3, v1, Lio/reactivex/internal/operators/flowable/FlowableFlattenIterable$FlattenIterableSubscriber;->s:Linv;
    ...
    .line 242
    invoke-static {v4}, Lhjl;->throwIfFatal(Ljava/lang/Throwable;)V

    .line 243
    iget-object v0, v1, Lio/reactivex/internal/operators/flowable/FlowableFlattenIterable$FlattenIterableSubscriber;->s:Linv;
    ...
    .line 248
    invoke-interface {v3}, Lhkh;->clear()V
    ...
    invoke-virtual {v1, v15, v4, v2, v3}, Lio/reactivex/internal/operators/flowable/FlowableFlattenIterable$FlattenIterableSubscriber;->checkTerminated(ZZLinu;Lhkh;)Z
    ...
    invoke-static {v15, v5}, Lhka;->requireNonNull(Ljava/lang/Object;Ljava/lang/String;)Ljava/lang/Object;
    ...
    invoke-virtual {v1, v5, v4, v2, v3}, Lio/reactivex/internal/operators/flowable/FlowableFlattenIterable$FlattenIterableSubscriber;->checkTerminated(ZZLinu;Lhkh;)Z
    ...
    .line 326
    invoke-static {v3}, Lhjl;->throwIfFatal(Ljava/lang/Throwable;)V
    ...
    .line 345
    invoke-interface {v3}, Lhkh;->isEmpty()Z
    ...
    .line 347
    :goto_6
    invoke-virtual {v1, v5, v15, v2, v3}, Lio/reactivex/internal/operators/flowable/FlowableFlattenIterable$FlattenIterableSubscriber;->checkTerminated(ZZLinu;Lhkh;)Z
...
.method public onSubscribe(Linv;)V
    ...
    .line 130
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableFlattenIterable$FlattenIterableSubscriber;->s:Linv;
    ...
    .line 140
    iput-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableFlattenIterable$FlattenIterableSubscriber;->queue:Lhkh;

    .line 141
    iput-boolean v2, p0, Lio/reactivex/internal/operators/flowable/FlowableFlattenIterable$FlattenIterableSubscriber;->done:Z

    .line 143
    iget-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableFlattenIterable$FlattenIterableSubscriber;->actual:Linu;
    ...
    .line 151
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableFlattenIterable$FlattenIterableSubscriber;->actual:Linu;
...
.method public poll()Ljava/lang/Object;
    ...
    .line 428
    :cond_0
    iget-object v2, p0, Lio/reactivex/internal/operators/flowable/FlowableFlattenIterable$FlattenIterableSubscriber;->mapper:Lhjv;

    invoke-interface {v2, v0}, Lhjv;->apply(Ljava/lang/Object;)Ljava/lang/Object;
