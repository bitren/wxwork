...
# direct methods
.method constructor <init>(Lhkb;Lhiz$c;ZI)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 494
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$ObserveOnConditionalSubscriber;->actual:Lhkb;
...
.method public onSubscribe(Linv;)V
    ...
    .line 499
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$ObserveOnConditionalSubscriber;->s:Linv;
    ...
    .line 500
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$ObserveOnConditionalSubscriber;->s:Linv;
    ...
    .line 510
    iput-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$ObserveOnConditionalSubscriber;->queue:Lhkh;

    .line 511
    iput-boolean v2, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$ObserveOnConditionalSubscriber;->done:Z

    .line 513
    iget-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$ObserveOnConditionalSubscriber;->actual:Lhkb;
    ...
    .line 520
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$ObserveOnConditionalSubscriber;->actual:Lhkb;
...
.method public poll()Ljava/lang/Object;
    ...
    .line 703
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$ObserveOnConditionalSubscriber;->queue:Lhkh;
    ...
    .line 708
    iget-object v3, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$ObserveOnConditionalSubscriber;->s:Linv;
...
.method runAsync()V
    ...
    .line 603
    iget-object v1, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$ObserveOnConditionalSubscriber;->queue:Lhkh;
    ...
    .line 629
    :goto_2
    invoke-virtual {p0, v10, v12, v0}, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$ObserveOnConditionalSubscriber;->checkTerminated(ZZLinu;)Z
    ...
    .line 637
    :cond_4
    invoke-interface {v0, v11}, Lhkb;->tryOnNext(Ljava/lang/Object;)Z
    ...
    .line 644
    iget-object v10, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$ObserveOnConditionalSubscriber;->s:Linv;

    invoke-interface {v10, v4, v5}, Linv;->request(J)V
    ...
    .line 623
    invoke-interface {v0, v2}, Lhkb;->onError(Ljava/lang/Throwable;)V

    .line 624
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$ObserveOnConditionalSubscriber;->worker:Lhiz$c;
    ...
    invoke-virtual {p0, v8, v9, v0}, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$ObserveOnConditionalSubscriber;->checkTerminated(ZZLinu;)Z
...
.method runBackfused()V
    ...
    .line 680
    iget-object v2, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$ObserveOnConditionalSubscriber;->actual:Lhkb;

    const/4 v3, 0x0

    invoke-interface {v2, v3}, Lhkb;->onNext(Ljava/lang/Object;)V
    ...
    .line 685
    iget-object v1, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$ObserveOnConditionalSubscriber;->actual:Lhkb;
...
.method runSync()V
    ...
    .line 570
    :cond_3
    invoke-interface {v0, v7}, Lhkb;->tryOnNext(Ljava/lang/Object;)Z
    ...
    .line 555
    iget-object v2, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$ObserveOnConditionalSubscriber;->s:Linv;

    invoke-interface {v2}, Linv;->cancel()V

    .line 556
    invoke-interface {v0, v1}, Lhkb;->onError(Ljava/lang/Throwable;)V
