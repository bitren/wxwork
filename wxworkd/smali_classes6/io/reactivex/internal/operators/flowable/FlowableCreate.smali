...
.field final nMh:Lio/reactivex/BackpressureStrategy;
...
.method public a(Linu;)V
    ...
    iget-object v1, p0, Lio/reactivex/internal/operators/flowable/FlowableCreate;->nMh:Lio/reactivex/BackpressureStrategy;
    ...
    invoke-static {}, Lio/reactivex/internal/operators/flowable/FlowableCreate;->eAH()I

    move-result v1

    invoke-direct {v0, p1, v1}, Lio/reactivex/internal/operators/flowable/FlowableCreate$BufferAsyncEmitter;-><init>(Linu;I)V
    ...
    invoke-direct {v0, p1}, Lio/reactivex/internal/operators/flowable/FlowableCreate$LatestAsyncEmitter;-><init>(Linu;)V
    ...
    invoke-direct {v0, p1}, Lio/reactivex/internal/operators/flowable/FlowableCreate$DropAsyncEmitter;-><init>(Linu;)V
    ...
    invoke-direct {v0, p1}, Lio/reactivex/internal/operators/flowable/FlowableCreate$ErrorAsyncEmitter;-><init>(Linu;)V
    ...
    invoke-direct {v0, p1}, Lio/reactivex/internal/operators/flowable/FlowableCreate$MissingEmitter;-><init>(Linu;)V
    ...
    .line 72
    :try_start_0
    iget-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableCreate;->nMg:Lhim;

    invoke-interface {p1, v0}, Lhim;->a(Lhil;)V
    :try_end_0
