...
.field private a:Lcom/xiaomi/push/service/ag;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Lcom/xiaomi/push/fa;->a:Landroid/content/SharedPreferences;

    invoke-static {p1}, Lcom/xiaomi/push/service/ag;->a(Landroid/content/Context;)Lcom/xiaomi/push/service/ag;

    move-result-object p1

    iput-object p1, p0, Lcom/xiaomi/push/fa;->a:Lcom/xiaomi/push/service/ag;
...
.method private a(Ljava/io/File;)Ljava/util/List;
    ...
    invoke-virtual {v0}, Lcom/xiaomi/push/ej;->a()Lcom/xiaomi/push/ei;
    ...
    :cond_0
    invoke-interface {v0}, Lcom/xiaomi/push/ei;->a()Ljava/lang/String;
    ...
    sget-object v5, Lcom/xiaomi/push/eo;->a:Ljava/lang/Object;
    ...
    iget-object v7, p0, Lcom/xiaomi/push/fa;->a:Landroid/content/Context;
    ...
    :cond_3
    invoke-static {v4}, Lcom/xiaomi/push/ac;->a([B)I
    ...
    :cond_4
    :try_start_6
    invoke-static {v8}, Lcom/xiaomi/push/y;->a(Ljava/io/Closeable;)V
    ...
    :cond_5
    :try_start_7
    invoke-static {v0, v2}, Lcom/xiaomi/push/en;->a(Ljava/lang/String;[B)[B
    ...
    invoke-static {v2, p1}, Lcom/xiaomi/push/js;->a(Lcom/xiaomi/push/jt;[B)V
...
.method private a()Z
    ...
    invoke-static {v0}, Lcom/xiaomi/push/as;->f(Landroid/content/Context;)Z
    ...
    invoke-direct {p0}, Lcom/xiaomi/push/fa;->c()Z
    ...
    invoke-static {v0}, Lcom/xiaomi/push/as;->g(Landroid/content/Context;)Z
    ...
    invoke-static {v0}, Lcom/xiaomi/push/as;->h(Landroid/content/Context;)Z
...
.method private b()Z
    ...
    iget-object v0, p0, Lcom/xiaomi/push/fa;->a:Lcom/xiaomi/push/service/ag;

    sget-object v1, Lcom/xiaomi/push/in;->L:Lcom/xiaomi/push/in;
    ...
    invoke-virtual {v0, v3, v4}, Lcom/xiaomi/push/service/ag;->a(II)I
...
.method private c()Z
    ...
    sget-object v1, Lcom/xiaomi/push/in;->J:Lcom/xiaomi/push/in;
    ...
    sget-object v3, Lcom/xiaomi/push/in;->K:Lcom/xiaomi/push/in;
...
.method public run()V
    ...
    invoke-static {v1}, Lcom/xiaomi/push/as;->c(Landroid/content/Context;)Z
    ...
    :cond_3
    invoke-direct {p0, v0}, Lcom/xiaomi/push/fa;->a(Ljava/io/File;)Ljava/util/List;

    move-result-object v1

    invoke-static {v1}, Lcom/xiaomi/push/ad;->a(Ljava/util/Collection;)Z
    ...
    invoke-direct {v3}, Lcom/xiaomi/push/jb;-><init>()V

    invoke-virtual {v3, v1}, Lcom/xiaomi/push/jb;->a(Ljava/util/List;)Lcom/xiaomi/push/jb;

    invoke-static {v3}, Lcom/xiaomi/push/js;->a(Lcom/xiaomi/push/jt;)[B
    ...
    invoke-direct {v3, v4, v5}, Lcom/xiaomi/push/jh;-><init>(Ljava/lang/String;Z)V

    sget-object v4, Lcom/xiaomi/push/is;->q:Lcom/xiaomi/push/is;

    iget-object v4, v4, Lcom/xiaomi/push/is;->a:Ljava/lang/String;

    invoke-virtual {v3, v4}, Lcom/xiaomi/push/jh;->c(Ljava/lang/String;)Lcom/xiaomi/push/jh;

    invoke-virtual {v3, v1}, Lcom/xiaomi/push/jh;->a([B)Lcom/xiaomi/push/jh;

    invoke-static {}, Lcom/xiaomi/push/ej;->a()Lcom/xiaomi/push/ej;

    move-result-object v1

    invoke-virtual {v1}, Lcom/xiaomi/push/ej;->a()Lcom/xiaomi/push/ei;
    ...
    invoke-interface {v1, v3, v4, v2}, Lcom/xiaomi/push/ei;->a(Lcom/xiaomi/push/jh;Lcom/xiaomi/push/ii;Lcom/xiaomi/push/iv;)V
