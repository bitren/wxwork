...
.field static final nQf:[Lio/reactivex/subjects/ReplaySubject$ReplayDisposable;

.field static final nQg:[Lio/reactivex/subjects/ReplaySubject$ReplayDisposable;


# instance fields
.field done:Z

.field final nQe:Lio/reactivex/subjects/ReplaySubject$a;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lio/reactivex/subjects/ReplaySubject$a<",
            "TT;>;"
...
.method static constructor <clinit>()V
    ...
    sput-object v1, Lio/reactivex/subjects/ReplaySubject;->nQf:[Lio/reactivex/subjects/ReplaySubject$ReplayDisposable;

    .line 143
    new-array v1, v0, [Lio/reactivex/subjects/ReplaySubject$ReplayDisposable;

    sput-object v1, Lio/reactivex/subjects/ReplaySubject;->nQg:[Lio/reactivex/subjects/ReplaySubject$ReplayDisposable;
...
.method public a(Lhiy;)V
    ...
    invoke-direct {v0, p1, p0}, Lio/reactivex/subjects/ReplaySubject$ReplayDisposable;-><init>(Lhiy;Lio/reactivex/subjects/ReplaySubject;)V
    ...
    .line 330
    :cond_0
    iget-object p1, p0, Lio/reactivex/subjects/ReplaySubject;->nQe:Lio/reactivex/subjects/ReplaySubject$a;
...
.method a(Lio/reactivex/subjects/ReplaySubject$ReplayDisposable;)Z
    ...
    .line 500
    sget-object v1, Lio/reactivex/subjects/ReplaySubject;->nQg:[Lio/reactivex/subjects/ReplaySubject$ReplayDisposable;
...
.method b(Lio/reactivex/subjects/ReplaySubject$ReplayDisposable;)V
    ...
    sget-object v1, Lio/reactivex/subjects/ReplaySubject;->nQf:[Lio/reactivex/subjects/ReplaySubject$ReplayDisposable;
...
.method eL(Ljava/lang/Object;)[Lio/reactivex/subjects/ReplaySubject$ReplayDisposable;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 549
    iget-object v0, p0, Lio/reactivex/subjects/ReplaySubject;->nQe:Lio/reactivex/subjects/ReplaySubject$a;
    ...
    sget-object v0, Lio/reactivex/subjects/ReplaySubject;->nQg:[Lio/reactivex/subjects/ReplaySubject$ReplayDisposable;
    ...
    .line 552
    :cond_0
    sget-object p1, Lio/reactivex/subjects/ReplaySubject;->nQg:[Lio/reactivex/subjects/ReplaySubject$ReplayDisposable;
...
.method public onComplete()V
    ...
    .line 385
    iget-object v1, p0, Lio/reactivex/subjects/ReplaySubject;->nQe:Lio/reactivex/subjects/ReplaySubject$a;

    .line 387
    invoke-interface {v1, v0}, Lio/reactivex/subjects/ReplaySubject$a;->addFinal(Ljava/lang/Object;)V

    .line 389
    invoke-virtual {p0, v0}, Lio/reactivex/subjects/ReplaySubject;->eL(Ljava/lang/Object;)[Lio/reactivex/subjects/ReplaySubject$ReplayDisposable;
...
.method public onError(Ljava/lang/Throwable;)V
    ...
    .line 371
    invoke-virtual {p0, p1}, Lio/reactivex/subjects/ReplaySubject;->eL(Ljava/lang/Object;)[Lio/reactivex/subjects/ReplaySubject$ReplayDisposable;
