...
.field private static final DEFAULT_ROOT_VALUE_SEPARATOR:Laks;
...
# instance fields
.field protected final transient _byteSymbolCanonicalizer:Lalw;
...
.field protected final transient _rootCharSymbols:Lalx;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/fasterxml/jackson/core/JsonFactory;->DEFAULT_ROOT_VALUE_SEPARATOR:Laks;
...
.method public constructor <init>()V
    ...
    .line 282
    invoke-direct {p0, v0}, Lcom/fasterxml/jackson/core/JsonFactory;-><init>(Lakq;)V
...
.method public constructor <init>(Lakq;)V
    ...
    .line 195
    invoke-static {}, Lalx;->BV()Lalx;

    move-result-object v0

    iput-object v0, p0, Lcom/fasterxml/jackson/core/JsonFactory;->_rootCharSymbols:Lalx;

    .line 206
    invoke-static {}, Lalw;->BK()Lalw;

    move-result-object v0

    iput-object v0, p0, Lcom/fasterxml/jackson/core/JsonFactory;->_byteSymbolCanonicalizer:Lalw;
    ...
    .line 264
    sget-object v0, Lcom/fasterxml/jackson/core/JsonFactory;->DEFAULT_ROOT_VALUE_SEPARATOR:Laks;

    iput-object v0, p0, Lcom/fasterxml/jackson/core/JsonFactory;->_rootValueSeparator:Laks;

    .line 284
    iput-object p1, p0, Lcom/fasterxml/jackson/core/JsonFactory;->_objectCodec:Lakq;

    return-void
.end method

.method protected constructor <init>(Lcom/fasterxml/jackson/core/JsonFactory;Lakq;)V
    .locals 0
    ...
    iput-object p2, p0, Lcom/fasterxml/jackson/core/JsonFactory;->_rootCharSymbols:Lalx;
    ...
    iput-object p2, p0, Lcom/fasterxml/jackson/core/JsonFactory;->_byteSymbolCanonicalizer:Lalw;
    ...
    .line 264
    sget-object p2, Lcom/fasterxml/jackson/core/JsonFactory;->DEFAULT_ROOT_VALUE_SEPARATOR:Laks;

    iput-object p2, p0, Lcom/fasterxml/jackson/core/JsonFactory;->_rootValueSeparator:Laks;

    const/4 p2, 0x0

    .line 293
    iput-object p2, p0, Lcom/fasterxml/jackson/core/JsonFactory;->_objectCodec:Lakq;
    ...
    .line 300
    iget-object p1, p1, Lcom/fasterxml/jackson/core/JsonFactory;->_rootValueSeparator:Laks;

    iput-object p1, p0, Lcom/fasterxml/jackson/core/JsonFactory;->_rootValueSeparator:Laks;
...
.method protected _createContext(Ljava/lang/Object;Z)Lale;
    .locals 2

    .line 1450
    new-instance v0, Lale;

    invoke-virtual {p0}, Lcom/fasterxml/jackson/core/JsonFactory;->_getBufferRecycler()Lama;

    move-result-object v1

    invoke-direct {v0, v1, p1, p2}, Lale;-><init>(Lama;Ljava/lang/Object;Z)V

    return-object v0
.end method

.method protected _createGenerator(Ljava/io/Writer;Lale;)Lcom/fasterxml/jackson/core/JsonGenerator;
    .locals 3
    ...
    iget-object v2, p0, Lcom/fasterxml/jackson/core/JsonFactory;->_objectCodec:Lakq;

    invoke-direct {v0, p2, v1, v2, p1}, Lalv;-><init>(Lale;ILakq;Ljava/io/Writer;)V
    ...
    .line 1311
    invoke-virtual {v0, p1}, Lalv;->a(Lcom/fasterxml/jackson/core/io/CharacterEscapes;)Lcom/fasterxml/jackson/core/JsonGenerator;

    .line 1313
    :cond_0
    iget-object p1, p0, Lcom/fasterxml/jackson/core/JsonFactory;->_rootValueSeparator:Laks;
    ...
    .line 1315
    invoke-virtual {v0, p1}, Lalv;->a(Laks;)Lcom/fasterxml/jackson/core/JsonGenerator;

    :cond_1
    return-object v0
.end method

.method protected _createParser(Ljava/io/InputStream;Lale;)Lcom/fasterxml/jackson/core/JsonParser;
    .locals 6
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    invoke-direct {v0, p2, p1}, Lalm;-><init>(Lale;Ljava/io/InputStream;)V

    iget v1, p0, Lcom/fasterxml/jackson/core/JsonFactory;->_parserFeatures:I

    iget-object v2, p0, Lcom/fasterxml/jackson/core/JsonFactory;->_objectCodec:Lakq;

    iget-object v3, p0, Lcom/fasterxml/jackson/core/JsonFactory;->_byteSymbolCanonicalizer:Lalw;

    iget-object v4, p0, Lcom/fasterxml/jackson/core/JsonFactory;->_rootCharSymbols:Lalx;

    iget v5, p0, Lcom/fasterxml/jackson/core/JsonFactory;->_factoryFeatures:I

    invoke-virtual/range {v0 .. v5}, Lalm;->a(ILakq;Lalw;Lalx;I)Lcom/fasterxml/jackson/core/JsonParser;
...
.method protected _createParser(Ljava/io/Reader;Lale;)Lcom/fasterxml/jackson/core/JsonParser;
    .locals 7
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    iget-object v4, p0, Lcom/fasterxml/jackson/core/JsonFactory;->_objectCodec:Lakq;

    iget-object v0, p0, Lcom/fasterxml/jackson/core/JsonFactory;->_rootCharSymbols:Lalx;

    iget v1, p0, Lcom/fasterxml/jackson/core/JsonFactory;->_factoryFeatures:I

    invoke-virtual {v0, v1}, Lalx;->he(I)Lalx;
    ...
    invoke-direct/range {v0 .. v5}, Lals;-><init>(Lale;ILjava/io/Reader;Lakq;Lalx;)V

    return-object v6
.end method

.method protected _createParser([BIILale;)Lcom/fasterxml/jackson/core/JsonParser;
    .locals 6
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    invoke-direct {v0, p4, p1, p2, p3}, Lalm;-><init>(Lale;[BII)V
...
.method protected _createParser([CIILale;Z)Lcom/fasterxml/jackson/core/JsonParser;
    .locals 12
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    iget-object v5, v0, Lcom/fasterxml/jackson/core/JsonFactory;->_objectCodec:Lakq;

    iget-object v1, v0, Lcom/fasterxml/jackson/core/JsonFactory;->_rootCharSymbols:Lalx;

    iget v2, v0, Lcom/fasterxml/jackson/core/JsonFactory;->_factoryFeatures:I

    invoke-virtual {v1, v2}, Lalx;->he(I)Lalx;
    ...
    invoke-direct/range {v1 .. v10}, Lals;-><init>(Lale;ILjava/io/Reader;Lakq;Lalx;[CIIZ)V

    return-object v11
.end method

.method protected _createUTF8Generator(Ljava/io/OutputStream;Lale;)Lcom/fasterxml/jackson/core/JsonGenerator;
    .locals 3
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    invoke-direct {v0, p2, v1, v2, p1}, Lalt;-><init>(Lale;ILakq;Ljava/io/OutputStream;)V
    ...
    .line 1334
    invoke-virtual {v0, p1}, Lalt;->a(Lcom/fasterxml/jackson/core/io/CharacterEscapes;)Lcom/fasterxml/jackson/core/JsonGenerator;
    ...
    .line 1338
    invoke-virtual {v0, p1}, Lalt;->a(Laks;)Lcom/fasterxml/jackson/core/JsonGenerator;

    :cond_1
    return-object v0
.end method

.method protected _createWriter(Ljava/io/OutputStream;Lcom/fasterxml/jackson/core/JsonEncoding;Lale;)Ljava/io/Writer;
    .locals 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    invoke-direct {p2, p3, p1}, Lall;-><init>(Lale;Ljava/io/OutputStream;)V
...
.method protected final _decorate(Ljava/io/InputStream;Lale;)Ljava/io/InputStream;
    .locals 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    .line 1364
    invoke-virtual {v0, p2, p1}, Lcom/fasterxml/jackson/core/io/InputDecorator;->decorate(Lale;Ljava/io/InputStream;)Ljava/io/InputStream;
...
.method protected final _decorate(Ljava/io/OutputStream;Lale;)Ljava/io/OutputStream;
    .locals 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    .line 1390
    invoke-virtual {v0, p2, p1}, Lcom/fasterxml/jackson/core/io/OutputDecorator;->decorate(Lale;Ljava/io/OutputStream;)Ljava/io/OutputStream;
...
.method protected final _decorate(Ljava/io/Reader;Lale;)Ljava/io/Reader;
    .locals 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    .line 1377
    invoke-virtual {v0, p2, p1}, Lcom/fasterxml/jackson/core/io/InputDecorator;->decorate(Lale;Ljava/io/Reader;)Ljava/io/Reader;
...
.method protected final _decorate(Ljava/io/Writer;Lale;)Ljava/io/Writer;
    .locals 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    .line 1403
    invoke-virtual {v0, p2, p1}, Lcom/fasterxml/jackson/core/io/OutputDecorator;->decorate(Lale;Ljava/io/Writer;)Ljava/io/Writer;
...
.method public _getBufferRecycler()Lama;
    .locals 3
...
.method public canUseSchema(Lakn;)Z
    .locals 1
...
.method public copy()Lcom/fasterxml/jackson/core/JsonFactory;
    ...
    invoke-direct {v0, p0, v1}, Lcom/fasterxml/jackson/core/JsonFactory;-><init>(Lcom/fasterxml/jackson/core/JsonFactory;Lakq;)V
...
.method public createGenerator(Ljava/io/File;Lcom/fasterxml/jackson/core/JsonEncoding;)Lcom/fasterxml/jackson/core/JsonGenerator;
    ...
    .line 1142
    invoke-virtual {p0, v0, p1}, Lcom/fasterxml/jackson/core/JsonFactory;->_createContext(Ljava/lang/Object;Z)Lale;

    move-result-object p1

    .line 1143
    invoke-virtual {p1, p2}, Lale;->a(Lcom/fasterxml/jackson/core/JsonEncoding;)V
    ...
    .line 1145
    invoke-virtual {p0, v0, p1}, Lcom/fasterxml/jackson/core/JsonFactory;->_decorate(Ljava/io/OutputStream;Lale;)Ljava/io/OutputStream;

    move-result-object p2

    invoke-virtual {p0, p2, p1}, Lcom/fasterxml/jackson/core/JsonFactory;->_createUTF8Generator(Ljava/io/OutputStream;Lale;)Lcom/fasterxml/jackson/core/JsonGenerator;
    ...
    .line 1147
    :cond_0
    invoke-virtual {p0, v0, p2, p1}, Lcom/fasterxml/jackson/core/JsonFactory;->_createWriter(Ljava/io/OutputStream;Lcom/fasterxml/jackson/core/JsonEncoding;Lale;)Ljava/io/Writer;

    move-result-object p2

    .line 1148
    invoke-virtual {p0, p2, p1}, Lcom/fasterxml/jackson/core/JsonFactory;->_decorate(Ljava/io/Writer;Lale;)Ljava/io/Writer;

    move-result-object p2

    invoke-virtual {p0, p2, p1}, Lcom/fasterxml/jackson/core/JsonFactory;->_createGenerator(Ljava/io/Writer;Lale;)Lcom/fasterxml/jackson/core/JsonGenerator;
...
.method public createGenerator(Ljava/io/OutputStream;Lcom/fasterxml/jackson/core/JsonEncoding;)Lcom/fasterxml/jackson/core/JsonGenerator;
    ...
    .line 1081
    invoke-virtual {p0, p1, v0}, Lcom/fasterxml/jackson/core/JsonFactory;->_createContext(Ljava/lang/Object;Z)Lale;

    move-result-object v0

    .line 1082
    invoke-virtual {v0, p2}, Lale;->a(Lcom/fasterxml/jackson/core/JsonEncoding;)V
    ...
    .line 1084
    invoke-virtual {p0, p1, v0}, Lcom/fasterxml/jackson/core/JsonFactory;->_decorate(Ljava/io/OutputStream;Lale;)Ljava/io/OutputStream;

    move-result-object p1

    invoke-virtual {p0, p1, v0}, Lcom/fasterxml/jackson/core/JsonFactory;->_createUTF8Generator(Ljava/io/OutputStream;Lale;)Lcom/fasterxml/jackson/core/JsonGenerator;
    ...
    .line 1086
    :cond_0
    invoke-virtual {p0, p1, p2, v0}, Lcom/fasterxml/jackson/core/JsonFactory;->_createWriter(Ljava/io/OutputStream;Lcom/fasterxml/jackson/core/JsonEncoding;Lale;)Ljava/io/Writer;

    move-result-object p1

    .line 1087
    invoke-virtual {p0, p1, v0}, Lcom/fasterxml/jackson/core/JsonFactory;->_decorate(Ljava/io/Writer;Lale;)Ljava/io/Writer;

    move-result-object p1

    invoke-virtual {p0, p1, v0}, Lcom/fasterxml/jackson/core/JsonFactory;->_createGenerator(Ljava/io/Writer;Lale;)Lcom/fasterxml/jackson/core/JsonGenerator;
...
.method public createParser(Ljava/io/File;)Lcom/fasterxml/jackson/core/JsonParser;
    ...
    .line 754
    invoke-virtual {p0, v1, v0}, Lcom/fasterxml/jackson/core/JsonFactory;->_decorate(Ljava/io/InputStream;Lale;)Ljava/io/InputStream;

    move-result-object p1

    invoke-virtual {p0, p1, v0}, Lcom/fasterxml/jackson/core/JsonFactory;->_createParser(Ljava/io/InputStream;Lale;)Lcom/fasterxml/jackson/core/JsonParser;
...
.method public createParser(Ljava/io/InputStream;)Lcom/fasterxml/jackson/core/JsonParser;
    ...
    .line 807
    invoke-virtual {p0, p1, v0}, Lcom/fasterxml/jackson/core/JsonFactory;->_decorate(Ljava/io/InputStream;Lale;)Ljava/io/InputStream;
...
.method public createParser(Ljava/io/Reader;)Lcom/fasterxml/jackson/core/JsonParser;
    ...
    .line 827
    invoke-virtual {p0, p1, v0}, Lcom/fasterxml/jackson/core/JsonFactory;->_decorate(Ljava/io/Reader;Lale;)Ljava/io/Reader;

    move-result-object p1

    invoke-virtual {p0, p1, v0}, Lcom/fasterxml/jackson/core/JsonFactory;->_createParser(Ljava/io/Reader;Lale;)Lcom/fasterxml/jackson/core/JsonParser;
...
.method public createParser(Ljava/lang/String;)Lcom/fasterxml/jackson/core/JsonParser;
    ...
    .line 884
    invoke-virtual {v4, v3}, Lale;->gi(I)[C
    ...
    .line 886
    invoke-virtual/range {v0 .. v5}, Lcom/fasterxml/jackson/core/JsonFactory;->_createParser([CIILale;Z)Lcom/fasterxml/jackson/core/JsonParser;
...
.method public createParser([B)Lcom/fasterxml/jackson/core/JsonParser;
    ...
    invoke-virtual {v1, v0, p1, v2, v3}, Lcom/fasterxml/jackson/core/io/InputDecorator;->decorate(Lale;[BII)Ljava/io/InputStream;
    ...
    .line 841
    invoke-virtual {p0, v1, v0}, Lcom/fasterxml/jackson/core/JsonFactory;->_createParser(Ljava/io/InputStream;Lale;)Lcom/fasterxml/jackson/core/JsonParser;
    ...
    invoke-virtual {p0, p1, v2, v1, v0}, Lcom/fasterxml/jackson/core/JsonFactory;->_createParser([BIILale;)Lcom/fasterxml/jackson/core/JsonParser;
...
.method public createParser([BII)Lcom/fasterxml/jackson/core/JsonParser;
    ...
    .line 861
    invoke-virtual {v1, v0, p1, p2, p3}, Lcom/fasterxml/jackson/core/io/InputDecorator;->decorate(Lale;[BII)Ljava/io/InputStream;
    ...
    .line 866
    :cond_0
    invoke-virtual {p0, p1, p2, p3, v0}, Lcom/fasterxml/jackson/core/JsonFactory;->_createParser([BIILale;)Lcom/fasterxml/jackson/core/JsonParser;
...
.method public createParser([CII)Lcom/fasterxml/jackson/core/JsonParser;
    ...
    invoke-virtual/range {v1 .. v6}, Lcom/fasterxml/jackson/core/JsonFactory;->_createParser([CIILale;Z)Lcom/fasterxml/jackson/core/JsonParser;
...
.method public getCodec()Lakq;
    ...
    .line 722
    iget-object v0, p0, Lcom/fasterxml/jackson/core/JsonFactory;->_objectCodec:Lakq;
...
.method public getRootValueSeparator()Ljava/lang/String;
    ...
    .line 701
    iget-object v0, p0, Lcom/fasterxml/jackson/core/JsonFactory;->_rootValueSeparator:Laks;
    ...
    :cond_0
    invoke-interface {v0}, Laks;->getValue()Ljava/lang/String;
...
.method public hasFormat(Lalc;)Lcom/fasterxml/jackson/core/format/MatchStrength;
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    .line 476
    invoke-virtual {p0, p1}, Lcom/fasterxml/jackson/core/JsonFactory;->hasJSONFormat(Lalc;)Lcom/fasterxml/jackson/core/format/MatchStrength;
...
.method protected hasJSONFormat(Lalc;)Lcom/fasterxml/jackson/core/format/MatchStrength;
    .locals 0
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    .line 504
    invoke-static {p1}, Lalm;->hasJSONFormat(Lalc;)Lcom/fasterxml/jackson/core/format/MatchStrength;
...
.method protected readResolve()Ljava/lang/Object;
    ...
    iget-object v1, p0, Lcom/fasterxml/jackson/core/JsonFactory;->_objectCodec:Lakq;
...
.method public setCodec(Lakq;)Lcom/fasterxml/jackson/core/JsonFactory;
    .locals 0
...
.method public version()Lcom/fasterxml/jackson/core/Version;
    ...
    .line 515
    sget-object v0, Lalr;->aZH:Lcom/fasterxml/jackson/core/Version;
