...
.method public constructor <init>(Lcom/fasterxml/jackson/databind/JavaType;Laml;Lapg;Lanr;)V
    ...
    .line 33
    invoke-direct {p0, p1, p2, p3, p4}, Lcom/fasterxml/jackson/databind/deser/std/CollectionDeserializer;-><init>(Lcom/fasterxml/jackson/databind/JavaType;Laml;Lapg;Lanr;)V
...
.method protected constructor <init>(Lcom/fasterxml/jackson/databind/JavaType;Laml;Lapg;Lanr;Laml;Ljava/lang/Boolean;)V
    ...
    .line 44
    invoke-direct/range {p0 .. p6}, Lcom/fasterxml/jackson/databind/deser/std/CollectionDeserializer;-><init>(Lcom/fasterxml/jackson/databind/JavaType;Laml;Lapg;Lanr;Laml;Ljava/lang/Boolean;)V
...
.method public deserialize(Lcom/fasterxml/jackson/core/JsonParser;Lcom/fasterxml/jackson/databind/DeserializationContext;)Ljava/util/Collection;
    ...
    .line 84
    iget-object v0, p0, Lcom/fasterxml/jackson/databind/deser/std/ArrayBlockingQueueDeserializer;->_delegateDeserializer:Laml;

    if-eqz v0, :cond_0

    .line 85
    iget-object v0, p0, Lcom/fasterxml/jackson/databind/deser/std/ArrayBlockingQueueDeserializer;->_valueInstantiator:Lanr;

    iget-object v1, p0, Lcom/fasterxml/jackson/databind/deser/std/ArrayBlockingQueueDeserializer;->_delegateDeserializer:Laml;
    ...
    .line 91
    iget-object p1, p0, Lcom/fasterxml/jackson/databind/deser/std/ArrayBlockingQueueDeserializer;->_valueInstantiator:Lanr;
...
.method public deserialize(Lcom/fasterxml/jackson/core/JsonParser;Lcom/fasterxml/jackson/databind/DeserializationContext;Ljava/util/Collection;)Ljava/util/Collection;
    ...
    .line 106
    iget-object v1, p0, Lcom/fasterxml/jackson/databind/deser/std/ArrayBlockingQueueDeserializer;->_valueDeserializer:Laml;

    .line 108
    iget-object v2, p0, Lcom/fasterxml/jackson/databind/deser/std/ArrayBlockingQueueDeserializer;->_valueTypeDeserializer:Lapg;
...
.method protected withResolved(Laml;Laml;Lapg;Ljava/lang/Boolean;)Lcom/fasterxml/jackson/databind/deser/std/ArrayBlockingQueueDeserializer;
    .locals 8
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iget-object v0, p0, Lcom/fasterxml/jackson/databind/deser/std/ArrayBlockingQueueDeserializer;->_valueDeserializer:Laml;

    if-ne p2, v0, :cond_0

    iget-object v0, p0, Lcom/fasterxml/jackson/databind/deser/std/ArrayBlockingQueueDeserializer;->_valueTypeDeserializer:Lapg;
    ...
    iget-object v5, p0, Lcom/fasterxml/jackson/databind/deser/std/ArrayBlockingQueueDeserializer;->_valueInstantiator:Lanr;
    ...
    invoke-direct/range {v1 .. v7}, Lcom/fasterxml/jackson/databind/deser/std/ArrayBlockingQueueDeserializer;-><init>(Lcom/fasterxml/jackson/databind/JavaType;Laml;Lapg;Lanr;Laml;Ljava/lang/Boolean;)V

    return-object v0
.end method

.method protected bridge synthetic withResolved(Laml;Laml;Lapg;Ljava/lang/Boolean;)Lcom/fasterxml/jackson/databind/deser/std/CollectionDeserializer;
    .locals 0

    .line 18
    invoke-virtual {p0, p1, p2, p3, p4}, Lcom/fasterxml/jackson/databind/deser/std/ArrayBlockingQueueDeserializer;->withResolved(Laml;Laml;Lapg;Ljava/lang/Boolean;)Lcom/fasterxml/jackson/databind/deser/std/ArrayBlockingQueueDeserializer;
