...
.method protected constructor <init>()V
    ...
    .line 49
    iput-object v0, p0, Lcom/fasterxml/jackson/databind/ser/impl/StringArraySerializer;->_elementSerializer:Lamo;

    return-void
.end method

.method public constructor <init>(Lcom/fasterxml/jackson/databind/ser/impl/StringArraySerializer;Lamj;Lamo;Ljava/lang/Boolean;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 56
    iput-object p3, p0, Lcom/fasterxml/jackson/databind/ser/impl/StringArraySerializer;->_elementSerializer:Lamo;

    return-void
.end method

.method private serializeContentsSlow([Ljava/lang/String;Lcom/fasterxml/jackson/core/JsonGenerator;Lamt;Lamo;)V
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "([",
    ...
    invoke-virtual {p4, v2, p2, p3}, Lamo;->serialize(Ljava/lang/Object;Lcom/fasterxml/jackson/core/JsonGenerator;Lamt;)V
...
.method public _withResolved(Lamj;Ljava/lang/Boolean;)Lamo;
    ...
    iget-object v1, p0, Lcom/fasterxml/jackson/databind/ser/impl/StringArraySerializer;->_elementSerializer:Lamo;

    invoke-direct {v0, p0, p1, v1, p2}, Lcom/fasterxml/jackson/databind/ser/impl/StringArraySerializer;-><init>(Lcom/fasterxml/jackson/databind/ser/impl/StringArraySerializer;Lamj;Lamo;Ljava/lang/Boolean;)V
...
.method public acceptJsonFormatVisitor(Laou;Lcom/fasterxml/jackson/databind/JavaType;)V
    ...
    invoke-virtual {p0, p1, p2, v0}, Lcom/fasterxml/jackson/databind/ser/impl/StringArraySerializer;->visitArrayFormat(Laou;Lcom/fasterxml/jackson/databind/JavaType;Lcom/fasterxml/jackson/databind/jsonFormatVisitors/JsonFormatTypes;)V
...
.method public createContextual(Lamt;Lamj;)Lamo;
    ...
    invoke-virtual {p0, p1, p2, v2, v3}, Lcom/fasterxml/jackson/databind/ser/impl/StringArraySerializer;->findFormatFeature(Lamt;Lamj;Ljava/lang/Class;Lcom/fasterxml/jackson/annotation/JsonFormat$Feature;)Ljava/lang/Boolean;
    ...
    .line 109
    :cond_1
    invoke-virtual {p0, p1, p2, v1}, Lcom/fasterxml/jackson/databind/ser/impl/StringArraySerializer;->findConvertingContentSerializer(Lamt;Lamj;Lamo;)Lamo;
    ...
    .line 116
    :goto_1
    invoke-virtual {p0, p1}, Lcom/fasterxml/jackson/databind/ser/impl/StringArraySerializer;->isDefaultSerializer(Lamo;)Z
    ...
    .line 120
    :cond_3
    iget-object v0, p0, Lcom/fasterxml/jackson/databind/ser/impl/StringArraySerializer;->_elementSerializer:Lamo;
    ...
    invoke-direct {v0, p0, p2, p1, v2}, Lcom/fasterxml/jackson/databind/ser/impl/StringArraySerializer;-><init>(Lcom/fasterxml/jackson/databind/ser/impl/StringArraySerializer;Lamj;Lamo;Ljava/lang/Boolean;)V
...
.method public getSchema(Lamt;Ljava/lang/reflect/Type;)Lamm;
    ...
    .line 213
    invoke-virtual {p0, p1, p2}, Lcom/fasterxml/jackson/databind/ser/impl/StringArraySerializer;->createSchemaNode(Ljava/lang/String;Z)Laqj;
    ...
    invoke-virtual {p0, v0}, Lcom/fasterxml/jackson/databind/ser/impl/StringArraySerializer;->createSchemaNode(Ljava/lang/String;)Laqj;
...
.method public bridge synthetic isEmpty(Lamt;Ljava/lang/Object;)Z
    ...
    invoke-virtual {p0, p1, p2}, Lcom/fasterxml/jackson/databind/ser/impl/StringArraySerializer;->isEmpty(Lamt;[Ljava/lang/String;)Z
...
.method public isEmpty(Lamt;[Ljava/lang/String;)Z
    .locals 0
...
.method public bridge synthetic serialize(Ljava/lang/Object;Lcom/fasterxml/jackson/core/JsonGenerator;Lamt;)V
    ...
    invoke-virtual {p0, p1, p2, p3}, Lcom/fasterxml/jackson/databind/ser/impl/StringArraySerializer;->serialize([Ljava/lang/String;Lcom/fasterxml/jackson/core/JsonGenerator;Lamt;)V

    return-void
.end method

.method public final serialize([Ljava/lang/String;Lcom/fasterxml/jackson/core/JsonGenerator;Lamt;)V
    .locals 3
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    .line 167
    :cond_1
    invoke-virtual {p0, p1, p2, p3}, Lcom/fasterxml/jackson/databind/ser/impl/StringArraySerializer;->serializeContents([Ljava/lang/String;Lcom/fasterxml/jackson/core/JsonGenerator;Lamt;)V
...
.method public serializeContents([Ljava/lang/String;Lcom/fasterxml/jackson/core/JsonGenerator;Lamt;)V
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    .line 185
    invoke-direct {p0, p1, p2, p3, v1}, Lcom/fasterxml/jackson/databind/ser/impl/StringArraySerializer;->serializeContentsSlow([Ljava/lang/String;Lcom/fasterxml/jackson/core/JsonGenerator;Lamt;Lamo;)V
