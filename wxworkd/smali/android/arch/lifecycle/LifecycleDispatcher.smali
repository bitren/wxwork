...
# static fields
.field private static gt:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/arch/lifecycle/LifecycleDispatcher;->gt:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method private static a(Landroid/support/v4/app/Fragment;Landroid/arch/lifecycle/Lifecycle$Event;)V
    .locals 1
...
.method private static a(Landroid/support/v4/app/FragmentActivity;Landroid/arch/lifecycle/Lifecycle$State;)V
    .locals 0
    ...
    invoke-static {p0, p1}, Landroid/arch/lifecycle/LifecycleDispatcher;->a(Lfa;Landroid/arch/lifecycle/Lifecycle$State;)V

    return-void
.end method

.method private static a(Lfa;Landroid/arch/lifecycle/Lifecycle$State;)V
    .locals 2
    ...
    .line 131
    invoke-virtual {v0}, Landroid/support/v4/app/Fragment;->getChildFragmentManager()Lfa;

    move-result-object v0

    invoke-static {v0, p1}, Landroid/arch/lifecycle/LifecycleDispatcher;->a(Lfa;Landroid/arch/lifecycle/Lifecycle$State;)V
...
.method static synthetic b(Landroid/support/v4/app/Fragment;Landroid/arch/lifecycle/Lifecycle$Event;)V
    .locals 0

    .line 47
    invoke-static {p0, p1}, Landroid/arch/lifecycle/LifecycleDispatcher;->a(Landroid/support/v4/app/Fragment;Landroid/arch/lifecycle/Lifecycle$Event;)V

    return-void
.end method

.method static synthetic b(Landroid/support/v4/app/FragmentActivity;Landroid/arch/lifecycle/Lifecycle$State;)V
    .locals 0

    .line 47
    invoke-static {p0, p1}, Landroid/arch/lifecycle/LifecycleDispatcher;->a(Landroid/support/v4/app/FragmentActivity;Landroid/arch/lifecycle/Lifecycle$State;)V
...
.method static init(Landroid/content/Context;)V
    ...
    .line 55
    sget-object v0, Landroid/arch/lifecycle/LifecycleDispatcher;->gt:Ljava/util/concurrent/atomic/AtomicBoolean;
