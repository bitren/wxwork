...
# instance fields
.field private final ge:Landroid/arch/lifecycle/LiveData;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.field final gh:Ljava/lang/Runnable;

.field final gi:Ljava/lang/Runnable;
...
.method public constructor <init>()V
    ...
    .line 54
    invoke-static {}, Lb;->Z()Ljava/util/concurrent/Executor;
...
.method public constructor <init>(Ljava/util/concurrent/Executor;)V
    ...
    iput-object v0, p0, Landroid/arch/lifecycle/ComputableLiveData;->gf:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    iput-object v0, p0, Landroid/arch/lifecycle/ComputableLiveData;->gg:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    iput-object v0, p0, Landroid/arch/lifecycle/ComputableLiveData;->gh:Ljava/lang/Runnable;
    ...
    iput-object v0, p0, Landroid/arch/lifecycle/ComputableLiveData;->gi:Ljava/lang/Runnable;
    ...
    iput-object p1, p0, Landroid/arch/lifecycle/ComputableLiveData;->ge:Landroid/arch/lifecycle/LiveData;
...
.method static synthetic b(Landroid/arch/lifecycle/ComputableLiveData;)Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    .line 41
    iget-object p0, p0, Landroid/arch/lifecycle/ComputableLiveData;->gg:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method static synthetic c(Landroid/arch/lifecycle/ComputableLiveData;)Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    .line 41
    iget-object p0, p0, Landroid/arch/lifecycle/ComputableLiveData;->gf:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method static synthetic d(Landroid/arch/lifecycle/ComputableLiveData;)Landroid/arch/lifecycle/LiveData;
    ...
    .line 41
    iget-object p0, p0, Landroid/arch/lifecycle/ComputableLiveData;->ge:Landroid/arch/lifecycle/LiveData;
...
.method public getLiveData()Landroid/arch/lifecycle/LiveData;
    ...
    .line 82
    iget-object v0, p0, Landroid/arch/lifecycle/ComputableLiveData;->ge:Landroid/arch/lifecycle/LiveData;
...
.method public invalidate()V
    ...
    iget-object v1, p0, Landroid/arch/lifecycle/ComputableLiveData;->gi:Ljava/lang/Runnable;

    invoke-virtual {v0, v1}, Lb;->d(Ljava/lang/Runnable;)V
