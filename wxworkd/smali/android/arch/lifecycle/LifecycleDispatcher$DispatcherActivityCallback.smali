...
# instance fields
.field private final gu:Landroid/arch/lifecycle/LifecycleDispatcher$FragmentCallback;
...
.method constructor <init>()V
    ...
    iput-object v0, p0, Landroid/arch/lifecycle/LifecycleDispatcher$DispatcherActivityCallback;->gu:Landroid/arch/lifecycle/LifecycleDispatcher$FragmentCallback;
...
.method public onActivityCreated(Landroid/app/Activity;Landroid/os/Bundle;)V
    ...
    invoke-virtual {p2}, Landroid/support/v4/app/FragmentActivity;->getSupportFragmentManager()Lfa;

    move-result-object p2

    iget-object v0, p0, Landroid/arch/lifecycle/LifecycleDispatcher$DispatcherActivityCallback;->gu:Landroid/arch/lifecycle/LifecycleDispatcher$FragmentCallback;

    const/4 v1, 0x1

    .line 75
    invoke-virtual {p2, v0, v1}, Lfa;->a(Lfa$b;Z)V
...
.method public onActivitySaveInstanceState(Landroid/app/Activity;Landroid/os/Bundle;)V
    ...
    invoke-static {p1, p2}, Landroid/arch/lifecycle/LifecycleDispatcher;->b(Landroid/support/v4/app/FragmentActivity;Landroid/arch/lifecycle/Lifecycle$State;)V
...
.method public onActivityStopped(Landroid/app/Activity;)V
    ...
    invoke-static {p1, v0}, Landroid/arch/lifecycle/LifecycleDispatcher;->b(Landroid/support/v4/app/FragmentActivity;Landroid/arch/lifecycle/Lifecycle$State;)V
