...
# static fields
.field private static final gI:Ljava/lang/Object;
...
.field private volatile gL:Ljava/lang/Object;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/arch/lifecycle/LiveData;->gI:Ljava/lang/Object;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Landroid/arch/lifecycle/LiveData;->gH:Ljava/lang/Object;
    ...
    iput-object v0, p0, Landroid/arch/lifecycle/LiveData;->gJ:Lf;

    const/4 v0, 0x0

    .line 68
    iput v0, p0, Landroid/arch/lifecycle/LiveData;->gK:I

    .line 69
    sget-object v0, Landroid/arch/lifecycle/LiveData;->gI:Ljava/lang/Object;

    iput-object v0, p0, Landroid/arch/lifecycle/LiveData;->mData:Ljava/lang/Object;

    .line 72
    iput-object v0, p0, Landroid/arch/lifecycle/LiveData;->gL:Ljava/lang/Object;
    ...
    iput-object v0, p0, Landroid/arch/lifecycle/LiveData;->gO:Ljava/lang/Runnable;
...
.method static synthetic a(Landroid/arch/lifecycle/LiveData;I)I
    ...
    .line 59
    iput p1, p0, Landroid/arch/lifecycle/LiveData;->gK:I
...
.method static synthetic a(Landroid/arch/lifecycle/LiveData;)Ljava/lang/Object;
    ...
    .line 59
    iget-object p0, p0, Landroid/arch/lifecycle/LiveData;->gH:Ljava/lang/Object;
...
.method static synthetic a(Landroid/arch/lifecycle/LiveData;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .line 59
    iput-object p1, p0, Landroid/arch/lifecycle/LiveData;->gL:Ljava/lang/Object;
...
.method private a(Landroid/arch/lifecycle/LiveData$ObserverWrapper;)V
    ...
    .line 92
    iget-boolean v0, p1, Landroid/arch/lifecycle/LiveData$ObserverWrapper;->gS:Z
    ...
    .line 100
    :cond_0
    invoke-virtual {p1}, Landroid/arch/lifecycle/LiveData$ObserverWrapper;->ap()Z
    ...
    .line 101
    invoke-virtual {p1, v0}, Landroid/arch/lifecycle/LiveData$ObserverWrapper;->m(Z)V

    return-void

    .line 104
    :cond_1
    iget v0, p1, Landroid/arch/lifecycle/LiveData$ObserverWrapper;->gT:I
    ...
    .line 107
    :cond_2
    iput v1, p1, Landroid/arch/lifecycle/LiveData$ObserverWrapper;->gT:I

    .line 109
    iget-object p1, p1, Landroid/arch/lifecycle/LiveData$ObserverWrapper;->gR:Landroid/arch/lifecycle/Observer;
...
.method static synthetic ao()Ljava/lang/Object;
    .locals 1
...
.method static synthetic b(Landroid/arch/lifecycle/LiveData;)Ljava/lang/Object;
    ...
    .line 59
    iget-object p0, p0, Landroid/arch/lifecycle/LiveData;->gL:Ljava/lang/Object;
...
.method private b(Landroid/arch/lifecycle/LiveData$ObserverWrapper;)V
    ...
    .line 113
    iget-boolean v0, p0, Landroid/arch/lifecycle/LiveData;->gM:Z
    ...
    .line 114
    iput-boolean v1, p0, Landroid/arch/lifecycle/LiveData;->gN:Z

    return-void

    .line 117
    :cond_0
    iput-boolean v1, p0, Landroid/arch/lifecycle/LiveData;->gM:Z

    :cond_1
    const/4 v0, 0x0

    .line 119
    iput-boolean v0, p0, Landroid/arch/lifecycle/LiveData;->gN:Z
    ...
    .line 124
    :cond_2
    iget-object v1, p0, Landroid/arch/lifecycle/LiveData;->gJ:Lf;

    .line 125
    invoke-virtual {v1}, Lf;->aa()Lf$d;
    ...
    .line 127
    iget-boolean v2, p0, Landroid/arch/lifecycle/LiveData;->gN:Z
    ...
    :cond_4
    :goto_0
    iget-boolean v1, p0, Landroid/arch/lifecycle/LiveData;->gN:Z

    if-nez v1, :cond_1

    .line 133
    iput-boolean v0, p0, Landroid/arch/lifecycle/LiveData;->gM:Z
...
.method static synthetic c(Landroid/arch/lifecycle/LiveData;)I
    ...
    .line 59
    iget p0, p0, Landroid/arch/lifecycle/LiveData;->gK:I
...
.method private static z(Ljava/lang/String;)V
    ...
    .line 434
    invoke-static {}, Lb;->Y()Lb;

    move-result-object v0

    invoke-virtual {v0}, Lb;->isMainThread()Z
...
.method public getValue()Ljava/lang/Object;
    ...
    .line 295
    sget-object v1, Landroid/arch/lifecycle/LiveData;->gI:Ljava/lang/Object;
...
.method public hasActiveObservers()Z
    ...
    .line 346
    iget v0, p0, Landroid/arch/lifecycle/LiveData;->gK:I
...
.method public hasObservers()Z
    ...
    .line 336
    iget-object v0, p0, Landroid/arch/lifecycle/LiveData;->gJ:Lf;

    invoke-virtual {v0}, Lf;->size()I
...
.method public observe(Landroid/arch/lifecycle/LifecycleOwner;Landroid/arch/lifecycle/Observer;)V
    ...
    invoke-virtual {v1, p2, v0}, Lf;->putIfAbsent(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .line 172
    invoke-virtual {p2, p1}, Landroid/arch/lifecycle/LiveData$ObserverWrapper;->c(Landroid/arch/lifecycle/LifecycleOwner;)Z
...
.method public observeForever(Landroid/arch/lifecycle/Observer;)V
    ...
    invoke-virtual {v1, p1, v0}, Lf;->putIfAbsent(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .line 207
    invoke-virtual {v0, p1}, Landroid/arch/lifecycle/LiveData$AlwaysActiveObserver;->m(Z)V
...
.method protected postValue(Ljava/lang/Object;)V
    ...
    .line 259
    iget-object v0, p0, Landroid/arch/lifecycle/LiveData;->gH:Ljava/lang/Object;

    monitor-enter v0

    .line 260
    :try_start_0
    iget-object v1, p0, Landroid/arch/lifecycle/LiveData;->gL:Ljava/lang/Object;

    sget-object v2, Landroid/arch/lifecycle/LiveData;->gI:Ljava/lang/Object;
    ...
    iget-object v0, p0, Landroid/arch/lifecycle/LiveData;->gO:Ljava/lang/Runnable;

    invoke-virtual {p1, v0}, Lb;->postToMainThread(Ljava/lang/Runnable;)V
...
.method public removeObserver(Landroid/arch/lifecycle/Observer;)V
    ...
    .line 222
    :cond_0
    invoke-virtual {p1}, Landroid/arch/lifecycle/LiveData$ObserverWrapper;->aq()V
...
.method public removeObservers(Landroid/arch/lifecycle/LifecycleOwner;)V
    ...
    invoke-virtual {v0}, Lf;->iterator()Ljava/util/Iterator;
    ...
    invoke-virtual {v2, p1}, Landroid/arch/lifecycle/LiveData$ObserverWrapper;->c(Landroid/arch/lifecycle/LifecycleOwner;)Z
