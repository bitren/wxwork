...
.field private gw:Landroid/arch/lifecycle/Lifecycle$State;

.field private final gx:Ljava/lang/ref/WeakReference;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.method public constructor <init>(Landroid/arch/lifecycle/LifecycleOwner;)V
    ...
    iput-object v0, p0, Landroid/arch/lifecycle/LifecycleRegistry;->gv:Le;

    const/4 v0, 0x0

    .line 74
    iput v0, p0, Landroid/arch/lifecycle/LifecycleRegistry;->gy:I

    .line 76
    iput-boolean v0, p0, Landroid/arch/lifecycle/LifecycleRegistry;->gz:Z

    .line 77
    iput-boolean v0, p0, Landroid/arch/lifecycle/LifecycleRegistry;->gA:Z
    ...
    iput-object v0, p0, Landroid/arch/lifecycle/LifecycleRegistry;->gB:Ljava/util/ArrayList;
    ...
    iput-object v0, p0, Landroid/arch/lifecycle/LifecycleRegistry;->gx:Ljava/lang/ref/WeakReference;

    .line 99
    sget-object p1, Landroid/arch/lifecycle/Lifecycle$State;->INITIALIZED:Landroid/arch/lifecycle/Lifecycle$State;

    iput-object p1, p0, Landroid/arch/lifecycle/LifecycleRegistry;->gw:Landroid/arch/lifecycle/Lifecycle$State;
...
.method private a(Landroid/arch/lifecycle/LifecycleObserver;)Landroid/arch/lifecycle/Lifecycle$State;
    ...
    .line 151
    iget-object v0, p0, Landroid/arch/lifecycle/LifecycleRegistry;->gv:Le;

    invoke-virtual {v0, p1}, Le;->g(Ljava/lang/Object;)Ljava/util/Map$Entry;
    ...
    iget-object p1, p1, Landroid/arch/lifecycle/LifecycleRegistry$ObserverWithState;->gw:Landroid/arch/lifecycle/Lifecycle$State;
    ...
    .line 154
    :goto_0
    iget-object v1, p0, Landroid/arch/lifecycle/LifecycleRegistry;->gB:Ljava/util/ArrayList;
    ...
    iget-object v0, p0, Landroid/arch/lifecycle/LifecycleRegistry;->gB:Ljava/util/ArrayList;
    ...
    .line 156
    :cond_1
    iget-object v1, p0, Landroid/arch/lifecycle/LifecycleRegistry;->gw:Landroid/arch/lifecycle/Lifecycle$State;
...
.method private a(Landroid/arch/lifecycle/Lifecycle$State;)V
    ...
    .line 127
    iget-object v0, p0, Landroid/arch/lifecycle/LifecycleRegistry;->gw:Landroid/arch/lifecycle/Lifecycle$State;
    ...
    .line 131
    iget-boolean p1, p0, Landroid/arch/lifecycle/LifecycleRegistry;->gz:Z

    const/4 v0, 0x1

    if-nez p1, :cond_2

    iget p1, p0, Landroid/arch/lifecycle/LifecycleRegistry;->gy:I
    ...
    .line 138
    iput-boolean p1, p0, Landroid/arch/lifecycle/LifecycleRegistry;->gz:Z
...
.method private a(Landroid/arch/lifecycle/LifecycleOwner;)V
    ...
    iget-boolean v1, p0, Landroid/arch/lifecycle/LifecycleRegistry;->gA:Z
    ...
    .line 289
    :goto_0
    iget-object v3, v2, Landroid/arch/lifecycle/LifecycleRegistry$ObserverWithState;->gw:Landroid/arch/lifecycle/Lifecycle$State;

    iget-object v4, p0, Landroid/arch/lifecycle/LifecycleRegistry;->gw:Landroid/arch/lifecycle/Lifecycle$State;
    ...
    iget-boolean v3, p0, Landroid/arch/lifecycle/LifecycleRegistry;->gA:Z

    if-nez v3, :cond_0

    iget-object v3, p0, Landroid/arch/lifecycle/LifecycleRegistry;->gv:Le;
    ...
    invoke-virtual {v3, v4}, Le;->contains(Ljava/lang/Object;)Z
    ...
    .line 293
    invoke-direct {p0}, Landroid/arch/lifecycle/LifecycleRegistry;->am()V
...
.method private al()Z
    ...
    invoke-virtual {v0}, Le;->ad()Ljava/util/Map$Entry;
    ...
    iget-object v0, v0, Landroid/arch/lifecycle/LifecycleRegistry$ObserverWithState;->gw:Landroid/arch/lifecycle/Lifecycle$State;

    .line 146
    iget-object v2, p0, Landroid/arch/lifecycle/LifecycleRegistry;->gv:Le;

    invoke-virtual {v2}, Le;->af()Ljava/util/Map$Entry;
    ...
    iget-object v2, v2, Landroid/arch/lifecycle/LifecycleRegistry$ObserverWithState;->gw:Landroid/arch/lifecycle/Lifecycle$State;
...
.method static b(Landroid/arch/lifecycle/Lifecycle$Event;)Landroid/arch/lifecycle/Lifecycle$State;
    ...
    .line 235
    sget-object v0, Landroid/arch/lifecycle/LifecycleRegistry$1;->gl:[I
...
.method private b(Landroid/arch/lifecycle/LifecycleOwner;)V
    ...
    .line 300
    invoke-virtual {v0}, Le;->descendingIterator()Ljava/util/Iterator;
...
.method private static c(Landroid/arch/lifecycle/Lifecycle$State;)Landroid/arch/lifecycle/Lifecycle$Event;
    ...
    .line 253
    sget-object v0, Landroid/arch/lifecycle/LifecycleRegistry$1;->gC:[I
...
.method private sync()V
    ...
    .line 317
    iget-object v0, p0, Landroid/arch/lifecycle/LifecycleRegistry;->gx:Ljava/lang/ref/WeakReference;
    ...
    :cond_0
    :goto_0
    invoke-direct {p0}, Landroid/arch/lifecycle/LifecycleRegistry;->al()Z
    ...
    .line 324
    iput-boolean v2, p0, Landroid/arch/lifecycle/LifecycleRegistry;->gA:Z
    ...
    invoke-virtual {v2}, Le;->ad()Ljava/util/Map$Entry;
    ...
    .line 329
    :cond_1
    iget-object v1, p0, Landroid/arch/lifecycle/LifecycleRegistry;->gv:Le;

    invoke-virtual {v1}, Le;->af()Ljava/util/Map$Entry;

    move-result-object v1

    .line 330
    iget-boolean v2, p0, Landroid/arch/lifecycle/LifecycleRegistry;->gA:Z

    if-nez v2, :cond_0

    if-eqz v1, :cond_0

    iget-object v2, p0, Landroid/arch/lifecycle/LifecycleRegistry;->gw:Landroid/arch/lifecycle/Lifecycle$State;
    ...
    iget-object v1, v1, Landroid/arch/lifecycle/LifecycleRegistry$ObserverWithState;->gw:Landroid/arch/lifecycle/Lifecycle$State;
...
.method public addObserver(Landroid/arch/lifecycle/LifecycleObserver;)V
    ...
    invoke-virtual {v0, p1, v1}, Le;->putIfAbsent(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .line 174
    :cond_2
    iget v2, p0, Landroid/arch/lifecycle/LifecycleRegistry;->gy:I

    const/4 v3, 0x1

    if-nez v2, :cond_4

    iget-boolean v2, p0, Landroid/arch/lifecycle/LifecycleRegistry;->gz:Z
    ...
    .line 176
    iget v5, p0, Landroid/arch/lifecycle/LifecycleRegistry;->gy:I

    add-int/2addr v5, v3

    iput v5, p0, Landroid/arch/lifecycle/LifecycleRegistry;->gy:I

    .line 177
    :goto_3
    iget-object v5, v1, Landroid/arch/lifecycle/LifecycleRegistry$ObserverWithState;->gw:Landroid/arch/lifecycle/Lifecycle$State;
    ...
    iget-object v4, p0, Landroid/arch/lifecycle/LifecycleRegistry;->gv:Le;

    .line 178
    invoke-virtual {v4, p1}, Le;->contains(Ljava/lang/Object;)Z
    ...
    .line 179
    iget-object v4, v1, Landroid/arch/lifecycle/LifecycleRegistry$ObserverWithState;->gw:Landroid/arch/lifecycle/Lifecycle$State;
    ...
    iput p1, p0, Landroid/arch/lifecycle/LifecycleRegistry;->gy:I
...
.method public removeObserver(Landroid/arch/lifecycle/LifecycleObserver;)V
    ...
    invoke-virtual {v0, p1}, Le;->remove(Ljava/lang/Object;)Ljava/lang/Object;
