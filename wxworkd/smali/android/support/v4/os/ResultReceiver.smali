...
.method constructor <init>(Landroid/os/Parcel;)V
    ...
    .line 137
    iput-boolean v0, p0, Landroid/support/v4/os/ResultReceiver;->VA:Z
    ...
    invoke-static {p1}, Lhv$a;->d(Landroid/os/IBinder;)Lhv;

    move-result-object p1

    iput-object p1, p0, Landroid/support/v4/os/ResultReceiver;->VB:Lhv;
...
.method public send(ILandroid/os/Bundle;)V
    ...
    .line 94
    iget-boolean v0, p0, Landroid/support/v4/os/ResultReceiver;->VA:Z
    ...
    .line 103
    :cond_1
    iget-object v0, p0, Landroid/support/v4/os/ResultReceiver;->VB:Lhv;

    if-eqz v0, :cond_2

    .line 105
    :try_start_0
    invoke-interface {v0, p1, p2}, Lhv;->send(ILandroid/os/Bundle;)V
    :try_end_0
...
.method public writeToParcel(Landroid/os/Parcel;I)V
    ...
    .line 129
    :try_start_0
    iget-object p2, p0, Landroid/support/v4/os/ResultReceiver;->VB:Lhv;
    ...
    iput-object p2, p0, Landroid/support/v4/os/ResultReceiver;->VB:Lhv;

    .line 132
    :cond_0
    iget-object p2, p0, Landroid/support/v4/os/ResultReceiver;->VB:Lhv;

    invoke-interface {p2}, Lhv;->asBinder()Landroid/os/IBinder;
