...
.field final mFragments:Lex;

.field public final mHandler:Landroid/os/Handler;

.field mNextCandidateRequestIndex:I

.field mPendingFragmentActivityResults:Liw;
...
.method public constructor <init>()V
    ...
    invoke-static {v0}, Lex;->a(Lez;)Lex;

    move-result-object v0

    iput-object v0, p0, Landroid/support/v4/app/FragmentActivity;->mFragments:Lex;
...
.method private allocateRequestIndex(Landroid/support/v4/app/Fragment;)I
    ...
    .line 919
    iget-object v0, p0, Landroid/support/v4/app/FragmentActivity;->mPendingFragmentActivityResults:Liw;
    ...
    invoke-virtual {v0, v2}, Liw;->indexOfKey(I)I
    ...
    .line 930
    iget-object v2, p0, Landroid/support/v4/app/FragmentActivity;->mPendingFragmentActivityResults:Liw;

    iget-object p1, p1, Landroid/support/v4/app/Fragment;->mWho:Ljava/lang/String;

    invoke-virtual {v2, v0, p1}, Liw;->put(ILjava/lang/Object;)V
...
.method private markFragmentsCreated()V
    ...
    invoke-static {v0, v1}, Landroid/support/v4/app/FragmentActivity;->markState(Lfa;Landroid/arch/lifecycle/Lifecycle$State;)Z
...
.method private static markState(Lfa;Landroid/arch/lifecycle/Lifecycle$State;)Z
    .locals 4
    ...
    .line 1069
    invoke-static {v1, p1}, Landroid/support/v4/app/FragmentActivity;->markState(Lfa;Landroid/arch/lifecycle/Lifecycle$State;)Z
...
.method final dispatchFragmentsOnCreateView(Landroid/view/View;Ljava/lang/String;Landroid/content/Context;Landroid/util/AttributeSet;)Landroid/view/View;
    ...
    .line 405
    iget-object v0, p0, Landroid/support/v4/app/FragmentActivity;->mFragments:Lex;

    invoke-virtual {v0, p1, p2, p3, p4}, Lex;->onCreateView(Landroid/view/View;Ljava/lang/String;Landroid/content/Context;Landroid/util/AttributeSet;)Landroid/view/View;
...
.method public dump(Ljava/lang/String;Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    invoke-virtual {v1, v0, p2, p3, p4}, Lfj;->dump(Ljava/lang/String;Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V

    .line 706
    :cond_0
    iget-object v0, p0, Landroid/support/v4/app/FragmentActivity;->mFragments:Lex;

    invoke-virtual {v0}, Lex;->getSupportFragmentManager()Lfa;

    move-result-object v0

    invoke-virtual {v0, p1, p2, p3, p4}, Lfa;->dump(Ljava/lang/String;Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
...
.method public getLastCustomNonConfigurationInstance()Ljava/lang/Object;
    ...
    .line 664
    iget-object v0, v0, Landroid/support/v4/app/FragmentActivity$b;->ND:Ljava/lang/Object;
...
.method public getSupportLoaderManager()Lfj;
    .locals 1
...
.method public getViewModelStore()Landroid/arch/lifecycle/ViewModelStore;
    ...
    .line 308
    iget-object v0, v0, Landroid/support/v4/app/FragmentActivity$b;->NF:Landroid/arch/lifecycle/ViewModelStore;
...
.method protected onActivityResult(IILandroid/content/Intent;)V
    ...
    invoke-virtual {v0}, Lex;->noteStateNotSaved()V
    ...
    .line 150
    iget-object v1, p0, Landroid/support/v4/app/FragmentActivity;->mPendingFragmentActivityResults:Liw;

    invoke-virtual {v1, v0}, Liw;->get(I)Ljava/lang/Object;
    ...
    invoke-virtual {v2, v0}, Liw;->remove(I)V
    ...
    invoke-virtual {v0, v1}, Lex;->findFragmentByWho(Ljava/lang/String;)Landroid/support/v4/app/Fragment;
    ...
    .line 167
    invoke-interface {v0, p0, p1, p2, p3}, Ler$b;->a(Landroid/app/Activity;IILandroid/content/Intent;)Z
...
.method public onBackPressed()V
    ...
    .line 182
    invoke-virtual {v0}, Lfa;->isStateSaved()Z
...
.method public onConfigurationChanged(Landroid/content/res/Configuration;)V
    ...
    invoke-virtual {v0, p1}, Lex;->dispatchConfigurationChanged(Landroid/content/res/Configuration;)V
...
.method protected onCreate(Landroid/os/Bundle;)V
    ...
    invoke-virtual {v0, v1}, Lex;->i(Landroid/support/v4/app/Fragment;)V
    ...
    .line 339
    iget-object v2, v0, Landroid/support/v4/app/FragmentActivity$b;->NF:Landroid/arch/lifecycle/ViewModelStore;
    ...
    .line 344
    iget-object v4, p0, Landroid/support/v4/app/FragmentActivity;->mFragments:Lex;

    if-eqz v0, :cond_1

    iget-object v1, v0, Landroid/support/v4/app/FragmentActivity$b;->NG:Lfc;

    :cond_1
    invoke-virtual {v4, v3, v1}, Lex;->a(Landroid/os/Parcelable;Lfc;)V
    ...
    invoke-direct {v1, v3}, Liw;-><init>(I)V

    iput-object v1, p0, Landroid/support/v4/app/FragmentActivity;->mPendingFragmentActivityResults:Liw;
    ...
    .line 358
    iget-object v3, p0, Landroid/support/v4/app/FragmentActivity;->mPendingFragmentActivityResults:Liw;

    aget v4, v0, v1

    aget-object v5, p1, v1

    invoke-virtual {v3, v4, v5}, Liw;->put(ILjava/lang/Object;)V
    ...
    .line 364
    :cond_4
    iget-object p1, p0, Landroid/support/v4/app/FragmentActivity;->mPendingFragmentActivityResults:Liw;
    ...
    iput-object p1, p0, Landroid/support/v4/app/FragmentActivity;->mPendingFragmentActivityResults:Liw;
    ...
    .line 369
    :cond_5
    iget-object p1, p0, Landroid/support/v4/app/FragmentActivity;->mFragments:Lex;

    invoke-virtual {p1}, Lex;->dispatchCreate()V
...
.method public onCreatePanelMenu(ILandroid/view/Menu;)Z
    ...
    invoke-virtual {v0, p2, v1}, Lex;->dispatchCreateOptionsMenu(Landroid/view/Menu;Landroid/view/MenuInflater;)Z
...
.method protected onDestroy()V
    ...
    invoke-virtual {v0}, Lex;->dispatchDestroy()V
...
.method public onLowMemory()V
    ...
    invoke-virtual {v0}, Lex;->dispatchLowMemory()V
...
.method public onMenuItemSelected(ILandroid/view/MenuItem;)Z
    ...
    invoke-virtual {p1, p2}, Lex;->dispatchContextItemSelected(Landroid/view/MenuItem;)Z
    ...
    invoke-virtual {p1, p2}, Lex;->dispatchOptionsItemSelected(Landroid/view/MenuItem;)Z
...
.method public onMultiWindowModeChanged(Z)V
    ...
    invoke-virtual {v0, p1}, Lex;->dispatchMultiWindowModeChanged(Z)V
...
.method protected onNewIntent(Landroid/content/Intent;)V
    ...
    invoke-virtual {p1}, Lex;->noteStateNotSaved()V
...
.method public onPanelClosed(ILandroid/view/Menu;)V
    ...
    invoke-virtual {v0, p2}, Lex;->dispatchOptionsMenuClosed(Landroid/view/Menu;)V
...
.method protected onPause()V
    ...
    invoke-virtual {v0}, Lex;->dispatchPause()V
...
.method public onPictureInPictureModeChanged(Z)V
    ...
    invoke-virtual {v0, p1}, Lex;->dispatchPictureInPictureModeChanged(Z)V
...
.method protected onPostResume()V
    ...
    invoke-virtual {v0}, Lex;->execPendingActions()Z
...
.method public onPreparePanel(ILandroid/view/View;Landroid/view/Menu;)Z
    ...
    .line 548
    iget-object p2, p0, Landroid/support/v4/app/FragmentActivity;->mFragments:Lex;

    invoke-virtual {p2, p3}, Lex;->dispatchPrepareOptionsMenu(Landroid/view/Menu;)Z
...
.method public onRequestPermissionsResult(I[Ljava/lang/String;[I)V
    ...
    invoke-virtual {v2, v0}, Liw;->get(I)Ljava/lang/Object;
    ...
    invoke-virtual {v3, v0}, Liw;->remove(I)V
    ...
    invoke-virtual {v0, v2}, Lex;->findFragmentByWho(Ljava/lang/String;)Landroid/support/v4/app/Fragment;
...
.method protected onResumeFragments()V
    ...
    invoke-virtual {v0}, Lex;->dispatchResume()V
...
.method public final onRetainNonConfigurationInstance()Ljava/lang/Object;
    ...
    .line 571
    iget-object v1, p0, Landroid/support/v4/app/FragmentActivity;->mFragments:Lex;

    invoke-virtual {v1}, Lex;->hs()Lfc;
    ...
    .line 578
    iput-object v0, v2, Landroid/support/v4/app/FragmentActivity$b;->ND:Ljava/lang/Object;

    .line 579
    iget-object v0, p0, Landroid/support/v4/app/FragmentActivity;->mViewModelStore:Landroid/arch/lifecycle/ViewModelStore;

    iput-object v0, v2, Landroid/support/v4/app/FragmentActivity$b;->NF:Landroid/arch/lifecycle/ViewModelStore;

    .line 580
    iput-object v1, v2, Landroid/support/v4/app/FragmentActivity$b;->NG:Lfc;
...
.method protected onSaveInstanceState(Landroid/os/Bundle;)V
    ...
    invoke-virtual {v0}, Lex;->saveAllState()Landroid/os/Parcelable;
    ...
    invoke-virtual {v3, v2}, Liw;->keyAt(I)I
    ...
    invoke-virtual {v3, v2}, Liw;->valueAt(I)Ljava/lang/Object;
...
.method protected onStart()V
    ...
    invoke-virtual {v0}, Lex;->dispatchActivityCreated()V
    ...
    invoke-virtual {v0}, Lex;->dispatchStart()V
...
.method protected onStop()V
    ...
    invoke-virtual {v0}, Lex;->dispatchStop()V
...
.method requestPermissionsFromFragment(Landroid/support/v4/app/Fragment;[Ljava/lang/String;I)V
    ...
    .line 943
    invoke-static {p0, p2, p3}, Ler;->requestPermissions(Landroid/app/Activity;[Ljava/lang/String;I)V
    ...
    .line 950
    invoke-static {p0, p2, p1}, Ler;->requestPermissions(Landroid/app/Activity;[Ljava/lang/String;I)V
    :try_end_0
...
.method public setEnterSharedElementCallback(Lfs;)V
    ...
    .line 217
    invoke-static {p0, p1}, Ler;->a(Landroid/app/Activity;Lfs;)V
...
.method public setExitSharedElementCallback(Lfs;)V
    ...
    .line 230
    invoke-static {p0, p1}, Ler;->b(Landroid/app/Activity;Lfs;)V
...
.method public startActivityFromFragment(Landroid/support/v4/app/Fragment;Landroid/content/Intent;ILandroid/os/Bundle;)V
    ...
    .line 881
    :try_start_0
    invoke-static {p0, p2, v1, p4}, Ler;->a(Landroid/app/Activity;Landroid/content/Intent;ILandroid/os/Bundle;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    .line 886
    invoke-static {p0, p2, p1, p4}, Ler;->a(Landroid/app/Activity;Landroid/content/Intent;ILandroid/os/Bundle;)V
    :try_end_1
...
.method public supportFinishAfterTransition()V
    ...
    .line 205
    invoke-static {p0}, Ler;->finishAfterTransition(Landroid/app/Activity;)V
...
.method public supportPostponeEnterTransition()V
    ...
    .line 238
    invoke-static {p0}, Ler;->f(Landroid/app/Activity;)V
...
.method public supportStartPostponedEnterTransition()V
    ...
    .line 246
    invoke-static {p0}, Ler;->g(Landroid/app/Activity;)V
