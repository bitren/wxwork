...
# instance fields
.field private final UK:Landroid/content/BroadcastReceiver$PendingResult;

.field private UL:Landroid/support/v4/media/MediaBrowserCompat;
...
.method constructor <init>(Landroid/content/Context;Landroid/content/Intent;Landroid/content/BroadcastReceiver$PendingResult;)V
    ...
    .line 146
    iput-object p3, p0, Landroid/support/v4/media/session/MediaButtonReceiver$a;->UK:Landroid/content/BroadcastReceiver$PendingResult;
...
.method private finish()V
    ...
    .line 177
    iget-object v0, p0, Landroid/support/v4/media/session/MediaButtonReceiver$a;->UL:Landroid/support/v4/media/MediaBrowserCompat;

    invoke-virtual {v0}, Landroid/support/v4/media/MediaBrowserCompat;->disconnect()V

    .line 178
    iget-object v0, p0, Landroid/support/v4/media/session/MediaButtonReceiver$a;->UK:Landroid/content/BroadcastReceiver$PendingResult;
...
.method a(Landroid/support/v4/media/MediaBrowserCompat;)V
    ...
    .line 150
    iput-object p1, p0, Landroid/support/v4/media/session/MediaButtonReceiver$a;->UL:Landroid/support/v4/media/MediaBrowserCompat;
...
.method public onConnected()V
    ...
    iget-object v1, p0, Landroid/support/v4/media/session/MediaButtonReceiver$a;->mContext:Landroid/content/Context;

    iget-object v2, p0, Landroid/support/v4/media/session/MediaButtonReceiver$a;->UL:Landroid/support/v4/media/MediaBrowserCompat;

    .line 157
    invoke-virtual {v2}, Landroid/support/v4/media/MediaBrowserCompat;->iw()Landroid/support/v4/media/session/MediaSessionCompat$Token;
    ...
    .line 158
    iget-object v1, p0, Landroid/support/v4/media/session/MediaButtonReceiver$a;->mIntent:Landroid/content/Intent;
