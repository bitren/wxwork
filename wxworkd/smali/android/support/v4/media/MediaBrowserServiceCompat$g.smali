...
.field private final Uv:Landroid/support/v4/media/MediaBrowserServiceCompat$d;
...
.method constructor <init>(Landroid/support/v4/media/MediaBrowserServiceCompat;)V
    ...
    .line 588
    iput-object p1, p0, Landroid/support/v4/media/MediaBrowserServiceCompat$g;->Ua:Landroid/support/v4/media/MediaBrowserServiceCompat;
    ...
    iget-object v0, p0, Landroid/support/v4/media/MediaBrowserServiceCompat$g;->Ua:Landroid/support/v4/media/MediaBrowserServiceCompat;
    ...
    iput-object p1, p0, Landroid/support/v4/media/MediaBrowserServiceCompat$g;->Uv:Landroid/support/v4/media/MediaBrowserServiceCompat$d;
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    .line 662
    invoke-static {v1}, Landroid/support/v4/media/session/MediaSessionCompat;->k(Landroid/os/Bundle;)V

    .line 664
    iget-object v2, p0, Landroid/support/v4/media/MediaBrowserServiceCompat$g;->Uv:Landroid/support/v4/media/MediaBrowserServiceCompat$d;
    ...
    .line 646
    :pswitch_2
    iget-object v0, p0, Landroid/support/v4/media/MediaBrowserServiceCompat$g;->Uv:Landroid/support/v4/media/MediaBrowserServiceCompat$d;
    ...
    .line 635
    invoke-static {v7}, Landroid/support/v4/media/session/MediaSessionCompat;->k(Landroid/os/Bundle;)V
    ...
    .line 628
    :pswitch_4
    iget-object v1, p0, Landroid/support/v4/media/MediaBrowserServiceCompat$g;->Uv:Landroid/support/v4/media/MediaBrowserServiceCompat$d;
    ...
    .line 624
    invoke-static {v0, v3}, Lev;->c(Landroid/os/Bundle;Ljava/lang/String;)Landroid/os/IBinder;
    ...
    .line 616
    invoke-static {v0, v4}, Lev;->c(Landroid/os/Bundle;Ljava/lang/String;)Landroid/os/IBinder;
    ...
    .line 597
    invoke-static {v6}, Landroid/support/v4/media/session/MediaSessionCompat;->k(Landroid/os/Bundle;)V
