...
.field private wB:Landroid/animation/ValueAnimator;
...
.field private wG:Landroid/support/design/widget/AppBarLayout$BaseBehavior$a;
...
.method public constructor <init>()V
    ...
    .line 893
    iput v0, p0, Landroid/support/design/widget/AppBarLayout$BaseBehavior;->wC:I
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    .line 893
    iput p1, p0, Landroid/support/design/widget/AppBarLayout$BaseBehavior;->wC:I
...
.method static synthetic a(Landroid/support/design/widget/AppBarLayout$BaseBehavior;)I
    ...
    .line 869
    iget p0, p0, Landroid/support/design/widget/AppBarLayout$BaseBehavior;->wz:I
...
.method private a(Landroid/support/design/widget/AppBarLayout;I)I
    ...
    .line 1083
    invoke-virtual {v2}, Landroid/support/design/widget/AppBarLayout$LayoutParams;->ea()I

    move-result v5

    const/16 v6, 0x20

    invoke-static {v5, v6}, Landroid/support/design/widget/AppBarLayout$BaseBehavior;->v(II)Z
...
.method private a(ILandroid/support/design/widget/AppBarLayout;Landroid/view/View;I)V
    ...
    .line 991
    invoke-virtual {p0}, Landroid/support/design/widget/AppBarLayout$BaseBehavior;->dY()I
    ...
    .line 994
    :cond_1
    invoke-static {p3, v0}, Ljs;->o(Landroid/view/View;I)V
...
.method private a(Landroid/support/design/widget/CoordinatorLayout;Landroid/support/design/widget/AppBarLayout;)V
    ...
    .line 1102
    invoke-virtual {v3}, Landroid/support/design/widget/AppBarLayout$LayoutParams;->ea()I
    ...
    .line 1114
    invoke-static {v4, v1}, Landroid/support/design/widget/AppBarLayout$BaseBehavior;->v(II)Z
    ...
    .line 1116
    invoke-static {v2}, Ljs;->al(Landroid/view/View;)I
    ...
    .line 1117
    invoke-static {v4, v7}, Landroid/support/design/widget/AppBarLayout$BaseBehavior;->v(II)Z
    ...
    .line 1129
    invoke-static {v4, v2}, Landroid/support/design/widget/AppBarLayout$BaseBehavior;->v(II)Z
    ...
    invoke-static {v5, v0, v1}, Lhb;->clamp(III)I
...
.method private a(Landroid/support/design/widget/CoordinatorLayout;Landroid/support/design/widget/AppBarLayout;II)V
    ...
    .line 1050
    iget-object p1, p0, Landroid/support/design/widget/AppBarLayout$BaseBehavior;->wB:Landroid/animation/ValueAnimator;
    ...
    .line 1056
    :cond_1
    iget-object v1, p0, Landroid/support/design/widget/AppBarLayout$BaseBehavior;->wB:Landroid/animation/ValueAnimator;
    ...
    iput-object v1, p0, Landroid/support/design/widget/AppBarLayout$BaseBehavior;->wB:Landroid/animation/ValueAnimator;

    .line 1058
    iget-object v1, p0, Landroid/support/design/widget/AppBarLayout$BaseBehavior;->wB:Landroid/animation/ValueAnimator;

    sget-object v2, Lak;->pV:Landroid/animation/TimeInterpolator;
...
.method private a(Landroid/support/design/widget/CoordinatorLayout;Landroid/support/design/widget/AppBarLayout;IIZ)V
    ...
    .line 1384
    invoke-virtual {v1}, Landroid/support/design/widget/AppBarLayout$LayoutParams;->ea()I
    ...
    .line 1405
    :goto_0
    invoke-virtual {p2}, Landroid/support/design/widget/AppBarLayout;->dW()Z
    ...
    :cond_5
    :goto_1
    invoke-virtual {p2, p3}, Landroid/support/design/widget/AppBarLayout;->C(Z)Z
...
.method private a(Landroid/support/design/widget/CoordinatorLayout;Landroid/support/design/widget/AppBarLayout;Landroid/view/View;)Z
    ...
    .line 936
    invoke-virtual {p2}, Landroid/support/design/widget/AppBarLayout;->dV()Z
...
.method private b(Landroid/support/design/widget/AppBarLayout;I)I
    ...
    .line 1333
    invoke-virtual {v5}, Landroid/support/design/widget/AppBarLayout$LayoutParams;->eb()Landroid/view/animation/Interpolator;
    ...
    .line 1338
    invoke-virtual {v5}, Landroid/support/design/widget/AppBarLayout$LayoutParams;->ea()I
    ...
    .line 1350
    :cond_0
    invoke-static {v4}, Ljs;->as(Landroid/view/View;)Z
...
.method private c(Landroid/support/design/widget/CoordinatorLayout;Landroid/support/design/widget/AppBarLayout;)Z
    ...
    .line 1428
    invoke-virtual {p1, p2}, Landroid/support/design/widget/CoordinatorLayout;->y(Landroid/view/View;)Ljava/util/List;
    ...
    invoke-virtual {v2}, Landroid/support/design/widget/AppBarLayout$ScrollingViewBehavior;->fz()I
...
.method a(Landroid/support/design/widget/CoordinatorLayout;Landroid/support/design/widget/AppBarLayout;III)I
    ...
    .line 1281
    invoke-static {p3, p4, p5}, Lhb;->clamp(III)I
    ...
    .line 1288
    :goto_0
    invoke-virtual {p0, p3}, Landroid/support/design/widget/AppBarLayout$BaseBehavior;->ap(I)Z
    ...
    .line 1293
    iput p3, p0, Landroid/support/design/widget/AppBarLayout$BaseBehavior;->wz:I
    ...
    .line 1300
    invoke-virtual {p1, p2}, Landroid/support/design/widget/CoordinatorLayout;->w(Landroid/view/View;)V

    .line 1304
    :cond_1
    invoke-virtual {p0}, Landroid/support/design/widget/AppBarLayout$BaseBehavior;->dZ()I

    move-result p3

    invoke-virtual {p2, p3}, Landroid/support/design/widget/AppBarLayout;->an(I)V
    ...
    .line 1316
    :cond_3
    iput v1, p0, Landroid/support/design/widget/AppBarLayout$BaseBehavior;->wz:I
...
.method public a(Landroid/support/design/widget/CoordinatorLayout;Landroid/support/design/widget/AppBarLayout;Landroid/os/Parcelable;)V
    ...
    .line 1498
    iget p1, p3, Landroid/support/design/widget/AppBarLayout$BaseBehavior$SavedState;->wK:I

    iput p1, p0, Landroid/support/design/widget/AppBarLayout$BaseBehavior;->wC:I

    .line 1499
    iget p1, p3, Landroid/support/design/widget/AppBarLayout$BaseBehavior$SavedState;->wL:F

    iput p1, p0, Landroid/support/design/widget/AppBarLayout$BaseBehavior;->wE:F

    .line 1500
    iget-boolean p1, p3, Landroid/support/design/widget/AppBarLayout$BaseBehavior$SavedState;->wM:Z

    iput-boolean p1, p0, Landroid/support/design/widget/AppBarLayout$BaseBehavior;->wD:Z
...
.method public a(Landroid/support/design/widget/CoordinatorLayout;Landroid/support/design/widget/AppBarLayout;Landroid/view/View;I)V
    ...
    .line 1006
    iget v0, p0, Landroid/support/design/widget/AppBarLayout$BaseBehavior;->wA:I
    ...
    iput-object p1, p0, Landroid/support/design/widget/AppBarLayout$BaseBehavior;->wF:Ljava/lang/ref/WeakReference;
...
.method public a(Landroid/support/design/widget/CoordinatorLayout;Landroid/support/design/widget/AppBarLayout;Landroid/view/View;IIIII)V
    ...
    :goto_0
    invoke-virtual {p2, p1}, Landroid/support/design/widget/AppBarLayout;->C(Z)Z
...
.method a(Landroid/support/design/widget/AppBarLayout;)Z
    ...
    .line 1234
    iget-object v0, p0, Landroid/support/design/widget/AppBarLayout$BaseBehavior;->wG:Landroid/support/design/widget/AppBarLayout$BaseBehavior$a;

    if-eqz v0, :cond_0

    .line 1236
    invoke-virtual {v0, p1}, Landroid/support/design/widget/AppBarLayout$BaseBehavior$a;->d(Landroid/support/design/widget/AppBarLayout;)Z
    ...
    .line 1240
    :cond_0
    iget-object p1, p0, Landroid/support/design/widget/AppBarLayout$BaseBehavior;->wF:Ljava/lang/ref/WeakReference;
...
.method public a(Landroid/support/design/widget/CoordinatorLayout;Landroid/support/design/widget/AppBarLayout;I)Z
    ...
    .line 1184
    iget v1, p0, Landroid/support/design/widget/AppBarLayout$BaseBehavior;->wC:I
    ...
    .line 1187
    iget-boolean v3, p0, Landroid/support/design/widget/AppBarLayout$BaseBehavior;->wD:Z
    ...
    iget v3, p0, Landroid/support/design/widget/AppBarLayout$BaseBehavior;->wE:F
    ...
    .line 1192
    :goto_0
    invoke-virtual {p0, p1, p2, v1}, Landroid/support/design/widget/AppBarLayout$BaseBehavior;->b(Landroid/support/design/widget/CoordinatorLayout;Landroid/view/View;I)I
    ...
    :cond_6
    :goto_2
    invoke-virtual {p2}, Landroid/support/design/widget/AppBarLayout;->dX()V
    ...
    invoke-static {v0, v1, v2}, Lhb;->clamp(III)I

    move-result v0

    .line 1217
    invoke-virtual {p0, v0}, Landroid/support/design/widget/AppBarLayout$BaseBehavior;->ap(I)Z
    ...
    invoke-virtual {p2, p1}, Landroid/support/design/widget/AppBarLayout;->an(I)V
...
.method public a(Landroid/support/design/widget/CoordinatorLayout;Landroid/support/design/widget/AppBarLayout;Landroid/view/View;Landroid/view/View;II)Z
    ...
    .line 920
    iget-object p2, p0, Landroid/support/design/widget/AppBarLayout$BaseBehavior;->wB:Landroid/animation/ValueAnimator;
    ...
    .line 926
    iput-object p2, p0, Landroid/support/design/widget/AppBarLayout$BaseBehavior;->wF:Ljava/lang/ref/WeakReference;

    .line 929
    iput p6, p0, Landroid/support/design/widget/AppBarLayout$BaseBehavior;->wA:I
...
.method b(Landroid/support/design/widget/CoordinatorLayout;Landroid/support/design/widget/AppBarLayout;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method bridge synthetic b(Landroid/support/design/widget/CoordinatorLayout;Landroid/view/View;)V
    .locals 0

    .line 869
    check-cast p2, Landroid/support/design/widget/AppBarLayout;

    invoke-virtual {p0, p1, p2}, Landroid/support/design/widget/AppBarLayout$BaseBehavior;->b(Landroid/support/design/widget/CoordinatorLayout;Landroid/support/design/widget/AppBarLayout;)V
...
.method public synthetic c(Landroid/support/design/widget/CoordinatorLayout;Landroid/view/View;)Landroid/os/Parcelable;
    .locals 0

    .line 869
    check-cast p2, Landroid/support/design/widget/AppBarLayout;

    invoke-virtual {p0, p1, p2}, Landroid/support/design/widget/AppBarLayout$BaseBehavior;->d(Landroid/support/design/widget/CoordinatorLayout;Landroid/support/design/widget/AppBarLayout;)Landroid/os/Parcelable;
...
.method public d(Landroid/support/design/widget/CoordinatorLayout;Landroid/support/design/widget/AppBarLayout;)Landroid/os/Parcelable;
    .locals 7
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 1471
    invoke-super {p0, p1, p2}, Landroid/support/design/widget/HeaderBehavior;->c(Landroid/support/design/widget/CoordinatorLayout;Landroid/view/View;)Landroid/os/Parcelable;
    ...
    .line 1481
    iput v3, v0, Landroid/support/design/widget/AppBarLayout$BaseBehavior$SavedState;->wK:I
    ...
    :cond_0
    iput-boolean v2, v0, Landroid/support/design/widget/AppBarLayout$BaseBehavior$SavedState;->wM:Z
    ...
    iput p1, v0, Landroid/support/design/widget/AppBarLayout$BaseBehavior$SavedState;->wL:F
...
.method dY()I
    ...
    iget v1, p0, Landroid/support/design/widget/AppBarLayout$BaseBehavior;->wz:I
...
.method synthetic h(Landroid/view/View;)I
    .locals 0
...
.method synthetic i(Landroid/view/View;)I
    .locals 0
...
.method synthetic j(Landroid/view/View;)Z
    .locals 0
