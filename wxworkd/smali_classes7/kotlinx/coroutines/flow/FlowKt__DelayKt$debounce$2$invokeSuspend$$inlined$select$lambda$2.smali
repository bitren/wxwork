...
.field final synthetic $this_select$inlined:Liep;
...
# direct methods
.method constructor <init>(Ljava/lang/Object;Lhpl;Liep;Lkotlinx/coroutines/flow/FlowKt__DelayKt$debounce$2;Liba;Lkotlin/jvm/internal/Ref$ObjectRef;Libk;)V
    .locals 0
    ...
    iput-object p3, p0, Lkotlinx/coroutines/flow/FlowKt__DelayKt$debounce$2$invokeSuspend$$inlined$select$lambda$2;->$this_select$inlined:Liep;
    ...
    iput-object p5, p0, Lkotlinx/coroutines/flow/FlowKt__DelayKt$debounce$2$invokeSuspend$$inlined$select$lambda$2;->$values$inlined:Liba;
    ...
    iput-object p7, p0, Lkotlinx/coroutines/flow/FlowKt__DelayKt$debounce$2$invokeSuspend$$inlined$select$lambda$2;->$downstream$inlined:Libk;
...
# virtual methods
.method public final create(Lhpl;)Lhpl;
    .locals 9
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iget-object v4, p0, Lkotlinx/coroutines/flow/FlowKt__DelayKt$debounce$2$invokeSuspend$$inlined$select$lambda$2;->$this_select$inlined:Liep;
    ...
    iget-object v6, p0, Lkotlinx/coroutines/flow/FlowKt__DelayKt$debounce$2$invokeSuspend$$inlined$select$lambda$2;->$values$inlined:Liba;
    ...
    iget-object v8, p0, Lkotlinx/coroutines/flow/FlowKt__DelayKt$debounce$2$invokeSuspend$$inlined$select$lambda$2;->$downstream$inlined:Libk;

    move-object v1, v0

    move-object v3, p1

    invoke-direct/range {v1 .. v8}, Lkotlinx/coroutines/flow/FlowKt__DelayKt$debounce$2$invokeSuspend$$inlined$select$lambda$2;-><init>(Ljava/lang/Object;Lhpl;Liep;Lkotlinx/coroutines/flow/FlowKt__DelayKt$debounce$2;Liba;Lkotlin/jvm/internal/Ref$ObjectRef;Libk;)V
...
.method public final invoke(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1}, Lkotlinx/coroutines/flow/FlowKt__DelayKt$debounce$2$invokeSuspend$$inlined$select$lambda$2;->create(Lhpl;)Lhpl;
...
.method public final invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .line 66
    iget-object p1, p0, Lkotlinx/coroutines/flow/FlowKt__DelayKt$debounce$2$invokeSuspend$$inlined$select$lambda$2;->$downstream$inlined:Libk;

    sget-object v2, Lico;->nXP:Lids;

    iget-object v3, p0, Lkotlinx/coroutines/flow/FlowKt__DelayKt$debounce$2$invokeSuspend$$inlined$select$lambda$2;->$value:Ljava/lang/Object;
    ...
    .line 66
    invoke-interface {p1, v1, p0}, Libk;->g(Ljava/lang/Object;Lhpl;)Ljava/lang/Object;
