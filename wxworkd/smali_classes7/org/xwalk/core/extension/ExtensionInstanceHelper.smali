...
.source "ExtensionInstanceHelper.java"
...
.method public constructor <init>(Lorg/xwalk/core/extension/XWalkExternalExtension;I)V
    ...
    iget-object p2, p0, Lorg/xwalk/core/extension/ExtensionInstanceHelper;->mExtension:Lorg/xwalk/core/extension/XWalkExternalExtension;

    invoke-virtual {p2}, Lorg/xwalk/core/extension/XWalkExternalExtension;->getMessageHandler()Lorg/xwalk/core/extension/MessageHandler;

    move-result-object p2

    invoke-direct {p1, p2}, Lorg/xwalk/core/extension/MessageHandler;-><init>(Lorg/xwalk/core/extension/MessageHandler;)V

    iput-object p1, p0, Lorg/xwalk/core/extension/ExtensionInstanceHelper;->mHandler:Lorg/xwalk/core/extension/MessageHandler;

    .line 23
    iget-object p1, p0, Lorg/xwalk/core/extension/ExtensionInstanceHelper;->mExtension:Lorg/xwalk/core/extension/XWalkExternalExtension;

    invoke-virtual {p1}, Lorg/xwalk/core/extension/XWalkExternalExtension;->isAutoJS()Z
    ...
    .line 25
    invoke-virtual {p1}, Lorg/xwalk/core/extension/XWalkExternalExtension;->getReflection()Lorg/xwalk/core/extension/ReflectionHelper;

    move-result-object p1

    iget-object p2, p0, Lorg/xwalk/core/extension/ExtensionInstanceHelper;->mHandler:Lorg/xwalk/core/extension/MessageHandler;
    ...
    .line 24
    invoke-static {p1, p2, v0}, Lorg/xwalk/core/extension/ReflectionHelper;->registerHandlers(Lorg/xwalk/core/extension/ReflectionHelper;Lorg/xwalk/core/extension/MessageHandler;Ljava/lang/Object;)V

    .line 27
    :cond_0
    new-instance p1, Lorg/xwalk/core/extension/BindingObjectStore;

    iget-object p2, p0, Lorg/xwalk/core/extension/ExtensionInstanceHelper;->mHandler:Lorg/xwalk/core/extension/MessageHandler;

    invoke-direct {p1, p2, p0}, Lorg/xwalk/core/extension/BindingObjectStore;-><init>(Lorg/xwalk/core/extension/MessageHandler;Lorg/xwalk/core/extension/ExtensionInstanceHelper;)V

    iput-object p1, p0, Lorg/xwalk/core/extension/ExtensionInstanceHelper;->mStore:Lorg/xwalk/core/extension/BindingObjectStore;
...
.method public handleMessage(Ljava/lang/String;)Ljava/lang/Object;
    ...
    .line 52
    iget-object p1, p0, Lorg/xwalk/core/extension/ExtensionInstanceHelper;->mHandler:Lorg/xwalk/core/extension/MessageHandler;

    invoke-virtual {p1, v0}, Lorg/xwalk/core/extension/MessageHandler;->handleMessage(Lorg/xwalk/core/extension/MessageInfo;)Ljava/lang/Object;
