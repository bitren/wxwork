...
.method private checkAndNotify(Lorg/apache/commons/io/monitor/FileEntry;[Lorg/apache/commons/io/monitor/FileEntry;[Ljava/io/File;)V
    ...
    sget-object v6, Liim;->ogT:[Ljava/io/File;
...
.method private doCreate(Lorg/apache/commons/io/monitor/FileEntry;)V
    ...
    invoke-interface {v1, v2}, Liis;->an(Ljava/io/File;)V
    ...
    invoke-interface {v1, v2}, Liis;->aq(Ljava/io/File;)V
...
.method private doDelete(Lorg/apache/commons/io/monitor/FileEntry;)V
    ...
    invoke-interface {v1, v2}, Liis;->ap(Ljava/io/File;)V
    ...
    invoke-interface {v1, v2}, Liis;->as(Ljava/io/File;)V
...
.method private doMatch(Lorg/apache/commons/io/monitor/FileEntry;Ljava/io/File;)V
    ...
    .line 408
    invoke-interface {v1, p2}, Liis;->ao(Ljava/io/File;)V

    goto :goto_0

    .line 410
    :cond_0
    invoke-interface {v1, p2}, Liis;->ar(Ljava/io/File;)V
...
.method private listFiles(Ljava/io/File;)[Ljava/io/File;
    ...
    .line 444
    sget-object p1, Liim;->ogT:[Ljava/io/File;
...
# virtual methods
.method public addListener(Liis;)V
    .locals 1
...
.method public checkAndNotify()V
    ...
    .line 297
    invoke-interface {v1, p0}, Liis;->a(Lorg/apache/commons/io/monitor/FileAlterationObserver;)V
    ...
    sget-object v2, Liim;->ogT:[Ljava/io/File;
    ...
    .line 312
    invoke-interface {v1, p0}, Liis;->b(Lorg/apache/commons/io/monitor/FileAlterationObserver;)V
...
.method public removeListener(Liis;)V
    .locals 1
