...
.method constructor <init>(Lenr;Ljava/lang/String;I)V
    ...
    .line 1076
    iput-object p1, p0, Lenr$10;->gHD:Lenr;

    iput-object p2, p0, Lenr$10;->gHH:Ljava/lang/String;

    iput p3, p0, Lenr$10;->gHI:I
...
.method public onResult(ILcom/tencent/wework/foundation/logic/search/SearchMessageResult;)V
    ...
    const-string v2, "SearchMessageResult sub errorCode"
    ...
    .line 1082
    iget-object p1, p0, Lenr$10;->gHD:Lenr;
    ...
    iget-object v0, p0, Lenr$10;->gHH:Ljava/lang/String;

    iget v1, p0, Lenr$10;->gHI:I
