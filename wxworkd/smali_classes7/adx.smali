...
.method public constructor <init>(Lace;)V
    ...
    .line 23
    iput-object p1, p0, Ladx;->aOl:Lace;
...
# virtual methods
.method public a(Ljava/io/InputStream;Ljava/io/File;Laak;)Z
    .locals 3

    .line 28
    iget-object p3, p0, Ladx;->aOl:Lace;

    const-class v0, [B

    const/high16 v1, 0x10000

    invoke-interface {p3, v1, v0}, Lace;->a(ILjava/lang/Class;)Ljava/lang/Object;
    ...
    :cond_2
    :goto_2
    iget-object p1, p0, Ladx;->aOl:Lace;

    invoke-interface {p1, p3}, Lace;->put(Ljava/lang/Object;)V
    ...
    :catch_3
    :cond_3
    iget-object p2, p0, Ladx;->aOl:Lace;

    invoke-interface {p2, p3}, Lace;->put(Ljava/lang/Object;)V
...
.method public bridge synthetic a(Ljava/lang/Object;Ljava/io/File;Laak;)Z
    ...
    invoke-virtual {p0, p1, p2, p3}, Ladx;->a(Ljava/io/InputStream;Ljava/io/File;Laak;)Z
