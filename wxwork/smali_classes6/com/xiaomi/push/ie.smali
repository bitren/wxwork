...
.method public static a(Landroid/content/Context;Lcom/xiaomi/push/ih;)V
    .locals 2
    ...
    new-instance v1, Lcom/xiaomi/push/ie$a;

    invoke-direct {v1, p0, p1}, Lcom/xiaomi/push/ie$a;-><init>(Landroid/content/Context;Lcom/xiaomi/push/ih;)V
...
.method private static a(Landroid/content/Context;Lcom/xiaomi/push/ih;Ljava/io/File;[B)V
    .locals 11
    ...
    :cond_2
    invoke-static {v2}, Lcom/xiaomi/push/ac;->a([B)I
    ...
    invoke-direct {v9}, Lcom/xiaomi/push/im;-><init>()V

    invoke-static {v9, v7}, Lcom/xiaomi/push/js;->a(Lcom/xiaomi/push/jt;[B)V
    ...
    invoke-static {p0, p1, v0}, Lcom/xiaomi/push/if;->a(Landroid/content/Context;Lcom/xiaomi/push/ih;Ljava/util/List;)V
...
.method static synthetic b(Landroid/content/Context;Lcom/xiaomi/push/ih;)V
    .locals 0

    invoke-static {p0, p1}, Lcom/xiaomi/push/ie;->c(Landroid/content/Context;Lcom/xiaomi/push/ih;)V

    return-void
.end method

.method private static c(Landroid/content/Context;Lcom/xiaomi/push/ih;)V
    .locals 7

    sget-boolean v0, Lcom/xiaomi/push/ie;->a:Z

    if-nez v0, :cond_4

    const/4 v0, 0x1

    sput-boolean v0, Lcom/xiaomi/push/ie;->a:Z
    ...
    :cond_0
    invoke-static {p0}, Lcom/xiaomi/push/ie;->a(Landroid/content/Context;)V

    invoke-static {p0}, Lcom/xiaomi/push/service/bf;->a(Landroid/content/Context;)[B
    ...
    :cond_2
    invoke-static {p0, p1, v0, v1}, Lcom/xiaomi/push/ie;->a(Landroid/content/Context;Lcom/xiaomi/push/ih;Ljava/io/File;[B)V

    const/4 p1, 0x0

    invoke-static {p1}, Lcom/xiaomi/push/id;->a(Z)V

    invoke-static {p0}, Lcom/xiaomi/push/ie;->b(Landroid/content/Context;)V

    sput-boolean p1, Lcom/xiaomi/push/ie;->a:Z
