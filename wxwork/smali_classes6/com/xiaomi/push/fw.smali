...
# static fields
.field private static a:Lcom/xiaomi/push/fw$a;
...
.method public static a(Ljava/lang/Enum;)I
    ...
    :cond_0
    instance-of v0, p0, Lcom/xiaomi/push/is;
    ...
    :cond_1
    instance-of v0, p0, Lcom/xiaomi/push/gc;
...
.method public static a(Landroid/content/Context;)Lcom/xiaomi/clientreport/data/Config;
    ...
    sget-object v1, Lcom/xiaomi/push/in;->aA:Lcom/xiaomi/push/in;
    ...
    sget-object v3, Lcom/xiaomi/push/in;->az:Lcom/xiaomi/push/in;

    invoke-virtual {v3}, Lcom/xiaomi/push/in;->a()I

    move-result v3

    invoke-virtual {v1, v3, v2}, Lcom/xiaomi/push/service/ag;->a(IZ)Z
    ...
    sget-object v3, Lcom/xiaomi/push/in;->aC:Lcom/xiaomi/push/in;
    ...
    sget-object v5, Lcom/xiaomi/push/in;->aB:Lcom/xiaomi/push/in;

    invoke-virtual {v5}, Lcom/xiaomi/push/in;->a()I

    move-result v5

    invoke-virtual {v3, v5, v4}, Lcom/xiaomi/push/service/ag;->a(II)I
...
.method public static a(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;IJLjava/lang/String;)Lcom/xiaomi/clientreport/data/EventClientReport;
    ...
    invoke-static {p1}, Lcom/xiaomi/push/fw;->a(Ljava/lang/String;)Lcom/xiaomi/clientreport/data/EventClientReport;
...
.method public static a(Landroid/content/Context;IJJ)Lcom/xiaomi/clientreport/data/PerfClientReport;
    ...
    invoke-static {}, Lcom/xiaomi/push/fw;->a()Lcom/xiaomi/clientreport/data/PerfClientReport;
...
.method public static a(Landroid/content/Context;Ljava/lang/String;)Lcom/xiaomi/push/im;
    ...
    invoke-static {}, Lcom/xiaomi/push/service/be;->a()Ljava/lang/String;
...
.method public static a(Ljava/lang/String;)Lcom/xiaomi/push/is;
    .locals 7

    sget-object v0, Lcom/xiaomi/push/fw;->a:Ljava/util/Map;

    if-nez v0, :cond_1

    const-class v0, Lcom/xiaomi/push/is;

    monitor-enter v0

    :try_start_0
    sget-object v1, Lcom/xiaomi/push/fw;->a:Ljava/util/Map;
    ...
    sput-object v1, Lcom/xiaomi/push/fw;->a:Ljava/util/Map;

    invoke-static {}, Lcom/xiaomi/push/is;->values()[Lcom/xiaomi/push/is;
    ...
    sget-object v5, Lcom/xiaomi/push/fw;->a:Ljava/util/Map;

    iget-object v6, v4, Lcom/xiaomi/push/is;->a:Ljava/lang/String;
    ...
    check-cast p0, Lcom/xiaomi/push/is;
    ...
    :cond_2
    sget-object p0, Lcom/xiaomi/push/is;->a:Lcom/xiaomi/push/is;
...
.method public static a(Landroid/content/Context;Lcom/xiaomi/clientreport/data/Config;)V
    ...
    invoke-direct {v0, p0}, Lcom/xiaomi/push/fu;-><init>(Landroid/content/Context;)V

    new-instance v1, Lcom/xiaomi/push/fv;

    invoke-direct {v1, p0}, Lcom/xiaomi/push/fv;-><init>(Landroid/content/Context;)V
...
.method private static a(Landroid/content/Context;Lcom/xiaomi/push/im;)V
    .locals 1
    ...
    invoke-static {v0}, Lcom/xiaomi/push/fw;->a(Landroid/content/Context;)Z
    ...
    invoke-static {p0, p1}, Lcom/xiaomi/push/service/bf;->a(Landroid/content/Context;Lcom/xiaomi/push/im;)V

    goto :goto_0

    :cond_0
    sget-object v0, Lcom/xiaomi/push/fw;->a:Lcom/xiaomi/push/fw$a;

    if-eqz v0, :cond_1

    invoke-interface {v0, p0, p1}, Lcom/xiaomi/push/fw$a;->a(Landroid/content/Context;Lcom/xiaomi/push/im;)V
...
.method public static a(Landroid/content/Context;Ljava/util/List;)V
    ...
    invoke-static {p0, v0}, Lcom/xiaomi/push/fw;->a(Landroid/content/Context;Ljava/lang/String;)Lcom/xiaomi/push/im;

    move-result-object v0

    const/4 v1, 0x0

    invoke-static {v0, v1}, Lcom/xiaomi/push/service/be;->a(Lcom/xiaomi/push/im;Z)Z
    ...
    invoke-virtual {v0}, Lcom/xiaomi/push/im;->d()Ljava/lang/String;
    ...
    invoke-static {p0, v0}, Lcom/xiaomi/push/fw;->a(Landroid/content/Context;Lcom/xiaomi/push/im;)V
    :try_end_0
...
.method public static a(Lcom/xiaomi/push/fw$a;)V
    .locals 0

    sput-object p0, Lcom/xiaomi/push/fw;->a:Lcom/xiaomi/push/fw$a;
