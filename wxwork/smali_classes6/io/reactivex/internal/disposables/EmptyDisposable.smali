...
.method public static complete(Lhig;)V
    .locals 1

    .line 67
    sget-object v0, Lio/reactivex/internal/disposables/EmptyDisposable;->INSTANCE:Lio/reactivex/internal/disposables/EmptyDisposable;

    invoke-interface {p0, v0}, Lhig;->onSubscribe(Lhjj;)V

    .line 68
    invoke-interface {p0}, Lhig;->onComplete()V

    return-void
.end method

.method public static complete(Lhiq;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-interface {p0, v0}, Lhiq;->onSubscribe(Lhjj;)V

    .line 58
    invoke-interface {p0}, Lhiq;->onComplete()V

    return-void
.end method

.method public static complete(Lhiy;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-interface {p0, v0}, Lhiy;->onSubscribe(Lhjj;)V

    .line 53
    invoke-interface {p0}, Lhiy;->onComplete()V

    return-void
.end method

.method public static error(Ljava/lang/Throwable;Lhig;)V
    .locals 1
    ...
    .line 73
    invoke-interface {p1, p0}, Lhig;->onError(Ljava/lang/Throwable;)V

    return-void
.end method

.method public static error(Ljava/lang/Throwable;Lhiq;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 83
    invoke-interface {p1, p0}, Lhiq;->onError(Ljava/lang/Throwable;)V

    return-void
.end method

.method public static error(Ljava/lang/Throwable;Lhiy;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public static error(Ljava/lang/Throwable;Lhjc;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 78
    invoke-interface {p1, p0}, Lhjc;->onError(Ljava/lang/Throwable;)V
