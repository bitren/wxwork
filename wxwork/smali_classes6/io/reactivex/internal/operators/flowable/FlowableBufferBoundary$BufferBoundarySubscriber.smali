...
# direct methods
.method constructor <init>(Linu;Lint;Lhjv;Ljava/util/concurrent/Callable;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 94
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableBufferBoundary$BufferBoundarySubscriber;->actual:Linu;
    ...
    .line 96
    iput-object p2, p0, Lio/reactivex/internal/operators/flowable/FlowableBufferBoundary$BufferBoundarySubscriber;->bufferOpen:Lint;

    .line 97
    iput-object p3, p0, Lio/reactivex/internal/operators/flowable/FlowableBufferBoundary$BufferBoundarySubscriber;->bufferClose:Lhjv;
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableBufferBoundary$BufferBoundarySubscriber;->queue:Lhkz;
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableBufferBoundary$BufferBoundarySubscriber;->subscribers:Lhji;
...
# virtual methods
.method boundaryError(Lhjj;Ljava/lang/Throwable;)V
    .locals 1
    ...
    .line 242
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableBufferBoundary$BufferBoundarySubscriber;->subscribers:Lhji;
...
.method public cancel()V
    ...
    .line 178
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableBufferBoundary$BufferBoundarySubscriber;->queue:Lhkz;
...
.method close(Lio/reactivex/internal/operators/flowable/FlowableBufferBoundary$BufferCloseSubscriber;J)V
    ...
    .line 223
    iget-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableBufferBoundary$BufferBoundarySubscriber;->subscribers:Lhji;

    invoke-virtual {p1}, Lhji;->size()I
    ...
    .line 232
    :cond_1
    iget-object v1, p0, Lio/reactivex/internal/operators/flowable/FlowableBufferBoundary$BufferBoundarySubscriber;->queue:Lhkz;
    ...
    invoke-virtual {v1, p2}, Lhkz;->offer(Ljava/lang/Object;)Z
...
.method drain()V
    ...
    .line 253
    iget-object v2, p0, Lio/reactivex/internal/operators/flowable/FlowableBufferBoundary$BufferBoundarySubscriber;->actual:Linu;

    .line 254
    iget-object v3, p0, Lio/reactivex/internal/operators/flowable/FlowableBufferBoundary$BufferBoundarySubscriber;->queue:Lhkz;
    ...
    .line 301
    :cond_9
    invoke-virtual {v3}, Lhkz;->isEmpty()Z
...
.method public onComplete()V
    ...
    .line 155
    iget-object v2, p0, Lio/reactivex/internal/operators/flowable/FlowableBufferBoundary$BufferBoundarySubscriber;->queue:Lhkz;

    invoke-virtual {v2, v1}, Lhkz;->offer(Ljava/lang/Object;)Z
...
.method public onSubscribe(Linv;)V
    ...
    .line 111
    iget-object v1, p0, Lio/reactivex/internal/operators/flowable/FlowableBufferBoundary$BufferBoundarySubscriber;->subscribers:Lhji;

    invoke-virtual {v1, v0}, Lhji;->a(Lhjj;)Z

    .line 113
    iget-object v1, p0, Lio/reactivex/internal/operators/flowable/FlowableBufferBoundary$BufferBoundarySubscriber;->bufferOpen:Lint;

    invoke-interface {v1, v0}, Lint;->subscribe(Linu;)V
...
.method open(Ljava/lang/Object;)V
    ...
    .line 188
    iget-object v1, p0, Lio/reactivex/internal/operators/flowable/FlowableBufferBoundary$BufferBoundarySubscriber;->bufferClose:Lhjv;
