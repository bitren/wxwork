...
# static fields
.field static final nMr:[Lio/reactivex/internal/operators/flowable/FlowablePublishMulticast$MulticastSubscription;

.field static final nMs:[Lio/reactivex/internal/operators/flowable/FlowablePublishMulticast$MulticastSubscription;
...
.method static constructor <clinit>()V
    ...
    sput-object v1, Lio/reactivex/internal/operators/flowable/FlowablePublishMulticast$a;->nMr:[Lio/reactivex/internal/operators/flowable/FlowablePublishMulticast$MulticastSubscription;

    .line 133
    new-array v0, v0, [Lio/reactivex/internal/operators/flowable/FlowablePublishMulticast$MulticastSubscription;

    sput-object v0, Lio/reactivex/internal/operators/flowable/FlowablePublishMulticast$a;->nMs:[Lio/reactivex/internal/operators/flowable/FlowablePublishMulticast$MulticastSubscription;
...
.method constructor <init>(IZ)V
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowablePublishMulticast$a;->s:Ljava/util/concurrent/atomic/AtomicReference;

    .line 163
    new-instance p1, Ljava/util/concurrent/atomic/AtomicReference;

    sget-object p2, Lio/reactivex/internal/operators/flowable/FlowablePublishMulticast$a;->nMr:[Lio/reactivex/internal/operators/flowable/FlowablePublishMulticast$MulticastSubscription;
...
.method public a(Linu;)V
    ...
    invoke-direct {v0, p1, p0}, Lio/reactivex/internal/operators/flowable/FlowablePublishMulticast$MulticastSubscription;-><init>(Linu;Lio/reactivex/internal/operators/flowable/FlowablePublishMulticast$a;)V
...
.method a(Lio/reactivex/internal/operators/flowable/FlowablePublishMulticast$MulticastSubscription;)Z
    ...
    .line 246
    sget-object v1, Lio/reactivex/internal/operators/flowable/FlowablePublishMulticast$a;->nMs:[Lio/reactivex/internal/operators/flowable/FlowablePublishMulticast$MulticastSubscription;
...
.method b(Lio/reactivex/internal/operators/flowable/FlowablePublishMulticast$MulticastSubscription;)V
    ...
    .line 282
    sget-object v1, Lio/reactivex/internal/operators/flowable/FlowablePublishMulticast$a;->nMr:[Lio/reactivex/internal/operators/flowable/FlowablePublishMulticast$MulticastSubscription;
...
.method public dispose()V
    ...
    .line 197
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowablePublishMulticast$a;->s:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    .line 199
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowablePublishMulticast$a;->queue:Lhkh;
...
.method drain()V
    ...
    .line 321
    :cond_0
    iget-object v0, v1, Lio/reactivex/internal/operators/flowable/FlowablePublishMulticast$a;->queue:Lhkh;
    ...
    .line 359
    :cond_6
    iget-boolean v7, v1, Lio/reactivex/internal/operators/flowable/FlowablePublishMulticast$a;->done:Z

    if-eqz v7, :cond_7

    .line 361
    iget-boolean v10, v1, Lio/reactivex/internal/operators/flowable/FlowablePublishMulticast$a;->delayError:Z

    if-nez v10, :cond_7

    .line 362
    iget-object v10, v1, Lio/reactivex/internal/operators/flowable/FlowablePublishMulticast$a;->error:Ljava/lang/Throwable;

    if-eqz v10, :cond_7

    .line 364
    invoke-virtual {v1, v10}, Lio/reactivex/internal/operators/flowable/FlowablePublishMulticast$a;->errorAll(Ljava/lang/Throwable;)V
    ...
    .line 387
    :cond_9
    invoke-virtual/range {p0 .. p0}, Lio/reactivex/internal/operators/flowable/FlowablePublishMulticast$a;->ly()V
    ...
    .line 404
    :cond_c
    iget-object v5, v5, Lio/reactivex/internal/operators/flowable/FlowablePublishMulticast$MulticastSubscription;->actual:Linu;

    invoke-interface {v5, v10}, Linu;->onNext(Ljava/lang/Object;)V
    ...
    .line 414
    iget-object v5, v1, Lio/reactivex/internal/operators/flowable/FlowablePublishMulticast$a;->s:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    invoke-interface {v5, v6, v7}, Linv;->request(J)V
    ...
    .line 375
    iget-object v0, v1, Lio/reactivex/internal/operators/flowable/FlowablePublishMulticast$a;->s:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    .line 452
    :cond_17
    iput v9, v1, Lio/reactivex/internal/operators/flowable/FlowablePublishMulticast$a;->consumed:I
...
.method errorAll(Ljava/lang/Throwable;)V
    ...
    .line 468
    iget-object v3, v3, Lio/reactivex/internal/operators/flowable/FlowablePublishMulticast$MulticastSubscription;->actual:Linu;

    invoke-interface {v3, p1}, Linu;->onError(Ljava/lang/Throwable;)V
...
.method ly()V
    ...
    invoke-interface {v3}, Linu;->onComplete()V
...
.method public onNext(Ljava/lang/Object;)V
    ...
    .line 217
    iget-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowablePublishMulticast$a;->s:Ljava/util/concurrent/atomic/AtomicReference;
...
.method public onSubscribe(Linv;)V
    ...
    .line 176
    iput-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowablePublishMulticast$a;->queue:Lhkh;
