...
# direct methods
.method constructor <init>(Lhkb;[Ljava/lang/Object;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 200
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableFromArray$ArrayConditionalSubscription;->actual:Lhkb;
...
.method fastPath()V
    ...
    .line 207
    iget-object v2, p0, Lio/reactivex/internal/operators/flowable/FlowableFromArray$ArrayConditionalSubscription;->actual:Lhkb;
    ...
    invoke-interface {v2, v0}, Lhkb;->onError(Ljava/lang/Throwable;)V

    return-void

    .line 218
    :cond_1
    invoke-interface {v2, v4}, Lhkb;->tryOnNext(Ljava/lang/Object;)Z
    ...
    .line 224
    :cond_3
    invoke-interface {v2}, Lhkb;->onComplete()V
...
.method slowPath(J)V
    ...
    .line 233
    iget-object v3, p0, Lio/reactivex/internal/operators/flowable/FlowableFromArray$ArrayConditionalSubscription;->actual:Lhkb;
    ...
    invoke-interface {v3, p1}, Lhkb;->onError(Ljava/lang/Throwable;)V

    return-void

    .line 248
    :cond_2
    invoke-interface {v3, v8}, Lhkb;->tryOnNext(Ljava/lang/Object;)Z
