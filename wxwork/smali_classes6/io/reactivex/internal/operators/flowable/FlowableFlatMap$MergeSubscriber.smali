...
.method constructor <init>(Linu;Lhjv;ZII)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 99
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableFlatMap$MergeSubscriber;->actual:Linu;

    .line 100
    iput-object p2, p0, Lio/reactivex/internal/operators/flowable/FlowableFlatMap$MergeSubscriber;->mapper:Lhjv;
...
.method public cancel()V
    ...
    .line 353
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableFlatMap$MergeSubscriber;->upstream:Linv;
    ...
    .line 356
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableFlatMap$MergeSubscriber;->queue:Lhkg;
...
.method checkTerminate()Z
    ...
    .line 566
    iget-object v2, p0, Lio/reactivex/internal/operators/flowable/FlowableFlatMap$MergeSubscriber;->actual:Linu;
...
.method drainLoop()V
    ...
    .line 371
    iget-object v2, v1, Lio/reactivex/internal/operators/flowable/FlowableFlatMap$MergeSubscriber;->actual:Linu;
    ...
    .line 377
    :cond_1
    iget-object v0, v1, Lio/reactivex/internal/operators/flowable/FlowableFlatMap$MergeSubscriber;->queue:Lhkg;
    ...
    .line 389
    invoke-interface {v0}, Lhkg;->poll()Ljava/lang/Object;
    ...
    .line 398
    :cond_4
    invoke-interface {v2, v9}, Linu;->onNext(Ljava/lang/Object;)V
    ...
    .line 418
    iget-object v7, v1, Lio/reactivex/internal/operators/flowable/FlowableFlatMap$MergeSubscriber;->queue:Lhkg;
    ...
    .line 422
    invoke-interface {v7}, Lhkg;->isEmpty()Z
    ...
    .line 472
    :cond_16
    iget-object v12, v7, Lio/reactivex/internal/operators/flowable/FlowableFlatMap$InnerSubscriber;->queue:Lhkh;
    ...
    .line 480
    :try_start_0
    invoke-interface {v12}, Lhkh;->poll()Ljava/lang/Object;
    ...
    .line 500
    :cond_18
    invoke-interface {v2, v14}, Linu;->onNext(Ljava/lang/Object;)V
    ...
    .line 482
    invoke-static {v8}, Lhjl;->throwIfFatal(Ljava/lang/Throwable;)V
    ...
    .line 486
    iget-object v0, v1, Lio/reactivex/internal/operators/flowable/FlowableFlatMap$MergeSubscriber;->upstream:Linv;
    ...
    .line 522
    iget-object v9, v7, Lio/reactivex/internal/operators/flowable/FlowableFlatMap$InnerSubscriber;->queue:Lhkh;
    ...
    .line 523
    invoke-interface {v9}, Lhkh;->isEmpty()Z
    ...
    .line 545
    iget-object v5, v1, Lio/reactivex/internal/operators/flowable/FlowableFlatMap$MergeSubscriber;->upstream:Linv;

    invoke-interface {v5, v3, v4}, Linv;->request(J)V
...
.method getInnerQueue(Lio/reactivex/internal/operators/flowable/FlowableFlatMap$InnerSubscriber;)Lhkh;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 269
    iget-object v0, p1, Lio/reactivex/internal/operators/flowable/FlowableFlatMap$InnerSubscriber;->queue:Lhkh;
    ...
    .line 272
    iput-object v0, p1, Lio/reactivex/internal/operators/flowable/FlowableFlatMap$InnerSubscriber;->queue:Lhkh;

    :cond_0
    return-object v0
.end method

.method getMainQueue()Lhkh;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    .line 224
    :goto_0
    iput-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableFlatMap$MergeSubscriber;->queue:Lhkg;
...
.method innerError(Lio/reactivex/internal/operators/flowable/FlowableFlatMap$InnerSubscriber;Ljava/lang/Throwable;)V
    ...
    .line 600
    iget-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableFlatMap$MergeSubscriber;->upstream:Linv;
...
.method public onNext(Ljava/lang/Object;)V
    ...
    :cond_0
    :try_start_0
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableFlatMap$MergeSubscriber;->mapper:Lhjv;
...
.method public onSubscribe(Linv;)V
    ...
    .line 111
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableFlatMap$MergeSubscriber;->upstream:Linv;

    .line 112
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableFlatMap$MergeSubscriber;->actual:Linu;
...
.method tryEmit(Ljava/lang/Object;Lio/reactivex/internal/operators/flowable/FlowableFlatMap$InnerSubscriber;)V
    ...
    .line 280
    iget-object v2, p2, Lio/reactivex/internal/operators/flowable/FlowableFlatMap$InnerSubscriber;->queue:Lhkh;
    ...
    .line 281
    invoke-interface {v2}, Lhkh;->isEmpty()Z
    ...
    invoke-interface {v2, p1}, Linu;->onNext(Ljava/lang/Object;)V
    ...
    .line 289
    invoke-virtual {p0, p2}, Lio/reactivex/internal/operators/flowable/FlowableFlatMap$MergeSubscriber;->getInnerQueue(Lio/reactivex/internal/operators/flowable/FlowableFlatMap$InnerSubscriber;)Lhkh;

    move-result-object v2

    .line 291
    :cond_3
    invoke-interface {v2, p1}, Lhkh;->offer(Ljava/lang/Object;)Z
    ...
    .line 300
    :cond_5
    iget-object v0, p2, Lio/reactivex/internal/operators/flowable/FlowableFlatMap$InnerSubscriber;->queue:Lhkh;
    ...
    .line 303
    iput-object v0, p2, Lio/reactivex/internal/operators/flowable/FlowableFlatMap$InnerSubscriber;->queue:Lhkh;
...
.method tryEmitScalar(Ljava/lang/Object;)V
    ...
    .line 232
    iget-object v4, p0, Lio/reactivex/internal/operators/flowable/FlowableFlatMap$MergeSubscriber;->queue:Lhkg;
    ...
    .line 233
    invoke-interface {v4}, Lhkh;->isEmpty()Z
    ...
    .line 234
    :cond_0
    iget-object v4, p0, Lio/reactivex/internal/operators/flowable/FlowableFlatMap$MergeSubscriber;->actual:Linu;

    invoke-interface {v4, p1}, Linu;->onNext(Ljava/lang/Object;)V
    ...
    .line 245
    invoke-virtual {p0}, Lio/reactivex/internal/operators/flowable/FlowableFlatMap$MergeSubscriber;->getMainQueue()Lhkh;

    move-result-object v4

    .line 247
    :cond_3
    invoke-interface {v4, p1}, Lhkh;->offer(Ljava/lang/Object;)Z
