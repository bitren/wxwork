...
# direct methods
.method public static a(Ljava/lang/Object;Lhjv;)Lhiu;
    .locals 1
    ...
    invoke-direct {v0, p0, p1}, Lio/reactivex/internal/operators/observable/ObservableScalarXMap$a;-><init>(Ljava/lang/Object;Lhjv;)V
...
.method public static a(Lhix;Lhiy;Lhjv;)Z
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    invoke-direct {p2, p1, p0}, Lio/reactivex/internal/operators/observable/ObservableScalarXMap$ScalarDisposable;-><init>(Lhiy;Ljava/lang/Object;)V

    .line 93
    invoke-interface {p1, p2}, Lhiy;->onSubscribe(Lhjj;)V
    ...
    .line 84
    invoke-static {p0, p1}, Lio/reactivex/internal/disposables/EmptyDisposable;->error(Ljava/lang/Throwable;Lhiy;)V

    return v0

    .line 96
    :cond_2
    invoke-interface {p0, p1}, Lhix;->subscribe(Lhiy;)V
