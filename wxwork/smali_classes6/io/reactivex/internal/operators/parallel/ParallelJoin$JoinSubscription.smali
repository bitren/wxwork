...
# direct methods
.method constructor <init>(Linu;II)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 140
    invoke-direct {p0, p1, p2, p3}, Lio/reactivex/internal/operators/parallel/ParallelJoin$JoinSubscriptionBase;-><init>(Linu;II)V
...
.method drainLoop()V
    ...
    .line 218
    iget-object v3, v0, Lio/reactivex/internal/operators/parallel/ParallelJoin$JoinSubscription;->actual:Linu;
    ...
    .line 245
    iget-object v12, v4, Lio/reactivex/internal/operators/parallel/ParallelJoin$JoinInnerSubscriber;->queue:Lhkg;

    if-eqz v12, :cond_4

    .line 247
    invoke-interface {v12}, Lhkg;->poll()Ljava/lang/Object;
    ...
    .line 251
    invoke-interface {v3, v12}, Linu;->onNext(Ljava/lang/Object;)V
    ...
    .line 290
    iget-object v13, v13, Lio/reactivex/internal/operators/parallel/ParallelJoin$JoinInnerSubscriber;->queue:Lhkg;

    if-eqz v13, :cond_c

    .line 291
    invoke-interface {v13}, Lhkh;->isEmpty()Z
...
.method public onNext(Lio/reactivex/internal/operators/parallel/ParallelJoin$JoinInnerSubscriber;Ljava/lang/Object;)V
    ...
    .line 147
    iget-object v0, p0, Lio/reactivex/internal/operators/parallel/ParallelJoin$JoinSubscription;->actual:Linu;
    ...
    .line 153
    :cond_1
    invoke-virtual {p1}, Lio/reactivex/internal/operators/parallel/ParallelJoin$JoinInnerSubscriber;->getQueue()Lhkg;

    move-result-object p1

    .line 155
    invoke-interface {p1, p2}, Lhkg;->offer(Ljava/lang/Object;)Z
    ...
    .line 159
    iget-object p2, p0, Lio/reactivex/internal/operators/parallel/ParallelJoin$JoinSubscription;->actual:Linu;
