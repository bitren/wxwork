...
# direct methods
.method constructor <init>(Linu;ILjava/util/Comparator;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 81
    iput-object p1, p0, Lio/reactivex/internal/operators/parallel/ParallelSortedJoin$SortedJoinSubscription;->actual:Linu;
...
.method drain()V
    ...
    .line 145
    :cond_0
    iget-object v2, v1, Lio/reactivex/internal/operators/parallel/ParallelSortedJoin$SortedJoinSubscription;->actual:Linu;
    ...
    .line 165
    invoke-interface {v2, v15}, Linu;->onError(Ljava/lang/Throwable;)V
    ...
    .line 211
    :cond_8
    invoke-interface {v2, v13}, Linu;->onNext(Ljava/lang/Object;)V
    ...
    .line 228
    invoke-interface {v2, v5}, Linu;->onError(Ljava/lang/Throwable;)V
