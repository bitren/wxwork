...
.method public constructor <init>(Ljava/util/concurrent/Executor;)V
    ...
    iput-object v0, p0, Lio/reactivex/internal/schedulers/ExecutorScheduler$ExecutorWorker;->nOs:Lhji;
...
.method public b(Ljava/lang/Runnable;JLjava/util/concurrent/TimeUnit;)Lhjj;
    ...
    .line 159
    invoke-virtual {p0, p1}, Lio/reactivex/internal/schedulers/ExecutorScheduler$ExecutorWorker;->G(Ljava/lang/Runnable;)Lhjj;
    ...
    invoke-direct {v1, v0}, Lio/reactivex/internal/disposables/SequentialDisposable;-><init>(Lhjj;)V
    ...
    iget-object p1, p0, Lio/reactivex/internal/schedulers/ExecutorScheduler$ExecutorWorker;->nOs:Lhji;

    invoke-direct {v2, v3, p1}, Lio/reactivex/internal/schedulers/ScheduledRunnable;-><init>(Ljava/lang/Runnable;Lhjy;)V

    .line 173
    iget-object p1, p0, Lio/reactivex/internal/schedulers/ExecutorScheduler$ExecutorWorker;->nOs:Lhji;

    invoke-virtual {p1, v2}, Lhji;->a(Lhjj;)Z
    ...
    .line 185
    :cond_2
    sget-object p1, Lio/reactivex/internal/schedulers/ExecutorScheduler;->nOp:Lhiz;

    invoke-virtual {p1, v2, p2, p3, p4}, Lhiz;->a(Ljava/lang/Runnable;JLjava/util/concurrent/TimeUnit;)Lhjj;
    ...
    invoke-direct {p2, p1}, Lhlb;-><init>(Lhjj;)V

    invoke-virtual {v2, p2}, Lio/reactivex/internal/schedulers/ScheduledRunnable;->setFuture(Ljava/util/concurrent/Future;)V

    .line 189
    :goto_0
    invoke-virtual {v0, v2}, Lio/reactivex/internal/disposables/SequentialDisposable;->replace(Lhjj;)Z
...
.method public dispose()V
    ...
    .line 198
    iget-object v0, p0, Lio/reactivex/internal/schedulers/ExecutorScheduler$ExecutorWorker;->nOs:Lhji;
