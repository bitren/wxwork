...
.method protected computeReflected()Lhug;
    ...
    .line 39
    invoke-static {p0}, Lhst;->a(Lkotlin/jvm/internal/FunctionReference;)Lhuk;
...
.method public equals(Ljava/lang/Object;)Z
    ...
    .line 78
    invoke-virtual {p0}, Lkotlin/jvm/internal/FunctionReference;->getOwner()Lhuj;

    move-result-object v1

    if-nez v1, :cond_1

    invoke-virtual {p1}, Lkotlin/jvm/internal/FunctionReference;->getOwner()Lhuj;
    ...
    .line 83
    :cond_3
    instance-of v0, p1, Lhuk;

    if-eqz v0, :cond_4

    .line 84
    invoke-virtual {p0}, Lkotlin/jvm/internal/FunctionReference;->compute()Lhug;
...
.method protected bridge synthetic getReflected()Lhug;
    .locals 1

    .line 12
    invoke-virtual {p0}, Lkotlin/jvm/internal/FunctionReference;->getReflected()Lhuk;
...
.method protected getReflected()Lhuk;
    .locals 1

    .line 33
    invoke-super {p0}, Lkotlin/jvm/internal/CallableReference;->getReflected()Lhug;
...
.method public isExternal()Z
    ...
    invoke-interface {v0}, Lhuk;->isExternal()Z
...
.method public isInfix()Z
    ...
    invoke-interface {v0}, Lhuk;->isInfix()Z
...
.method public isInline()Z
    ...
    invoke-interface {v0}, Lhuk;->isInline()Z
...
.method public isOperator()Z
    ...
    invoke-interface {v0}, Lhuk;->isOperator()Z
...
.method public isSuspend()Z
    ...
    invoke-interface {v0}, Lhuk;->isSuspend()Z
