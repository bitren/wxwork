...
.method public decode(ILwb;)Lwd;
    ...
    invoke-direct/range {v0 .. v6}, Lwh;-><init>(Lcom/android/dx/io/instructions/InstructionCodec;IILcom/android/dx/io/IndexType;I[I)V
...
.method public encode(Lwd;Lwc;)V
    ...
    .line 706
    invoke-virtual {p1}, Lwh;->getOpcode()I

    move-result v0

    .line 707
    invoke-virtual {p1}, Lwh;->rn()I

    move-result v1

    invoke-virtual {p1}, Lwh;->rb()I
    ...
    .line 708
    invoke-virtual {p1}, Lwh;->qV()S

    move-result v1

    .line 709
    invoke-virtual {p1}, Lwh;->re()I

    move-result v2

    invoke-virtual {p1}, Lwh;->rf()I

    move-result v3

    invoke-virtual {p1}, Lwh;->rg()I

    move-result v4

    invoke-virtual {p1}, Lwh;->rm()I
