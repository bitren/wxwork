...
.method public static checkUpgrade(ZZ)V
    ...
    invoke-direct {p1, v5, v0}, Lcom/tencent/bugly/beta/global/d;-><init>(I[Ljava/lang/Object;)V
...
.method public static declared-synchronized init(Landroid/content/Context;Z)V
    ...
    :cond_2
    :try_start_2
    const-string v3, "current upgrade sdk version:1.3.6"
    ...
    const-string/jumbo p1, "setted upgradeCheckPeriod: %d"
    ...
    const-string/jumbo p1, "setted initDelay: %d"
    ...
    const-string/jumbo p1, "setted smallIconId: %d"
    ...
    const-string/jumbo p1, "setted largeIconId: %d"
    ...
    const-string/jumbo p1, "setted defaultBannerId: %d"
    ...
    :cond_c
    const-string/jumbo p1, "setted canShowUpgradeActs: %s"
    ...
    :cond_f
    const-string/jumbo p1, "setted canNotShowUpgradeActs: %s"
    ...
    const-string/jumbo p1, "showInterruptedStrategy %s"
    ...
    const-string/jumbo p1, "storageDir is not exists: %s"
    ...
    const-string/jumbo p1, "setted storageDir: %s"
    ...
    const-string/jumbo p1, "setPatchRestartOnScreenOff %s"
    ...
    :cond_1b
    const-string/jumbo p1, "setted soBlackList: %s"
...
.method public static loadLibrary(Ljava/lang/String;)V
    ...
    :cond_3
    :goto_1
    const-string/jumbo p0, "libName is invalid"
...
.method public declared-synchronized init(Landroid/content/Context;ZLcom/tencent/bugly/BuglyStrategy;)V
    ...
    invoke-virtual {p3, v0, v1}, Lcom/tencent/bugly/crashreport/common/info/a;->d(Ljava/lang/String;Ljava/lang/String;)V
