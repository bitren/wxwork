...
.method public static a(Landroid/content/Context;ILjava/lang/String;)Ljava/lang/String;
    ...
    const-string/jumbo p0, "no read_log permission!"
...
.method public static a(Landroid/os/Parcel;)Ljava/util/Map;
    ...
    const-string/jumbo v3, "pluginNum"
    ...
    const-string/jumbo v7, "pluginVal"

    invoke-virtual {v6, v7}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-virtual {v6, v5}, Ljava/lang/StringBuilder;->append(I)Ljava/lang/StringBuilder;

    const-string/jumbo v7, "plugInId"
    ...
    const-string/jumbo v8, "plugInUUID"
    ...
    const-string/jumbo v9, "plugInVersion"
    ...
    :cond_3
    const-string/jumbo p0, "map plugin parcel error!"
...
.method public static a(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;I)V
    ...
    const-string/jumbo p0, "rqdp{  sv sd start} %s"
    ...
    :cond_6
    :goto_3
    const-string/jumbo p0, "rqdp{  sv sd end}"
...
.method public static a(Landroid/os/Parcel;Ljava/util/Map;)V
    ...
    const-string/jumbo v5, "pluginKey"
    ...
    const-string/jumbo v4, "pluginVal"

    invoke-virtual {v3, v4}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-virtual {v3, v0}, Ljava/lang/StringBuilder;->append(I)Ljava/lang/StringBuilder;

    const-string/jumbo v4, "plugInId"
    ...
    const-string/jumbo v4, "plugInUUID"
...
.method public static a(Ljava/io/File;Ljava/io/File;I)Z
    ...
    const-string/jumbo v0, "rqdp{  ZF start}"
    ...
    :goto_3
    const-string/jumbo p1, "rqdp{  ZF end}"
    ...
    :cond_9
    :goto_7
    const-string/jumbo p0, "rqdp{  ZF end}"
    ...
    const-string/jumbo p2, "rqdp{  ZF end}"
    ...
    :cond_d
    :goto_c
    const-string/jumbo p0, "rqdp{  !sFile.exists() || !sFile.canRead(),pls check ,return!}"
    ...
    :cond_e
    :goto_d
    const-string/jumbo p0, "rqdp{  err ZF 1R!}"
...
.method public static a(Ljava/io/File;Ljava/lang/String;Ljava/lang/String;)[B
    ...
    .line 232
    invoke-virtual {v3, p0, v2, v4}, Ljava/util/zip/ZipOutputStream;->write([BII)V
...
.method public static a([BILjava/lang/String;)[B
    ...
    :cond_0
    const-string/jumbo v0, "rqdp{  enD:} %d %d"
...
.method public static b(Landroid/content/Context;Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 650
    sget-object v4, Lcom/tencent/bugly/proguard/ap;->a:Ljava/util/Map;
...
.method public static b(Landroid/os/Parcel;)Ljava/util/Map;
    ...
    :cond_1
    const-string/jumbo p0, "map parcel error!"
...
.method public static b(Landroid/content/Context;)Z
    ...
    :catch_1
    const-string/jumbo p0, "\u65e0\u6cd5\u83b7\u53d6GET_TASK\u6743\u9650\uff0c\u5c06\u5728\u901a\u77e5\u680f\u63d0\u9192\u5347\u7ea7\uff0c\u5982\u9700\u5f39\u7a97\u63d0\u9192\uff0c\u8bf7\u5728AndroidManifest.xml\u4e2d\u6dfb\u52a0GET_TASKS\u6743\u9650\uff1a\n<uses-permission android:name=\"android.permission.GET_TASKS\" />\n"
