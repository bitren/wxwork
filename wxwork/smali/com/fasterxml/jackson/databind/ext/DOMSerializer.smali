...
.method public getSchema(Lamt;Ljava/lang/reflect/Type;)Lamm;
    ...
    .line 46
    invoke-virtual {p0, p1, p2}, Lcom/fasterxml/jackson/databind/ext/DOMSerializer;->createSchemaNode(Ljava/lang/String;Z)Laqj;
...
.method public bridge synthetic serialize(Ljava/lang/Object;Lcom/fasterxml/jackson/core/JsonGenerator;Lamt;)V
    ...
    invoke-virtual {p0, p1, p2, p3}, Lcom/fasterxml/jackson/databind/ext/DOMSerializer;->serialize(Lorg/w3c/dom/Node;Lcom/fasterxml/jackson/core/JsonGenerator;Lamt;)V

    return-void
.end method

.method public serialize(Lorg/w3c/dom/Node;Lcom/fasterxml/jackson/core/JsonGenerator;Lamt;)V
    .locals 0
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;,
