...
.method public acceptJsonFormatVisitor(Laou;Lcom/fasterxml/jackson/databind/JavaType;)V
    ...
    invoke-virtual {p0, p1, p2, v0}, Lcom/fasterxml/jackson/databind/ser/std/SqlDateSerializer;->_acceptJsonFormatVisitor(Laou;Lcom/fasterxml/jackson/databind/JavaType;Z)V
...
.method public getSchema(Lamt;Ljava/lang/reflect/Type;)Lamm;
    ...
    .line 59
    invoke-virtual {p0, p1, p2}, Lcom/fasterxml/jackson/databind/ser/std/SqlDateSerializer;->createSchemaNode(Ljava/lang/String;Z)Laqj;
...
.method public bridge synthetic serialize(Ljava/lang/Object;Lcom/fasterxml/jackson/core/JsonGenerator;Lamt;)V
    ...
    invoke-virtual {p0, p1, p2, p3}, Lcom/fasterxml/jackson/databind/ser/std/SqlDateSerializer;->serialize(Ljava/sql/Date;Lcom/fasterxml/jackson/core/JsonGenerator;Lamt;)V

    return-void
.end method

.method public serialize(Ljava/sql/Date;Lcom/fasterxml/jackson/core/JsonGenerator;Lamt;)V
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;,
    ...
    .line 48
    invoke-virtual {p0, p3}, Lcom/fasterxml/jackson/databind/ser/std/SqlDateSerializer;->_asTimestamp(Lamt;)Z
