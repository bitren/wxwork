...
.field protected _defaultImplDeserializer:Laml;
...
# direct methods
.method protected constructor <init>(Lcom/fasterxml/jackson/databind/JavaType;Laph;Ljava/lang/String;ZLjava/lang/Class;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 73
    iput-object p2, p0, Lcom/fasterxml/jackson/databind/jsontype/impl/TypeDeserializerBase;->_idResolver:Laph;
    ...
    .line 91
    :goto_0
    iput-object p2, p0, Lcom/fasterxml/jackson/databind/jsontype/impl/TypeDeserializerBase;->_property:Lamj;

    return-void
.end method

.method protected constructor <init>(Lcom/fasterxml/jackson/databind/jsontype/impl/TypeDeserializerBase;Lamj;)V
    .locals 1
    ...
    .line 97
    iget-object v0, p1, Lcom/fasterxml/jackson/databind/jsontype/impl/TypeDeserializerBase;->_idResolver:Laph;

    iput-object v0, p0, Lcom/fasterxml/jackson/databind/jsontype/impl/TypeDeserializerBase;->_idResolver:Laph;
    ...
    .line 102
    iget-object p1, p1, Lcom/fasterxml/jackson/databind/jsontype/impl/TypeDeserializerBase;->_defaultImplDeserializer:Laml;

    iput-object p1, p0, Lcom/fasterxml/jackson/databind/jsontype/impl/TypeDeserializerBase;->_defaultImplDeserializer:Laml;
...
.method protected _deserializeWithNativeTypeId(Lcom/fasterxml/jackson/core/JsonParser;Lcom/fasterxml/jackson/databind/DeserializationContext;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .line 242
    invoke-virtual {p0, p2}, Lcom/fasterxml/jackson/databind/jsontype/impl/TypeDeserializerBase;->_findDefaultImplDeserializer(Lcom/fasterxml/jackson/databind/DeserializationContext;)Laml;
    ...
    .line 248
    :goto_0
    invoke-virtual {p0, p2, p3}, Lcom/fasterxml/jackson/databind/jsontype/impl/TypeDeserializerBase;->_findDeserializer(Lcom/fasterxml/jackson/databind/DeserializationContext;Ljava/lang/String;)Laml;
...
.method protected final _findDefaultImplDeserializer(Lcom/fasterxml/jackson/databind/DeserializationContext;)Laml;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 203
    invoke-static {v0}, Laro;->aQ(Ljava/lang/Class;)Z
    ...
    .line 208
    :try_start_0
    iget-object v1, p0, Lcom/fasterxml/jackson/databind/jsontype/impl/TypeDeserializerBase;->_defaultImplDeserializer:Laml;
    ...
    iget-object v2, p0, Lcom/fasterxml/jackson/databind/jsontype/impl/TypeDeserializerBase;->_property:Lamj;

    invoke-virtual {p1, v1, v2}, Lcom/fasterxml/jackson/databind/DeserializationContext;->findContextualValueDeserializer(Lcom/fasterxml/jackson/databind/JavaType;Lamj;)Laml;
    ...
    .line 212
    :cond_3
    iget-object p1, p0, Lcom/fasterxml/jackson/databind/jsontype/impl/TypeDeserializerBase;->_defaultImplDeserializer:Laml;
...
.method protected final _findDeserializer(Lcom/fasterxml/jackson/databind/DeserializationContext;Ljava/lang/String;)Laml;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 158
    iget-object v0, p0, Lcom/fasterxml/jackson/databind/jsontype/impl/TypeDeserializerBase;->_idResolver:Laph;

    invoke-interface {v0, p1, p2}, Laph;->a(Lamk;Ljava/lang/String;)Lcom/fasterxml/jackson/databind/JavaType;
    ...
    .line 161
    invoke-virtual {p0, p1}, Lcom/fasterxml/jackson/databind/jsontype/impl/TypeDeserializerBase;->_findDefaultImplDeserializer(Lcom/fasterxml/jackson/databind/DeserializationContext;)Laml;
    ...
    invoke-virtual {p0, p1, p2, v0, v1}, Lcom/fasterxml/jackson/databind/jsontype/impl/TypeDeserializerBase;->_handleUnknownTypeId(Lcom/fasterxml/jackson/databind/DeserializationContext;Ljava/lang/String;Laph;Lcom/fasterxml/jackson/databind/JavaType;)Laml;
    ...
    .line 183
    :cond_1
    iget-object v1, p0, Lcom/fasterxml/jackson/databind/jsontype/impl/TypeDeserializerBase;->_property:Lamj;

    invoke-virtual {p1, v0, v1}, Lcom/fasterxml/jackson/databind/DeserializationContext;->findContextualValueDeserializer(Lcom/fasterxml/jackson/databind/JavaType;Lamj;)Laml;
...
.method protected _handleUnknownTypeId(Lcom/fasterxml/jackson/databind/DeserializationContext;Ljava/lang/String;Laph;Lcom/fasterxml/jackson/databind/JavaType;)Laml;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {p3}, Laps;->Fi()Ljava/lang/String;

    move-result-object p3

    if-nez p3, :cond_0

    const-string/jumbo p3, "known type ids are not statically known"
    ...
    const-string/jumbo v0, "known type ids = "
...
.method public abstract forProperty(Lamj;)Lapg;
.end method
...
.method public getTypeIdResolver()Laph;
    .locals 1
...
.method public toString()Ljava/lang/String;
    ...
    iget-object v1, p0, Lcom/fasterxml/jackson/databind/jsontype/impl/TypeDeserializerBase;->_idResolver:Laph;
