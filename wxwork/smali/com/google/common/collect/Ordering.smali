...
.method public static arbitrary()Lcom/google/common/collect/Ordering;
    ...
    .line 314
    sget-object v0, Lcom/google/common/collect/Ordering$b;->bUW:Lcom/google/common/collect/Ordering;
...
.method public leastOf(Ljava/util/Iterator;I)Ljava/util/List;
    ...
    .line 778
    invoke-static {p1}, Lcom/google/common/collect/Lists;->v(Ljava/util/Iterator;)Ljava/util/ArrayList;
    ...
    .line 786
    :cond_2
    invoke-static {p2, p0}, Lbgi;->a(ILjava/util/Comparator;)Lbgi;

    move-result-object p2

    .line 787
    invoke-virtual {p2, p1}, Lbgi;->z(Ljava/util/Iterator;)V

    .line 788
    invoke-virtual {p2}, Lbgi;->Rs()Ljava/util/List;
...
.method onKeys()Lcom/google/common/collect/Ordering;
    ...
    .line 452
    invoke-static {}, Lcom/google/common/collect/Maps;->QP()Lbdj;

    move-result-object v0

    invoke-virtual {p0, v0}, Lcom/google/common/collect/Ordering;->onResultOf(Lbdj;)Lcom/google/common/collect/Ordering;
...
.method public onResultOf(Lbdj;)Lcom/google/common/collect/Ordering;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<F:",
    ...
    invoke-direct {v0, p1, p0}, Lcom/google/common/collect/ByFunctionOrdering;-><init>(Lbdj;Lcom/google/common/collect/Ordering;)V
