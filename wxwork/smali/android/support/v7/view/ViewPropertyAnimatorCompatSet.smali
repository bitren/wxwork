...
.field private final mProxyListener:Ljy;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Landroid/support/v7/view/ViewPropertyAnimatorCompatSet;->mProxyListener:Ljy;
...
.method public cancel()V
    ...
    .line 94
    invoke-virtual {v1}, Ljw;->cancel()V
...
.method public play(Ljw;)Landroid/support/v7/view/ViewPropertyAnimatorCompatSet;
    .locals 1
...
.method public playSequentially(Ljw;Ljw;)Landroid/support/v7/view/ViewPropertyAnimatorCompatSet;
    .locals 2
    ...
    .line 62
    invoke-virtual {p1}, Ljw;->getDuration()J

    move-result-wide v0

    invoke-virtual {p2, v0, v1}, Ljw;->r(J)Ljw;
...
.method public setListener(Ljx;)Landroid/support/v7/view/ViewPropertyAnimatorCompatSet;
    .locals 1
    ...
    .line 115
    iput-object p1, p0, Landroid/support/v7/view/ViewPropertyAnimatorCompatSet;->mListener:Ljx;
...
.method public start()V
    ...
    .line 74
    invoke-virtual {v1, v2}, Ljw;->b(Landroid/view/animation/Interpolator;)Ljw;

    .line 76
    :cond_2
    iget-object v2, p0, Landroid/support/v7/view/ViewPropertyAnimatorCompatSet;->mListener:Ljx;

    if-eqz v2, :cond_3

    .line 77
    iget-object v2, p0, Landroid/support/v7/view/ViewPropertyAnimatorCompatSet;->mProxyListener:Ljy;

    invoke-virtual {v1, v2}, Ljw;->a(Ljx;)Ljw;

    .line 79
    :cond_3
    invoke-virtual {v1}, Ljw;->start()V
