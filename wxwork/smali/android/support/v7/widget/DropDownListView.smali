...
# instance fields
.field private mClickAnimation:Ljw;
...
.field private mScrollHelper:Lky;
...
.method private clearPressedItem()V
    ...
    .line 639
    :cond_0
    iget-object v0, p0, Landroid/support/v7/widget/DropDownListView;->mClickAnimation:Ljw;
    ...
    .line 641
    iput-object v0, p0, Landroid/support/v7/widget/DropDownListView;->mClickAnimation:Ljw;
...
.method private positionSelectorLikeFocusCompat(ILandroid/view/View;)V
    ...
    .line 599
    invoke-static {v0, p2, p1}, Lgq;->a(Landroid/graphics/drawable/Drawable;FF)V
...
.method private positionSelectorLikeTouchCompat(ILandroid/view/View;FF)V
    ...
    .line 579
    invoke-static {p2, p3, p4}, Lgq;->a(Landroid/graphics/drawable/Drawable;FF)V
...
.method public onForwardedEvent(Landroid/view/MotionEvent;I)Z
    ...
    .line 525
    iget-object p2, p0, Landroid/support/v7/widget/DropDownListView;->mScrollHelper:Lky;
    ...
    invoke-direct {p2, p0}, Lky;-><init>(Landroid/widget/ListView;)V

    iput-object p2, p0, Landroid/support/v7/widget/DropDownListView;->mScrollHelper:Lky;

    .line 528
    :cond_5
    iget-object p2, p0, Landroid/support/v7/widget/DropDownListView;->mScrollHelper:Lky;

    invoke-virtual {p2, v2}, Lky;->ag(Z)Lkm;

    .line 529
    iget-object p2, p0, Landroid/support/v7/widget/DropDownListView;->mScrollHelper:Lky;

    invoke-virtual {p2, p0, p1}, Lky;->onTouch(Landroid/view/View;Landroid/view/MotionEvent;)Z

    goto :goto_2

    .line 530
    :cond_6
    iget-object p1, p0, Landroid/support/v7/widget/DropDownListView;->mScrollHelper:Lky;

    if-eqz p1, :cond_7

    .line 531
    invoke-virtual {p1, v1}, Lky;->ag(Z)Lkm;
