...
.method constructor <init>(Landroid/support/v7/graphics/drawable/AnimatedStateListDrawableCompat$AnimatedStateListState;Landroid/support/v7/graphics/drawable/AnimatedStateListDrawableCompat;Landroid/content/res/Resources;)V
    ...
    .line 636
    iget-object p2, p1, Landroid/support/v7/graphics/drawable/AnimatedStateListDrawableCompat$AnimatedStateListState;->mTransitions:Lio;

    iput-object p2, p0, Landroid/support/v7/graphics/drawable/AnimatedStateListDrawableCompat$AnimatedStateListState;->mTransitions:Lio;

    .line 637
    iget-object p1, p1, Landroid/support/v7/graphics/drawable/AnimatedStateListDrawableCompat$AnimatedStateListState;->mStateIds:Liw;

    iput-object p1, p0, Landroid/support/v7/graphics/drawable/AnimatedStateListDrawableCompat$AnimatedStateListState;->mStateIds:Liw;
    ...
    iput-object p1, p0, Landroid/support/v7/graphics/drawable/AnimatedStateListDrawableCompat$AnimatedStateListState;->mTransitions:Lio;
...
.method addStateSet([ILandroid/graphics/drawable/Drawable;I)I
    ...
    .line 667
    iget-object p2, p0, Landroid/support/v7/graphics/drawable/AnimatedStateListDrawableCompat$AnimatedStateListState;->mStateIds:Liw;

    invoke-static {p3}, Ljava/lang/Integer;->valueOf(I)Ljava/lang/Integer;

    move-result-object p3

    invoke-virtual {p2, p1, p3}, Liw;->put(ILjava/lang/Object;)V
...
.method addTransition(IILandroid/graphics/drawable/Drawable;Z)I
    ...
    .line 657
    :goto_0
    iget-object v4, p0, Landroid/support/v7/graphics/drawable/AnimatedStateListDrawableCompat$AnimatedStateListState;->mTransitions:Lio;
    ...
    invoke-virtual {v4, v0, v1, v7}, Lio;->append(JLjava/lang/Object;)V
    ...
    .line 660
    iget-object p4, p0, Landroid/support/v7/graphics/drawable/AnimatedStateListDrawableCompat$AnimatedStateListState;->mTransitions:Lio;
    ...
    invoke-virtual {p4, p1, p2, v0}, Lio;->append(JLjava/lang/Object;)V
...
.method getKeyframeIdAt(I)I
    ...
    .line 680
    :cond_0
    iget-object v1, p0, Landroid/support/v7/graphics/drawable/AnimatedStateListDrawableCompat$AnimatedStateListState;->mStateIds:Liw;

    invoke-static {v0}, Ljava/lang/Integer;->valueOf(I)Ljava/lang/Integer;

    move-result-object v0

    invoke-virtual {v1, p1, v0}, Liw;->get(ILjava/lang/Object;)Ljava/lang/Object;
...
.method indexOfTransition(II)I
    ...
    .line 685
    iget-object v0, p0, Landroid/support/v7/graphics/drawable/AnimatedStateListDrawableCompat$AnimatedStateListState;->mTransitions:Lio;
    ...
    invoke-virtual {v0, p1, p2, v1}, Lio;->get(JLjava/lang/Object;)Ljava/lang/Object;
...
.method mutate()V
    ...
    invoke-virtual {v0}, Lio;->jq()Lio;

    move-result-object v0

    iput-object v0, p0, Landroid/support/v7/graphics/drawable/AnimatedStateListDrawableCompat$AnimatedStateListState;->mTransitions:Lio;

    .line 647
    iget-object v0, p0, Landroid/support/v7/graphics/drawable/AnimatedStateListDrawableCompat$AnimatedStateListState;->mStateIds:Liw;

    invoke-virtual {v0}, Liw;->js()Liw;

    move-result-object v0

    iput-object v0, p0, Landroid/support/v7/graphics/drawable/AnimatedStateListDrawableCompat$AnimatedStateListState;->mStateIds:Liw;
