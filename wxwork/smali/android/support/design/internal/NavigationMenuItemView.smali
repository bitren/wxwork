...
.field private final uo:Landroid/widget/CheckedTextView;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput-object p2, p0, Landroid/support/design/internal/NavigationMenuItemView;->uv:Liy;
    ...
    iput p1, p0, Landroid/support/design/internal/NavigationMenuItemView;->qL:I
    ...
    iput-object p1, p0, Landroid/support/design/internal/NavigationMenuItemView;->uo:Landroid/widget/CheckedTextView;

    .line 96
    iget-object p1, p0, Landroid/support/design/internal/NavigationMenuItemView;->uo:Landroid/widget/CheckedTextView;
    ...
    iget-object p2, p0, Landroid/support/design/internal/NavigationMenuItemView;->uv:Liy;
...
.method private dw()Z
    ...
    .line 122
    iget-object v0, p0, Landroid/support/design/internal/NavigationMenuItemView;->tE:Landroid/support/v7/view/menu/MenuItemImpl;
...
.method private dx()V
    ...
    .line 128
    invoke-direct {p0}, Landroid/support/design/internal/NavigationMenuItemView;->dw()Z
    ...
    .line 130
    iget-object v0, p0, Landroid/support/design/internal/NavigationMenuItemView;->uo:Landroid/widget/CheckedTextView;
    ...
    .line 131
    iget-object v0, p0, Landroid/support/design/internal/NavigationMenuItemView;->uq:Landroid/widget/FrameLayout;
    ...
    .line 134
    iget-object v1, p0, Landroid/support/design/internal/NavigationMenuItemView;->uq:Landroid/widget/FrameLayout;
...
.method private dy()Landroid/graphics/drawable/StateListDrawable;
    .locals 4
...
.method private setActionView(Landroid/view/View;)V
    ...
    iput-object v0, p0, Landroid/support/design/internal/NavigationMenuItemView;->uq:Landroid/widget/FrameLayout;
...
.method public initialize(Landroid/support/v7/view/menu/MenuItemImpl;I)V
    ...
    .line 102
    iput-object p1, p0, Landroid/support/design/internal/NavigationMenuItemView;->tE:Landroid/support/v7/view/menu/MenuItemImpl;
    ...
    .line 107
    invoke-direct {p0}, Landroid/support/design/internal/NavigationMenuItemView;->dy()Landroid/graphics/drawable/StateListDrawable;
    ...
    .line 118
    invoke-direct {p0}, Landroid/support/design/internal/NavigationMenuItemView;->dx()V
...
.method public setCheckable(Z)V
    ...
    .line 193
    iget-object p1, p0, Landroid/support/design/internal/NavigationMenuItemView;->uv:Liy;

    iget-object v0, p0, Landroid/support/design/internal/NavigationMenuItemView;->uo:Landroid/widget/CheckedTextView;

    const/16 v1, 0x800

    invoke-virtual {p1, v0, v1}, Liy;->sendAccessibilityEvent(Landroid/view/View;I)V
...
.method public setIcon(Landroid/graphics/drawable/Drawable;)V
    ...
    .line 210
    iget-boolean v1, p0, Landroid/support/design/internal/NavigationMenuItemView;->ut:Z
    ...
    .line 213
    iget-object v1, p0, Landroid/support/design/internal/NavigationMenuItemView;->ur:Landroid/content/res/ColorStateList;

    invoke-static {p1, v1}, Lgq;->a(Landroid/graphics/drawable/Drawable;Landroid/content/res/ColorStateList;)V

    .line 215
    :cond_1
    iget v1, p0, Landroid/support/design/internal/NavigationMenuItemView;->qL:I
    ...
    .line 216
    :cond_2
    iget-boolean v1, p0, Landroid/support/design/internal/NavigationMenuItemView;->un:Z

    if-eqz v1, :cond_4

    .line 217
    iget-object p1, p0, Landroid/support/design/internal/NavigationMenuItemView;->uu:Landroid/graphics/drawable/Drawable;
    ...
    .line 219
    invoke-static {p1, v1, v2}, Lge;->d(Landroid/content/res/Resources;ILandroid/content/res/Resources$Theme;)Landroid/graphics/drawable/Drawable;

    move-result-object p1

    iput-object p1, p0, Landroid/support/design/internal/NavigationMenuItemView;->uu:Landroid/graphics/drawable/Drawable;
    ...
    invoke-static {v0, p1, v1, v1, v1}, Lld;->setCompoundDrawablesRelative(Landroid/widget/TextView;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;)V
...
.method public setIconTintList(Landroid/content/res/ColorStateList;)V
    ...
    .line 250
    iput-object p1, p0, Landroid/support/design/internal/NavigationMenuItemView;->ur:Landroid/content/res/ColorStateList;

    .line 251
    iget-object p1, p0, Landroid/support/design/internal/NavigationMenuItemView;->ur:Landroid/content/res/ColorStateList;
    ...
    :goto_0
    iput-boolean p1, p0, Landroid/support/design/internal/NavigationMenuItemView;->ut:Z

    .line 252
    iget-object p1, p0, Landroid/support/design/internal/NavigationMenuItemView;->tE:Landroid/support/v7/view/menu/MenuItemImpl;
...
.method public setNeedsEmptyIcon(Z)V
    ...
    .line 267
    iput-boolean p1, p0, Landroid/support/design/internal/NavigationMenuItemView;->un:Z
