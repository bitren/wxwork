...
.field private final ql:Lbu;

.field private final qm:Lau;

.field private qn:Landroid/animation/Animator;

.field private qo:Landroid/animation/Animator;

.field private qr:Landroid/animation/Animator;
...
.field qw:Landroid/animation/AnimatorListenerAdapter;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    .line 116
    iput-boolean v0, p0, Landroid/support/design/bottomappbar/BottomAppBar;->qv:Z
    ...
    iput-object v1, p0, Landroid/support/design/bottomappbar/BottomAppBar;->qw:Landroid/animation/AnimatorListenerAdapter;

    .line 129
    sget-object v4, La;->eM:[I
    ...
    .line 130
    invoke-static/range {v2 .. v7}, Lbm;->a(Landroid/content/Context;Landroid/util/AttributeSet;[III[I)Landroid/content/res/TypedArray;

    move-result-object p2

    .line 138
    invoke-static {p1, p2, v1}, Lbo;->b(Landroid/content/Context;Landroid/content/res/TypedArray;I)Landroid/content/res/ColorStateList;
    ...
    iput v4, p0, Landroid/support/design/bottomappbar/BottomAppBar;->qt:I
    ...
    iput-boolean v1, p0, Landroid/support/design/bottomappbar/BottomAppBar;->qu:Z
    ...
    iput p2, p0, Landroid/support/design/bottomappbar/BottomAppBar;->qk:I

    .line 154
    new-instance p2, Lau;

    invoke-direct {p2, p3, v2, v3}, Lau;-><init>(FFF)V

    iput-object p2, p0, Landroid/support/design/bottomappbar/BottomAppBar;->qm:Lau;

    .line 156
    new-instance p2, Lbw;

    invoke-direct {p2}, Lbw;-><init>()V

    .line 157
    iget-object p3, p0, Landroid/support/design/bottomappbar/BottomAppBar;->qm:Lau;

    invoke-virtual {p2, p3}, Lbw;->a(Lbt;)V

    .line 158
    new-instance p3, Lbu;

    invoke-direct {p3, p2}, Lbu;-><init>(Lbw;)V

    iput-object p3, p0, Landroid/support/design/bottomappbar/BottomAppBar;->ql:Lbu;

    .line 159
    iget-object p2, p0, Landroid/support/design/bottomappbar/BottomAppBar;->ql:Lbu;

    invoke-virtual {p2, v0}, Lbu;->z(Z)V
    ...
    invoke-virtual {p2, p3}, Lbu;->a(Landroid/graphics/Paint$Style;)V

    .line 161
    iget-object p2, p0, Landroid/support/design/bottomappbar/BottomAppBar;->ql:Lbu;

    invoke-static {p2, p1}, Lgq;->a(Landroid/graphics/drawable/Drawable;Landroid/content/res/ColorStateList;)V

    .line 162
    iget-object p1, p0, Landroid/support/design/bottomappbar/BottomAppBar;->ql:Lbu;
...
.method private Y(I)V
    ...
    .line 288
    iget v0, p0, Landroid/support/design/bottomappbar/BottomAppBar;->qt:I
    ...
    .line 292
    :cond_0
    iget-object v0, p0, Landroid/support/design/bottomappbar/BottomAppBar;->qo:Landroid/animation/Animator;
    ...
    .line 299
    invoke-direct {p0, p1, v0}, Landroid/support/design/bottomappbar/BottomAppBar;->c(ILjava/util/List;)V
    ...
    .line 303
    iput-object p1, p0, Landroid/support/design/bottomappbar/BottomAppBar;->qo:Landroid/animation/Animator;

    .line 304
    iget-object p1, p0, Landroid/support/design/bottomappbar/BottomAppBar;->qo:Landroid/animation/Animator;
...
.method private Z(I)I
    ...
    iget v1, p0, Landroid/support/design/bottomappbar/BottomAppBar;->qk:I
...
.method static synthetic a(Landroid/support/design/bottomappbar/BottomAppBar;)Lau;
    .locals 0

    .line 86
    iget-object p0, p0, Landroid/support/design/bottomappbar/BottomAppBar;->qm:Lau;
...
.method private a(IZLjava/util/List;)V
    ...
    .line 412
    iget-boolean v3, p0, Landroid/support/design/bottomappbar/BottomAppBar;->qv:Z

    if-nez v3, :cond_1

    if-eqz p2, :cond_2

    invoke-direct {p0}, Landroid/support/design/bottomappbar/BottomAppBar;->cs()Z
    ...
    :cond_1
    iget v3, p0, Landroid/support/design/bottomappbar/BottomAppBar;->qt:I
...
.method static synthetic a(Landroid/support/design/bottomappbar/BottomAppBar;IZ)V
    ...
    .line 86
    invoke-direct {p0, p1, p2}, Landroid/support/design/bottomappbar/BottomAppBar;->i(IZ)V
...
.method static synthetic a(Landroid/support/design/bottomappbar/BottomAppBar;Z)V
    ...
    .line 86
    invoke-direct {p0, p1}, Landroid/support/design/bottomappbar/BottomAppBar;->t(Z)V
...
.method private a(Landroid/support/design/widget/FloatingActionButton;)V
    ...
    .line 658
    iget-object v0, p0, Landroid/support/design/bottomappbar/BottomAppBar;->qw:Landroid/animation/AnimatorListenerAdapter;
...
.method static synthetic b(Landroid/support/design/bottomappbar/BottomAppBar;Landroid/animation/Animator;)Landroid/animation/Animator;
    ...
    .line 86
    iput-object p1, p0, Landroid/support/design/bottomappbar/BottomAppBar;->qr:Landroid/animation/Animator;

    return-object p1
.end method

.method static synthetic b(Landroid/support/design/bottomappbar/BottomAppBar;)Lbu;
    .locals 0

    .line 86
    iget-object p0, p0, Landroid/support/design/bottomappbar/BottomAppBar;->ql:Lbu;
...
.method private b(ILjava/util/List;)V
    ...
    .line 316
    iget-boolean v0, p0, Landroid/support/design/bottomappbar/BottomAppBar;->qv:Z
    ...
    iget-object v2, p0, Landroid/support/design/bottomappbar/BottomAppBar;->qm:Lau;

    .line 322
    invoke-virtual {v2}, Lau;->getHorizontalOffset()F
    ...
    invoke-direct {p0, p1}, Landroid/support/design/bottomappbar/BottomAppBar;->Z(I)I
...
.method private b(ZLjava/util/List;)V
    ...
    .line 475
    iget-object v0, p0, Landroid/support/design/bottomappbar/BottomAppBar;->qm:Lau;

    invoke-direct {p0}, Landroid/support/design/bottomappbar/BottomAppBar;->getFabTranslationX()F

    move-result v1

    invoke-virtual {v0, v1}, Lau;->s(F)V
    ...
    iget-object v2, p0, Landroid/support/design/bottomappbar/BottomAppBar;->ql:Lbu;

    .line 479
    invoke-virtual {v2}, Lbu;->dH()F
...
.method static synthetic c(Landroid/support/design/bottomappbar/BottomAppBar;Landroid/animation/Animator;)Landroid/animation/Animator;
    ...
    .line 86
    iput-object p1, p0, Landroid/support/design/bottomappbar/BottomAppBar;->qn:Landroid/animation/Animator;
...
.method private c(ILjava/util/List;)V
    ...
    .line 361
    invoke-direct {p0}, Landroid/support/design/bottomappbar/BottomAppBar;->cr()Landroid/support/design/widget/FloatingActionButton;
...
.method private c(ZLjava/util/List;)V
    ...
    .line 498
    invoke-direct {p0, p1}, Landroid/support/design/bottomappbar/BottomAppBar;->u(Z)F
...
.method static synthetic c(Landroid/support/design/bottomappbar/BottomAppBar;)Z
    ...
    .line 86
    iget-boolean p0, p0, Landroid/support/design/bottomappbar/BottomAppBar;->qv:Z

    return p0
.end method

.method private cr()Landroid/support/design/widget/FloatingActionButton;
    .locals 4
    ...
    invoke-virtual {v0, p0}, Landroid/support/design/widget/CoordinatorLayout;->y(Landroid/view/View;)Ljava/util/List;
...
.method private cs()Z
    ...
    .line 355
    invoke-virtual {v0}, Landroid/support/design/widget/FloatingActionButton;->fb()Z
...
.method private ct()V
    ...
    .line 590
    iget-object v0, p0, Landroid/support/design/bottomappbar/BottomAppBar;->qn:Landroid/animation/Animator;
    ...
    .line 593
    :cond_0
    iget-object v0, p0, Landroid/support/design/bottomappbar/BottomAppBar;->qr:Landroid/animation/Animator;
...
.method private cv()V
    ...
    .line 621
    iget-object v1, p0, Landroid/support/design/bottomappbar/BottomAppBar;->ql:Lbu;

    iget-boolean v2, p0, Landroid/support/design/bottomappbar/BottomAppBar;->qv:Z
    ...
    :goto_0
    invoke-virtual {v1, v2}, Lbu;->u(F)V
    ...
    .line 632
    :cond_2
    iget v1, p0, Landroid/support/design/bottomappbar/BottomAppBar;->qt:I
...
.method static synthetic d(Landroid/support/design/bottomappbar/BottomAppBar;)I
    ...
    .line 86
    iget p0, p0, Landroid/support/design/bottomappbar/BottomAppBar;->qt:I
...
.method static synthetic f(Landroid/support/design/bottomappbar/BottomAppBar;)Z
    ...
    .line 86
    invoke-direct {p0}, Landroid/support/design/bottomappbar/BottomAppBar;->cu()Z
...
.method static synthetic g(Landroid/support/design/bottomappbar/BottomAppBar;)V
    ...
    .line 86
    invoke-direct {p0}, Landroid/support/design/bottomappbar/BottomAppBar;->cv()V
...
.method private getFabTranslationX()F
    ...
    invoke-direct {p0, v0}, Landroid/support/design/bottomappbar/BottomAppBar;->Z(I)I
...
.method private getFabTranslationY()F
    ...
    invoke-direct {p0, v0}, Landroid/support/design/bottomappbar/BottomAppBar;->u(Z)F
...
.method private i(IZ)V
    ...
    .line 388
    iget-object p1, p0, Landroid/support/design/bottomappbar/BottomAppBar;->qr:Landroid/animation/Animator;
...
.method private t(Z)V
    ...
    :goto_0
    invoke-direct {p0, v1, v0}, Landroid/support/design/bottomappbar/BottomAppBar;->b(ZLjava/util/List;)V

    .line 457
    invoke-direct {p0, p1, v0}, Landroid/support/design/bottomappbar/BottomAppBar;->c(ZLjava/util/List;)V
    ...
    .line 462
    iget-object p1, p0, Landroid/support/design/bottomappbar/BottomAppBar;->qn:Landroid/animation/Animator;
...
.method public getBackgroundTint()Landroid/content/res/ColorStateList;
    ...
    .line 193
    iget-object v0, p0, Landroid/support/design/bottomappbar/BottomAppBar;->ql:Lbu;

    invoke-virtual {v0}, Lbu;->dG()Landroid/content/res/ColorStateList;
...
.method public getCradleVerticalOffset()F
    ...
    invoke-virtual {v0}, Lau;->getCradleVerticalOffset()F
...
.method public getFabCradleMargin()F
    ...
    invoke-virtual {v0}, Lau;->getFabCradleMargin()F
...
.method public getFabCradleRoundedCornerRadius()F
    ...
    invoke-virtual {v0}, Lau;->getFabCradleRoundedCornerRadius()F
...
.method public getHideOnScroll()Z
    ...
    .line 254
    iget-boolean v0, p0, Landroid/support/design/bottomappbar/BottomAppBar;->qu:Z
...
.method public onLayout(ZIIII)V
    ...
    .line 612
    invoke-direct {p0}, Landroid/support/design/bottomappbar/BottomAppBar;->ct()V
...
.method public onRestoreInstanceState(Landroid/os/Parcelable;)V
    ...
    .line 801
    iget v0, p1, Landroid/support/design/bottomappbar/BottomAppBar$SavedState;->qt:I

    iput v0, p0, Landroid/support/design/bottomappbar/BottomAppBar;->qt:I

    .line 802
    iget-boolean p1, p1, Landroid/support/design/bottomappbar/BottomAppBar$SavedState;->qv:Z

    iput-boolean p1, p0, Landroid/support/design/bottomappbar/BottomAppBar;->qv:Z
...
.method public onSaveInstanceState()Landroid/os/Parcelable;
    ...
    iput v0, v1, Landroid/support/design/bottomappbar/BottomAppBar$SavedState;->qt:I

    .line 789
    iget-boolean v0, p0, Landroid/support/design/bottomappbar/BottomAppBar;->qv:Z

    iput-boolean v0, v1, Landroid/support/design/bottomappbar/BottomAppBar$SavedState;->qv:Z
...
.method public setCradleVerticalOffset(F)V
    ...
    invoke-virtual {v0, p1}, Lau;->setCradleVerticalOffset(F)V

    .line 244
    iget-object p1, p0, Landroid/support/design/bottomappbar/BottomAppBar;->ql:Lbu;

    invoke-virtual {p1}, Lbu;->invalidateSelf()V
...
.method public setFabAlignmentMode(I)V
    ...
    .line 182
    invoke-direct {p0, p1}, Landroid/support/design/bottomappbar/BottomAppBar;->Y(I)V

    .line 183
    iget-boolean v0, p0, Landroid/support/design/bottomappbar/BottomAppBar;->qv:Z

    invoke-direct {p0, p1, v0}, Landroid/support/design/bottomappbar/BottomAppBar;->i(IZ)V

    .line 184
    iput p1, p0, Landroid/support/design/bottomappbar/BottomAppBar;->qt:I
...
.method public setFabCradleMargin(F)V
    ...
    invoke-virtual {v0, p1}, Lau;->setFabCradleMargin(F)V
...
.method public setFabCradleRoundedCornerRadius(F)V
    ...
    invoke-virtual {v0, p1}, Lau;->setFabCradleRoundedCornerRadius(F)V
...
.method setFabDiameter(I)V
    ...
    invoke-virtual {v0, p1}, Lau;->t(F)V
...
.method public setHideOnScroll(Z)V
    ...
    .line 263
    iput-boolean p1, p0, Landroid/support/design/bottomappbar/BottomAppBar;->qu:Z
