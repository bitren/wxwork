...
.field private final qH:Law;

.field private qI:I

.field private qJ:Landroid/graphics/PorterDuff$Mode;

.field private qK:Landroid/content/res/ColorStateList;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput p2, p0, Landroid/support/design/button/MaterialButton;->qI:I
    ...
    .line 149
    invoke-static {p2, p3}, Lbn;->parseTintMode(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuff$Mode;

    move-result-object p2

    iput-object p2, p0, Landroid/support/design/button/MaterialButton;->qJ:Landroid/graphics/PorterDuff$Mode;
    ...
    .line 153
    invoke-static {p2, p1, p3}, Lbo;->b(Landroid/content/Context;Landroid/content/res/TypedArray;I)Landroid/content/res/ColorStateList;

    move-result-object p2

    iput-object p2, p0, Landroid/support/design/button/MaterialButton;->qK:Landroid/content/res/ColorStateList;
    ...
    invoke-static {p2, p1, p3}, Lbo;->c(Landroid/content/Context;Landroid/content/res/TypedArray;I)Landroid/graphics/drawable/Drawable;
    ...
    iput p2, p0, Landroid/support/design/button/MaterialButton;->qN:I
    ...
    iput p2, p0, Landroid/support/design/button/MaterialButton;->qL:I

    .line 161
    new-instance p2, Law;

    invoke-direct {p2, p0}, Law;-><init>(Landroid/support/design/button/MaterialButton;)V

    iput-object p2, p0, Landroid/support/design/button/MaterialButton;->qH:Law;

    .line 162
    iget-object p2, p0, Landroid/support/design/button/MaterialButton;->qH:Law;

    invoke-virtual {p2, p1}, Law;->a(Landroid/content/res/TypedArray;)V

    .line 164
    invoke-virtual {p1}, Landroid/content/res/TypedArray;->recycle()V

    .line 166
    iget p1, p0, Landroid/support/design/button/MaterialButton;->qI:I

    invoke-virtual {p0, p1}, Landroid/support/design/button/MaterialButton;->setCompoundDrawablePadding(I)V

    .line 167
    invoke-direct {p0}, Landroid/support/design/button/MaterialButton;->cx()V
...
.method private cx()V
    ...
    iget-object v1, p0, Landroid/support/design/button/MaterialButton;->qK:Landroid/content/res/ColorStateList;

    invoke-static {v0, v1}, Lgq;->a(Landroid/graphics/drawable/Drawable;Landroid/content/res/ColorStateList;)V

    .line 542
    iget-object v0, p0, Landroid/support/design/button/MaterialButton;->qJ:Landroid/graphics/PorterDuff$Mode;
    ...
    .line 546
    :cond_0
    iget v0, p0, Landroid/support/design/button/MaterialButton;->qL:I
    ...
    .line 547
    :goto_0
    iget v1, p0, Landroid/support/design/button/MaterialButton;->qL:I
    ...
    iget v3, p0, Landroid/support/design/button/MaterialButton;->qM:I
    ...
    invoke-static {p0, v0, v1, v1, v1}, Lld;->setCompoundDrawablesRelative(Landroid/widget/TextView;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;)V
...
.method private cy()Z
    ...
    .line 744
    iget-object v0, p0, Landroid/support/design/button/MaterialButton;->qH:Law;

    if-eqz v0, :cond_0

    invoke-virtual {v0}, Law;->cA()Z
...
.method public getCornerRadius()I
    ...
    .line 717
    invoke-direct {p0}, Landroid/support/design/button/MaterialButton;->cy()Z
    ...
    invoke-virtual {v0}, Law;->getCornerRadius()I
...
.method public getIconGravity()I
    ...
    .line 729
    iget v0, p0, Landroid/support/design/button/MaterialButton;->qN:I
...
.method public getIconPadding()I
    ...
    .line 396
    iget v0, p0, Landroid/support/design/button/MaterialButton;->qI:I
...
.method public getIconTint()Landroid/content/res/ColorStateList;
    ...
    .line 509
    iget-object v0, p0, Landroid/support/design/button/MaterialButton;->qK:Landroid/content/res/ColorStateList;
...
.method public getRippleColor()Landroid/content/res/ColorStateList;
    ...
    invoke-virtual {v0}, Law;->getRippleColor()Landroid/content/res/ColorStateList;
...
.method public getStrokeColor()Landroid/content/res/ColorStateList;
    ...
    invoke-virtual {v0}, Law;->getStrokeColor()Landroid/content/res/ColorStateList;
...
.method public getStrokeWidth()I
    ...
    invoke-virtual {v0}, Law;->getStrokeWidth()I
...
.method public getSupportBackgroundTintList()Landroid/content/res/ColorStateList;
    ...
    invoke-virtual {v0}, Law;->getSupportBackgroundTintList()Landroid/content/res/ColorStateList;
...
.method public getSupportBackgroundTintMode()Landroid/graphics/PorterDuff$Mode;
    ...
    invoke-virtual {v0}, Law;->getSupportBackgroundTintMode()Landroid/graphics/PorterDuff$Mode;
...
.method protected onDraw(Landroid/graphics/Canvas;)V
    ...
    invoke-virtual {v0, p1}, Law;->a(Landroid/graphics/Canvas;)V
...
.method public onLayout(ZIIII)V
    ...
    iget-object p1, p0, Landroid/support/design/button/MaterialButton;->qH:Law;
    ...
    .line 324
    invoke-virtual {p1, p5, p4}, Law;->p(II)V
...
.method protected onMeasure(II)V
    ...
    iget p1, p0, Landroid/support/design/button/MaterialButton;->qN:I
    ...
    .line 351
    :cond_2
    iget p1, p0, Landroid/support/design/button/MaterialButton;->qM:I

    if-eq p1, v1, :cond_3

    .line 352
    iput v1, p0, Landroid/support/design/button/MaterialButton;->qM:I
...
.method public setBackgroundColor(I)V
    ...
    invoke-virtual {v0, p1}, Law;->setBackgroundColor(I)V
...
.method public setCornerRadius(I)V
    ...
    invoke-virtual {v0, p1}, Law;->setCornerRadius(I)V
...
.method public setIconGravity(I)V
    ...
    .line 740
    iput p1, p0, Landroid/support/design/button/MaterialButton;->qN:I
...
.method public setIconPadding(I)V
    ...
    .line 382
    iput p1, p0, Landroid/support/design/button/MaterialButton;->qI:I
...
.method public setIconSize(I)V
    ...
    .line 412
    iput p1, p0, Landroid/support/design/button/MaterialButton;->qL:I
...
.method public setIconTint(Landroid/content/res/ColorStateList;)V
    ...
    .line 483
    iput-object p1, p0, Landroid/support/design/button/MaterialButton;->qK:Landroid/content/res/ColorStateList;
...
.method public setIconTintMode(Landroid/graphics/PorterDuff$Mode;)V
    ...
    .line 521
    iput-object p1, p0, Landroid/support/design/button/MaterialButton;->qJ:Landroid/graphics/PorterDuff$Mode;
...
.method public setRippleColor(Landroid/content/res/ColorStateList;)V
    ...
    invoke-virtual {v0, p1}, Law;->setRippleColor(Landroid/content/res/ColorStateList;)V
...
.method public setStrokeColor(Landroid/content/res/ColorStateList;)V
    ...
    invoke-virtual {v0, p1}, Law;->setStrokeColor(Landroid/content/res/ColorStateList;)V
...
.method public setStrokeWidth(I)V
    ...
    invoke-virtual {v0, p1}, Law;->setStrokeWidth(I)V
...
.method public setSupportBackgroundTintList(Landroid/content/res/ColorStateList;)V
    ...
    invoke-virtual {v0, p1}, Law;->setSupportBackgroundTintList(Landroid/content/res/ColorStateList;)V
...
.method public setSupportBackgroundTintMode(Landroid/graphics/PorterDuff$Mode;)V
    ...
    invoke-virtual {v0, p1}, Law;->setSupportBackgroundTintMode(Landroid/graphics/PorterDuff$Mode;)V
