...
# instance fields
.field private final UM:Landroid/support/v4/media/session/MediaControllerCompat$b;

.field private final UN:Landroid/support/v4/media/session/MediaSessionCompat$Token;

.field private final UO:Ljava/util/HashSet;
...
.method public constructor <init>(Landroid/content/Context;Landroid/support/v4/media/session/MediaSessionCompat$Token;)V
    ...
    iput-object v0, p0, Landroid/support/v4/media/session/MediaControllerCompat;->UO:Ljava/util/HashSet;

    if-eqz p2, :cond_3

    .line 277
    iput-object p2, p0, Landroid/support/v4/media/session/MediaControllerCompat;->UN:Landroid/support/v4/media/session/MediaSessionCompat$Token;
    ...
    iput-object v0, p0, Landroid/support/v4/media/session/MediaControllerCompat;->UM:Landroid/support/v4/media/session/MediaControllerCompat$b;
    ...
    iput-object p1, p0, Landroid/support/v4/media/session/MediaControllerCompat;->UM:Landroid/support/v4/media/session/MediaControllerCompat$b;
...
.method public dispatchMediaButtonEvent(Landroid/view/KeyEvent;)Z
    ...
    .line 310
    iget-object v0, p0, Landroid/support/v4/media/session/MediaControllerCompat;->UM:Landroid/support/v4/media/session/MediaControllerCompat$b;
