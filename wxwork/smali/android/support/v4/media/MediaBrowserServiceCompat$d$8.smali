...
.method constructor <init>(Landroid/support/v4/media/MediaBrowserServiceCompat$d;Landroid/support/v4/media/MediaBrowserServiceCompat$e;Ljava/lang/String;Landroid/os/Bundle;Landroid/support/v4/os/ResultReceiver;)V
    ...
    .line 1052
    iput-object p1, p0, Landroid/support/v4/media/MediaBrowserServiceCompat$d$8;->Ur:Landroid/support/v4/media/MediaBrowserServiceCompat$d;

    iput-object p2, p0, Landroid/support/v4/media/MediaBrowserServiceCompat$d$8;->Un:Landroid/support/v4/media/MediaBrowserServiceCompat$e;

    iput-object p3, p0, Landroid/support/v4/media/MediaBrowserServiceCompat$d$8;->val$query:Ljava/lang/String;

    iput-object p4, p0, Landroid/support/v4/media/MediaBrowserServiceCompat$d$8;->val$extras:Landroid/os/Bundle;

    iput-object p5, p0, Landroid/support/v4/media/MediaBrowserServiceCompat$d$8;->Ub:Landroid/support/v4/os/ResultReceiver;
...
.method public run()V
    ...
    .line 1055
    iget-object v0, p0, Landroid/support/v4/media/MediaBrowserServiceCompat$d$8;->Un:Landroid/support/v4/media/MediaBrowserServiceCompat$e;
    ...
    .line 1057
    iget-object v1, p0, Landroid/support/v4/media/MediaBrowserServiceCompat$d$8;->Ur:Landroid/support/v4/media/MediaBrowserServiceCompat$d;
    ...
    iget-object v2, p0, Landroid/support/v4/media/MediaBrowserServiceCompat$d$8;->val$query:Ljava/lang/String;
    ...
    iget-object v3, p0, Landroid/support/v4/media/MediaBrowserServiceCompat$d$8;->val$extras:Landroid/os/Bundle;

    iget-object v4, p0, Landroid/support/v4/media/MediaBrowserServiceCompat$d$8;->Ub:Landroid/support/v4/os/ResultReceiver;
