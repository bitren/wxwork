...
.field private final Yf:Landroid/graphics/Paint;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    iput-object p2, p0, Landroid/support/v4/view/PagerTabStrip;->Yf:Landroid/graphics/Paint;
    ...
    .line 71
    iput p2, p0, Landroid/support/v4/view/PagerTabStrip;->Yg:I

    const/4 p2, 0x0

    .line 73
    iput-boolean p2, p0, Landroid/support/v4/view/PagerTabStrip;->Yh:Z

    .line 74
    iput-boolean p2, p0, Landroid/support/v4/view/PagerTabStrip;->Yi:Z
    ...
    .line 90
    iget-object v0, p0, Landroid/support/v4/view/PagerTabStrip;->Yf:Landroid/graphics/Paint;
    ...
    .line 95
    iput v1, p0, Landroid/support/v4/view/PagerTabStrip;->Ya:I
    ...
    .line 96
    iput v1, p0, Landroid/support/v4/view/PagerTabStrip;->Yb:I
    ...
    .line 97
    iput v1, p0, Landroid/support/v4/view/PagerTabStrip;->Yc:I
    ...
    .line 98
    iput v1, p0, Landroid/support/v4/view/PagerTabStrip;->Ye:I
    ...
    .line 99
    iput v1, p0, Landroid/support/v4/view/PagerTabStrip;->Yj:I
    ...
    .line 100
    iput v0, p0, Landroid/support/v4/view/PagerTabStrip;->Yd:I
    ...
    .line 109
    iget-object p1, p0, Landroid/support/v4/view/PagerTabStrip;->Ym:Landroid/widget/TextView;
    ...
    .line 117
    iget-object p1, p0, Landroid/support/v4/view/PagerTabStrip;->Yo:Landroid/widget/TextView;
...
.method a(IFZ)V
    ...
    .line 287
    iget-object v2, p0, Landroid/support/v4/view/PagerTabStrip;->Yn:Landroid/widget/TextView;

    invoke-virtual {v2}, Landroid/widget/TextView;->getLeft()I

    move-result v2

    iget v3, p0, Landroid/support/v4/view/PagerTabStrip;->Ye:I

    sub-int/2addr v2, v3

    .line 288
    iget-object v3, p0, Landroid/support/v4/view/PagerTabStrip;->Yn:Landroid/widget/TextView;

    invoke-virtual {v3}, Landroid/widget/TextView;->getRight()I

    move-result v3

    iget v4, p0, Landroid/support/v4/view/PagerTabStrip;->Ye:I

    add-int/2addr v3, v4

    .line 289
    iget v4, p0, Landroid/support/v4/view/PagerTabStrip;->Ya:I
    ...
    iput p1, p0, Landroid/support/v4/view/PagerTabStrip;->Yg:I

    .line 296
    iget-object p1, p0, Landroid/support/v4/view/PagerTabStrip;->Yn:Landroid/widget/TextView;

    invoke-virtual {p1}, Landroid/widget/TextView;->getLeft()I

    move-result p1

    iget p2, p0, Landroid/support/v4/view/PagerTabStrip;->Ye:I

    sub-int/2addr p1, p2

    .line 297
    iget-object p2, p0, Landroid/support/v4/view/PagerTabStrip;->Yn:Landroid/widget/TextView;

    invoke-virtual {p2}, Landroid/widget/TextView;->getRight()I

    move-result p2

    iget p3, p0, Landroid/support/v4/view/PagerTabStrip;->Ye:I
...
.method public getDrawFullUnderline()Z
    ...
    .line 218
    iget-boolean v0, p0, Landroid/support/v4/view/PagerTabStrip;->Yh:Z
...
.method getMinHeight()I
    ...
    iget v1, p0, Landroid/support/v4/view/PagerTabStrip;->Yd:I
...
.method protected onDraw(Landroid/graphics/Canvas;)V
    ...
    .line 269
    iget-object v1, p0, Landroid/support/v4/view/PagerTabStrip;->Yn:Landroid/widget/TextView;

    invoke-virtual {v1}, Landroid/widget/TextView;->getLeft()I

    move-result v1

    iget v2, p0, Landroid/support/v4/view/PagerTabStrip;->Ye:I
    ...
    .line 271
    iget v3, p0, Landroid/support/v4/view/PagerTabStrip;->Ya:I

    sub-int v3, v0, v3

    .line 273
    iget-object v4, p0, Landroid/support/v4/view/PagerTabStrip;->Yf:Landroid/graphics/Paint;

    iget v5, p0, Landroid/support/v4/view/PagerTabStrip;->Yg:I
    ...
    .line 274
    iget-object v13, p0, Landroid/support/v4/view/PagerTabStrip;->Yf:Landroid/graphics/Paint;
    ...
    .line 276
    iget-boolean v1, p0, Landroid/support/v4/view/PagerTabStrip;->Yh:Z

    if-eqz v1, :cond_0

    .line 277
    iget-object v1, p0, Landroid/support/v4/view/PagerTabStrip;->Yf:Landroid/graphics/Paint;
    ...
    iget v1, p0, Landroid/support/v4/view/PagerTabStrip;->Yj:I
    ...
    iget-object v6, p0, Landroid/support/v4/view/PagerTabStrip;->Yf:Landroid/graphics/Paint;
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    .line 229
    iget-boolean v2, p0, Landroid/support/v4/view/PagerTabStrip;->Yk:Z
    ...
    .line 247
    :cond_1
    iput-boolean v3, p0, Landroid/support/v4/view/PagerTabStrip;->Yk:Z
    ...
    iget v0, p0, Landroid/support/v4/view/PagerTabStrip;->Ye:I
    ...
    .line 241
    iput-boolean v1, p0, Landroid/support/v4/view/PagerTabStrip;->Yk:Z
...
.method public setBackgroundColor(I)V
    ...
    .line 185
    iget-boolean v0, p0, Landroid/support/v4/view/PagerTabStrip;->Yi:Z
    ...
    .line 186
    :goto_0
    iput-boolean p1, p0, Landroid/support/v4/view/PagerTabStrip;->Yh:Z
...
.method public setDrawFullUnderline(Z)V
    ...
    .line 206
    iput-boolean p1, p0, Landroid/support/v4/view/PagerTabStrip;->Yi:Z
...
.method public setPadding(IIII)V
    ...
    .line 160
    iget v0, p0, Landroid/support/v4/view/PagerTabStrip;->Yb:I
...
.method public setTabIndicatorColor(I)V
    ...
    .line 137
    iget-object p1, p0, Landroid/support/v4/view/PagerTabStrip;->Yf:Landroid/graphics/Paint;
...
.method public setTextSpacing(I)V
    ...
    .line 168
    iget v0, p0, Landroid/support/v4/view/PagerTabStrip;->Yc:I
