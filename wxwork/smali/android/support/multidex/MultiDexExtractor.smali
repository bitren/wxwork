...
# instance fields
.field private final HN:Ljava/io/File;

.field private final HO:J

.field private final HP:Ljava/io/File;

.field private final HQ:Ljava/io/RandomAccessFile;

.field private final HR:Ljava/nio/channels/FileChannel;

.field private final HS:Ljava/nio/channels/FileLock;
...
.method public constructor <init>(Ljava/io/File;Ljava/io/File;)V
    ...
    .line 96
    iput-object p1, p0, Landroid/support/multidex/MultiDexExtractor;->HN:Ljava/io/File;

    .line 97
    iput-object p2, p0, Landroid/support/multidex/MultiDexExtractor;->HP:Ljava/io/File;

    .line 98
    invoke-static {p1}, Landroid/support/multidex/MultiDexExtractor;->h(Ljava/io/File;)J

    move-result-wide v0

    iput-wide v0, p0, Landroid/support/multidex/MultiDexExtractor;->HO:J
    ...
    iput-object p2, p0, Landroid/support/multidex/MultiDexExtractor;->HQ:Ljava/io/RandomAccessFile;

    .line 102
    :try_start_0
    iget-object p2, p0, Landroid/support/multidex/MultiDexExtractor;->HQ:Ljava/io/RandomAccessFile;

    invoke-virtual {p2}, Ljava/io/RandomAccessFile;->getChannel()Ljava/nio/channels/FileChannel;

    move-result-object p2

    iput-object p2, p0, Landroid/support/multidex/MultiDexExtractor;->HR:Ljava/nio/channels/FileChannel;
    :try_end_0
    ...
    .line 105
    iget-object p2, p0, Landroid/support/multidex/MultiDexExtractor;->HR:Ljava/nio/channels/FileChannel;

    invoke-virtual {p2}, Ljava/nio/channels/FileChannel;->lock()Ljava/nio/channels/FileLock;

    move-result-object p2

    iput-object p2, p0, Landroid/support/multidex/MultiDexExtractor;->HS:Ljava/nio/channels/FileLock;
    :try_end_1
...
.method private static a(Landroid/content/Context;Ljava/lang/String;JJLjava/util/List;)V
    ...
    .line 321
    invoke-static {p0}, Landroid/support/multidex/MultiDexExtractor;->M(Landroid/content/Context;)Landroid/content/SharedPreferences;
...
.method private static a(Landroid/content/Context;Ljava/io/File;JLjava/lang/String;)Z
    ...
    invoke-static {p1}, Landroid/support/multidex/MultiDexExtractor;->g(Ljava/io/File;)J
...
.method private f(Landroid/content/Context;Ljava/lang/String;)Ljava/util/List;
    ...
    iget-object v3, v0, Landroid/support/multidex/MultiDexExtractor;->HN:Ljava/io/File;
    ...
    .line 179
    invoke-static/range {p1 .. p1}, Landroid/support/multidex/MultiDexExtractor;->M(Landroid/content/Context;)Landroid/content/SharedPreferences;
    ...
    iget-object v9, v0, Landroid/support/multidex/MultiDexExtractor;->HP:Ljava/io/File;
    ...
    .line 187
    invoke-static {v8}, Landroid/support/multidex/MultiDexExtractor;->h(Ljava/io/File;)J
...
.method private gJ()Ljava/util/List;
    .locals 13
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    iget-object v1, p0, Landroid/support/multidex/MultiDexExtractor;->HN:Ljava/io/File;
    ...
    .line 249
    invoke-direct {p0}, Landroid/support/multidex/MultiDexExtractor;->gK()V
    ...
    iget-object v3, p0, Landroid/support/multidex/MultiDexExtractor;->HN:Ljava/io/File;
    ...
    iget-object v7, p0, Landroid/support/multidex/MultiDexExtractor;->HP:Ljava/io/File;
    ...
    .line 276
    :try_start_1
    invoke-static {v6}, Landroid/support/multidex/MultiDexExtractor;->h(Ljava/io/File;)J
    ...
    const-string/jumbo v11, "succeeded"
...
.method private gK()V
    ...
    .line 354
    iget-object v0, p0, Landroid/support/multidex/MultiDexExtractor;->HP:Ljava/io/File;
    ...
    iget-object v2, p0, Landroid/support/multidex/MultiDexExtractor;->HP:Ljava/io/File;
...
.method private static h(Ljava/io/File;)J
    ...
    .line 234
    invoke-static {p0}, Lda;->h(Ljava/io/File;)J
...
.method public b(Landroid/content/Context;Ljava/lang/String;Z)Ljava/util/List;
    ...
    iget-object v2, p0, Landroid/support/multidex/MultiDexExtractor;->HN:Ljava/io/File;
    ...
    .line 131
    iget-object v0, p0, Landroid/support/multidex/MultiDexExtractor;->HS:Ljava/nio/channels/FileLock;
    ...
    .line 136
    iget-object v0, p0, Landroid/support/multidex/MultiDexExtractor;->HN:Ljava/io/File;

    iget-wide v1, p0, Landroid/support/multidex/MultiDexExtractor;->HO:J

    invoke-static {p1, v0, v1, v2, p2}, Landroid/support/multidex/MultiDexExtractor;->a(Landroid/content/Context;Ljava/io/File;JLjava/lang/String;)Z
    ...
    .line 138
    :try_start_0
    invoke-direct {p0, p1, p2}, Landroid/support/multidex/MultiDexExtractor;->f(Landroid/content/Context;Ljava/lang/String;)Ljava/util/List;
    ...
    .line 142
    invoke-direct {p0}, Landroid/support/multidex/MultiDexExtractor;->gJ()Ljava/util/List;
    ...
    invoke-static {v0}, Landroid/support/multidex/MultiDexExtractor;->g(Ljava/io/File;)J

    move-result-wide v4

    iget-wide v6, p0, Landroid/support/multidex/MultiDexExtractor;->HO:J
    ...
    iget-wide v5, p0, Landroid/support/multidex/MultiDexExtractor;->HO:J
...
.method public close()V
    ...
    .line 164
    iget-object v0, p0, Landroid/support/multidex/MultiDexExtractor;->HR:Ljava/nio/channels/FileChannel;

    invoke-virtual {v0}, Ljava/nio/channels/FileChannel;->close()V

    .line 165
    iget-object v0, p0, Landroid/support/multidex/MultiDexExtractor;->HQ:Ljava/io/RandomAccessFile;
