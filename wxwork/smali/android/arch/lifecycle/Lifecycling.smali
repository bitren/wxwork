...
.field private static gG:Ljava/util/Map;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/Map<",
            "Ljava/lang/Class;",
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/arch/lifecycle/Lifecycling;->gF:Ljava/util/Map;
    ...
    sput-object v0, Landroid/arch/lifecycle/Lifecycling;->gG:Ljava/util/Map;
...
.method private static h(Ljava/lang/Class;)I
    ...
    .line 116
    sget-object v0, Landroid/arch/lifecycle/Lifecycling;->gF:Ljava/util/Map;
    ...
    .line 119
    :cond_0
    invoke-static {p0}, Landroid/arch/lifecycle/Lifecycling;->i(Ljava/lang/Class;)I

    move-result v0

    .line 120
    sget-object v1, Landroid/arch/lifecycle/Lifecycling;->gF:Ljava/util/Map;
...
.method static h(Ljava/lang/Object;)Landroid/arch/lifecycle/GenericLifecycleObserver;
    .locals 4
    ...
    .line 57
    invoke-static {v0}, Landroid/arch/lifecycle/Lifecycling;->h(Ljava/lang/Class;)I
    ...
    .line 59
    sget-object v1, Landroid/arch/lifecycle/Lifecycling;->gG:Ljava/util/Map;
...
.method private static i(Ljava/lang/Class;)I
    .locals 8
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 130
    :cond_0
    invoke-static {p0}, Landroid/arch/lifecycle/Lifecycling;->g(Ljava/lang/Class;)Ljava/lang/reflect/Constructor;
    ...
    .line 137
    :cond_1
    sget-object v0, Landroid/arch/lifecycle/ClassesInfoCache;->fY:Landroid/arch/lifecycle/ClassesInfoCache;

    invoke-virtual {v0, p0}, Landroid/arch/lifecycle/ClassesInfoCache;->d(Ljava/lang/Class;)Z
    ...
    .line 144
    invoke-static {v0}, Landroid/arch/lifecycle/Lifecycling;->j(Ljava/lang/Class;)Z
    ...
    sget-object v4, Landroid/arch/lifecycle/Lifecycling;->gG:Ljava/util/Map;
    ...
    .line 152
    invoke-static {v6}, Landroid/arch/lifecycle/Lifecycling;->j(Ljava/lang/Class;)Z
    ...
    .line 155
    :cond_5
    invoke-static {v6}, Landroid/arch/lifecycle/Lifecycling;->h(Ljava/lang/Class;)I
    ...
    .line 161
    :cond_7
    sget-object v7, Landroid/arch/lifecycle/Lifecycling;->gG:Ljava/util/Map;
    ...
    .line 164
    sget-object v0, Landroid/arch/lifecycle/Lifecycling;->gG:Ljava/util/Map;
