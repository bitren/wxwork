...
/***/ (function(module, exports, __webpack_require__) {
	...
	if ((0, _Utils.getPlatform)() == 'ios') {
	    ...
	    delete _qyInterface2.default.getMacAddress;
	} else if ((0, _Utils.getPlatform)() == 'android') {
	    // delete ios only interface
	}
...
/***/ (function(module, exports, __webpack_require__) {
	...
	// const methods = wx.getBaseMethods()

	// let invokeMethod = methods.invokeMethod;
	...
	var getMacAddress = function getMacAddress() {
	  ...
	  (0, _BaseMethods.invokeMethod)('qy__getMacAddress', args, {});
	};

	var translateVoice = function translateVoice() {
	  var args = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};

	  (0, _BaseMethods.invokeMethod)('qy__translateVoice', args, {});
	};

	var openChatWithMsg = function openChatWithMsg() {
	  var args = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};

	  (0, _BaseMethods.invokeMethod)('qy__openChatWithMsg', args, {});
	};

	var canIUsePrivate = function canIUsePrivate() {
	  var args = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};

	  (0, _BaseMethods.invokeMethod)('qy__canIUsePrivate', args, {});
	};

	var operatePrivate = function operatePrivate() {
	  var args = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};

	  (0, _BaseMethods.invokeMethod)('qy__operatePrivate', args, {});
	};

	var bioassayFaceCompare = function bioassayFaceCompare() {
	  var args = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};

	  (0, _BaseMethods.invokeMethod)('qy__bioassayFaceCompare', args, {});
	};

	var openDeviceProfile = function openDeviceProfile() {
	  var args = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};

	  (0, _BaseMethods.invokeMethod)('qy__openDeviceProfile', args, {});
	};

	var enableShareToWxMenuGlobal = function enableShareToWxMenuGlobal() {
	  var args = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};

	  (0, _BaseMethods.invokeMethod)('qy__enableShareToWxMenuGlobal', args, {});
	};

	var shareToExternalContact = function shareToExternalContact() {
	  var args = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};

	  (0, _BaseMethods.invokeMethod)('qy__shareToExternalContact', args, {});
	};

	var discoverDevice = function discoverDevice() {
	  var args = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};

	  (0, _BaseMethods.invokeMethod)('qy__discoverDevice', args, {});
	};

	var applyCodeForRestrictedChat = function applyCodeForRestrictedChat() {
	  var args = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};

	  (0, _BaseMethods.invokeMethod)('qy__applyCodeForRestrictedChat', args, {});
	};

	var openUrl = function openUrl() {
	  var args = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};

	  (0, _BaseMethods.invokeMethod)('qy__openUrl', args, {});
	};
