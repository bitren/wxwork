...
# instance fields
.field private final ayo:Ljava/util/TreeMap;
...
.method public constructor <init>(Luo;)V
    ...
    iput-object p1, p0, Lvi;->ayo:Ljava/util/TreeMap;
...
# virtual methods
.method public declared-synchronized a(Lxr;)Lvh;
    .locals 2
    ...
    .line 102
    :try_start_0
    invoke-virtual {p0}, Lvi;->qN()V

    .line 104
    iget-object v0, p0, Lvi;->ayo:Ljava/util/TreeMap;
    ...
    invoke-direct {v0, p1}, Lvh;-><init>(Lxr;)V

    .line 108
    iget-object v1, p0, Lvi;->ayo:Ljava/util/TreeMap;
...
.method public b(Lxr;)I
    .locals 1

    if-eqz p1, :cond_1

    .line 126
    invoke-virtual {p0}, Lvi;->qM()V
    ...
    .line 134
    invoke-virtual {p1}, Lvh;->getIndex()I
