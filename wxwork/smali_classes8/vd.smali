...
# direct methods
.method public constructor <init>(Ljava/lang/String;Luo;)V
    .locals 1

    const/4 v0, 0x4

    .line 39
    invoke-direct {p0, p1, p2, v0}, Lvv;-><init>(Ljava/lang/String;Luo;I)V

    return-void
.end method

.method private qD()Ljava/lang/String;
    .locals 9
    ...
    .line 59
    invoke-virtual {p0}, Lvd;->pQ()Ljava/util/Collection;
    ...
    invoke-virtual {v2}, Lvc;->qA()Lyq;

    move-result-object v2

    invoke-virtual {v2}, Lyq;->getPackageName()Ljava/lang/String;
...
.method protected pP()V
    ...
    invoke-virtual {v2, v1}, Lvc;->setIndex(I)V
    ...
    invoke-direct {p0}, Lvd;->qD()Ljava/lang/String;
