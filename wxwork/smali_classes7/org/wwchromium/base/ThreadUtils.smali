.class public Lorg/wwchromium/base/ThreadUtils;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lorg/wwchromium/base/ThreadUtils;->sLock:Ljava/lang/Object;
...
.method public static assertOnBackgroundThread()V
    ...
    .line 225
    sget-boolean v0, Lorg/wwchromium/base/ThreadUtils;->sThreadAssertsDisabled:Z
...
.method public static checkUiThread()V
    ...
    invoke-static {}, Lorg/wwchromium/base/ThreadUtils;->runningOnUiThread()Z
...
.method private static getUiThreadHandler()Landroid/os/Handler;
    ...
    .line 55
    sget-object v0, Lorg/wwchromium/base/ThreadUtils;->sLock:Ljava/lang/Object;

    monitor-enter v0

    .line 56
    :try_start_0
    sget-object v1, Lorg/wwchromium/base/ThreadUtils;->sUiThreadHandler:Landroid/os/Handler;

    if-nez v1, :cond_1

    .line 57
    sget-boolean v1, Lorg/wwchromium/base/ThreadUtils;->sWillOverride:Z
    ...
    sput-object v1, Lorg/wwchromium/base/ThreadUtils;->sUiThreadHandler:Landroid/os/Handler;
...
.method public static getUiThreadLooper()Landroid/os/Looper;
    ...
    .line 249
    invoke-static {}, Lorg/wwchromium/base/ThreadUtils;->getUiThreadHandler()Landroid/os/Handler;
...
.method public static runOnUiThread(Ljava/util/concurrent/Callable;)Ljava/util/concurrent/FutureTask;
    ...
    invoke-static {v0}, Lorg/wwchromium/base/ThreadUtils;->runOnUiThread(Ljava/util/concurrent/FutureTask;)Ljava/util/concurrent/FutureTask;
...
.method public static runOnUiThread(Ljava/util/concurrent/FutureTask;)Ljava/util/concurrent/FutureTask;
    ...
    .line 131
    :cond_0
    invoke-static {p0}, Lorg/wwchromium/base/ThreadUtils;->postOnUiThread(Ljava/util/concurrent/FutureTask;)Ljava/util/concurrent/FutureTask;
...
.method public static runOnUiThreadBlocking(Ljava/lang/Runnable;)V
    ...
    .line 77
    invoke-static {v0}, Lorg/wwchromium/base/ThreadUtils;->postOnUiThread(Ljava/util/concurrent/FutureTask;)Ljava/util/concurrent/FutureTask;
...
.method public static runOnUiThreadBlockingNoException(Ljava/util/concurrent/Callable;)Ljava/lang/Object;
    ...
    .line 96
    :try_start_0
    invoke-static {p0}, Lorg/wwchromium/base/ThreadUtils;->runOnUiThreadBlocking(Ljava/util/concurrent/Callable;)Ljava/lang/Object;
...
.method public static setThreadAssertsDisabledForTesting(Z)V
    ...
    .line 238
    sput-boolean p0, Lorg/wwchromium/base/ThreadUtils;->sThreadAssertsDisabled:Z
...
.method public static setUiThread(Landroid/os/Looper;)V
    ...
    .line 41
    :try_start_0
    sput-object p0, Lorg/wwchromium/base/ThreadUtils;->sUiThreadHandler:Landroid/os/Handler;
    ...
    sget-object v3, Lorg/wwchromium/base/ThreadUtils;->sUiThreadHandler:Landroid/os/Handler;
...
.method public static setWillOverrideUiThread()V
    ...
    .line 32
    :try_start_0
    sput-boolean v1, Lorg/wwchromium/base/ThreadUtils;->sWillOverride:Z
