...
.method constructor <init>(Lcay;)V
    ...
    .line 346
    iput-object p1, p0, Lcay$4;->cFj:Lcay;
...
.method public run()V
    ...
    .line 351
    :try_start_0
    iget-object v0, p0, Lcay$4;->cFj:Lcay;

    invoke-virtual {v0}, Lcay;->aaN()Landroid/os/Bundle;
    ...
    invoke-virtual {v1, v3}, Lcbd;->getInt(Ljava/lang/String;)I
    ...
    invoke-static {v6, v2, v7}, Lcom/tencent/open/utils/HttpUtils;->g(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Lorg/apache/http/client/HttpClient;
    ...
    const-string v8, "http://wspeed.qq.com/w.cgi"
    ...
    invoke-virtual {v6, v7}, Lcax;->b(Ljava/lang/String;)V
    :try_end_1
    ...
    .line 393
    invoke-static {v6, v7, v5}, Lcao;->d(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    iget-object v2, p0, Lcay$4;->cFj:Lcay;

    iget-object v2, v2, Lcay;->c:Ljava/util/List;

    invoke-virtual {v0, v1, v2}, Lcax;->a(Ljava/lang/String;Ljava/util/List;)V
