...
.field private static final bua:[B
...
.method public static A(Lbco;)Z
    ...
    invoke-virtual {p0, v0, v3, v1}, Lbco;->readBytes([BII)V

    .line 53
    sget-object p0, Lavn;->bua:[B
...
.method protected B(Lbco;)J
    ...
    invoke-direct {p0, p1}, Lavn;->G([B)J

    move-result-wide v0

    invoke-virtual {p0, v0, v1}, Lavn;->at(J)J
...
.method protected a(Lbco;JLavo$a;)Z
    ...
    .line 79
    invoke-direct {p0, v7, p2}, Lavn;->b(Ljava/util/List;I)V

    const/16 p1, 0xf00

    .line 80
    invoke-direct {p0, v7, p1}, Lavn;->b(Ljava/util/List;I)V
