.class public Lecb;
.super Lebg;
.source "JSFuncCloseWebView.java"
...
.method public constructor <init>(Lcom/tencent/wework/common/controller/SuperActivity;Lefb;)V
    ...
    const-string/jumbo v0, "wwapp.closeCurrentWebview"

    .line 24
    invoke-direct {p0, p2, v0}, Lebg;-><init>(Lefb;Ljava/lang/String;)V

    .line 25
    iput-object p1, p0, Lecb;->fSS:Lcom/tencent/wework/common/controller/SuperActivity;
...
.method protected run3rdapi(Lefb;Ljava/lang/String;Landroid/os/Bundle;)Ljava/util/Map;
    ...
    .line 30
    iget-object p1, p0, Lecb;->fSS:Lcom/tencent/wework/common/controller/SuperActivity;

    invoke-virtual {p1}, Lcom/tencent/wework/common/controller/SuperActivity;->finish()V

    .line 31
    sget-object p1, Lecb;->RESULT_SKIP:Ljava/util/Map;
