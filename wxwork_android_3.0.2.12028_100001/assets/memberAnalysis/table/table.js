...
var Table = {
    ...
    getTableRowTpl: function (type, item) {
        ...
        var normalCellTpl = "<tr><td class='col_2'><span class='paddingLeft'>" + applyContactNum_val + "</span></td><td" +
            ...
            " class='paddingLeft'>" + chatNum_val + "</span></td><td class='col_5'><span class='paddingLeft'>" + sendMsgNum_val + "</span></td><td class='col_6'><span class='paddingLeft'>" + replyPer_val + "</span></td><td class='col_7'><span class='paddingLeft'>" + firstReplyTime_val + "</span></td><td class='col_8'><span class='paddingLeft'>" + feedbackNum_val + "</span></td></tr>";
